...
// /home/jony/Downloads/ardy/ardy/retarget_to_t3/vendor/soma_retargeter_runtime/soma_retargeter/utils/pose_utils.py:37
...
// /home/jony/Downloads/ardy/ardy/retarget_to_t3/vendor/soma_retargeter_runtime/soma_retargeter/robotics/human_to_robot_scaler.py:244
...
extern "C" __global__ void HumanToRobotScaler__compute_effectors_from_skeleton__locals__compute_global_pose_kernel_7b8be618_cuda_kernel_forward(
    ...
    wp::array_t<wp::transform_t<wp::float32>> var_out_result)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def compute_global_pose_kernel(                                                        <L 81>
        // pose_utils.wp_compute_global_pose(in_num_joints, in_root_tx, in_parent_indices, in_local_pose, out_result)       <L 88>
...
extern "C" __global__ void HumanToRobotScaler__compute_effectors_from_skeleton__locals__compute_global_pose_kernel_7b8be618_cuda_kernel_backward(
    wp::launch_bounds_t<1> dim,
    wp::int32 var_in_num_joints,
    wp::transform_t<wp::float32> var_in_root_tx,
    wp::array_t<wp::int32> var_in_parent_indices,
    ...
    wp::array_t<wp::transform_t<wp::float32>> adj_out_result)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: pose_utils.wp_compute_global_pose(in_num_joints, in_root_tx, in_parent_indices, in_local_pose, out_result)  <L 88>
        // adj: def compute_global_pose_kernel(                                                   <L 81>
        continue;
    }
}
...
extern "C" __global__ void HumanToRobotScaler__compute_effectors_from_skeleton__locals__compute_scaled_effectors_kernel_35908886_cuda_kernel_forward(
    wp::launch_bounds_t<1> dim,
    wp::int32 var_in_num_mapped_joints,
    wp::array_t<wp::transform_t<wp::float32>> var_in_global_pose,
    wp::array_t<wp::int32> var_in_mapped_joint_indices,
    ...
    wp::array_t<wp::transform_t<wp::float32>> var_out_result)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def compute_scaled_effectors_kernel(                                                   <L 91>
        // HumanToRobotScaler.wp_compute_scaled_effectors(                                        <L 100>
        // in_num_mapped_joints, in_global_pose, in_mapped_joint_indices,                         <L 101>
        // in_mapped_joint_scales, in_mapped_joint_offsets, in_scale_animation, out_result)       <L 102>
        HumanToRobotScaler__wp_compute_scaled_effectors_0(var_in_num_mapped_joints, var_in_global_pose, var_in_mapped_joint_indices, var_in_mapped_joint_scales, var_in_mapped_joint_offsets, var_in_scale_animation, var_out_result);
    }
}



extern "C" __global__ void HumanToRobotScaler__compute_effectors_from_skeleton__locals__compute_scaled_effectors_kernel_35908886_cuda_kernel_backward(
    wp::launch_bounds_t<1> dim,
    wp::int32 var_in_num_mapped_joints,
    wp::array_t<wp::transform_t<wp::float32>> var_in_global_pose,
    wp::array_t<wp::int32> var_in_mapped_joint_indices,
    ...
    wp::array_t<wp::transform_t<wp::float32>> adj_out_result)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // reverse
        adj_HumanToRobotScaler__wp_compute_scaled_effectors_0(var_in_num_mapped_joints, var_in_global_pose, var_in_mapped_joint_indices, var_in_mapped_joint_scales, var_in_mapped_joint_offsets, var_in_scale_animation, var_out_result, adj_in_num_mapped_joints, adj_in_global_pose, adj_in_mapped_joint_indices, adj_in_mapped_joint_scales, adj_in_mapped_joint_offsets, adj_in_scale_animation, adj_out_result);
        // adj: in_mapped_joint_scales, in_mapped_joint_offsets, in_scale_animation, out_result)  <L 102>
        // adj: in_num_mapped_joints, in_global_pose, in_mapped_joint_indices,                    <L 101>
        // adj: HumanToRobotScaler.wp_compute_scaled_effectors(                                   <L 100>
        // adj: def compute_scaled_effectors_kernel(                                              <L 91>
        continue;
    }
}
