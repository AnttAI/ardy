    ...
    wp::array_t<wp::float32> var_elevation_data)
{
    ...
    // return wp.static(sample_sdf)(texture_sdf, pp)                                          <L 697>
    var_4 = texture_sample_sdf_hw_0(var_texture_sdf, var_1);
    return var_4;
    return {};
}
...
extern "C" __launch_bounds__(256, 2) __global__ void create_narrow_phase_process_mesh_mesh_contacts_kernel__locals__mesh_sdf_collision_global_reduce_kernel_4e81d778_cuda_kernel_forward(
    ...
    wp::int32 var_total_num_blocks)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::float32 var_122;
        wp::vec_t<3, wp::float32> var_123;
        wp::transform_t<wp::float32>* var_124;
        wp::transform_t<wp::float32> var_125;
        wp::transform_t<wp::float32> var_126;
        wp::transform_t<wp::float32>* var_127;
        wp::transform_t<wp::float32> var_128;
        wp::transform_t<wp::float32> var_129;
        TextureSDFData_93572308 var_130;
        bool var_131;
        TextureSDFData_93572308* var_132;
        TextureSDFData_93572308 var_133;
        TextureSDFData_93572308 var_134;
        TextureSDFData_93572308 var_135;
        const bool var_136 = true;
        const wp::float32 var_137 = 1.0;
        const wp::float32 var_138 = 1.0;
        ...
        wp::float32 var_161;
        const bool var_162 = false;
        bool var_163;
        const bool var_164 = true;
        wp::float32* var_165;
        wp::float32 var_166;
        wp::float32 var_167;
        bool var_168;
        ...
        wp::float32 var_170;
        wp::float32 var_171;
        wp::vec_t<2, wp::int32>* var_172;
        wp::vec_t<2, wp::int32> var_173;
        wp::vec_t<2, wp::int32> var_174;
        wp::int32 var_175;
        wp::int32 var_176;
        ...
        wp::float32 var_208;
        bool var_209;
        const bool var_210 = false;
        wp::vec_t<3, wp::float32> var_211;
        wp::float32 var_212;
        wp::float32 var_213;
        bool var_214;
        const bool var_215 = false;
        wp::float32 var_216;
        bool var_217;
        bool var_218;
        const bool var_219 = false;
        const wp::float32 var_220 = 1.01;
        wp::float32 var_221;
        wp::float32 var_222;
        bool var_223;
        wp::float32 var_224;
        ...
        bool var_246;
        wp::float32 var_247;
        EdgeCullResult_d4aae4ab var_248;
        wp::int32 var_249;
        ...
        bool var_256;
        EdgeCullResult_d4aae4ab var_257;
        wp::int32 var_258;
        wp::int32* var_259;
        wp::int32 var_260;
        wp::int32 var_261;
        ...
        bool var_291;
        bool var_292;
        const bool var_293 = false;
        bool var_294;
        const bool var_295 = false;
        const wp::float32 var_296 = 100000000000.0;
        wp::float32 var_297;
        wp::vec_t<3, wp::float32> var_298;
        wp::vec_t<3, wp::float32> var_299;
        wp::float32 var_300;
        wp::vec_t<3, wp::float32> var_301;
        const bool var_302 = true;
        wp::float32 var_303;
        wp::vec_t<3, wp::float32> var_304;
        ...
        wp::vec_t<3, wp::int32>* var_340;
        wp::vec_t<3, wp::int32> var_341;
        wp::vec_t<3, wp::int32> var_342;
        wp::float32 var_343;
        wp::vec_t<3, wp::float32> var_344;
        wp::vec_t<3, wp::float32> var_345;
        wp::vec_t<3, wp::float32> var_346;
        const wp::float32 var_347 = 0.5;
        ...
        end_while_2:;
            ...
            start_for_4:;
                ...
                var_113 = wp::extract(var_105, var_112);
                var_115 = wp::extract(var_105, var_114);
                var_116 = wp::vec_t<3, wp::float32>(var_111, var_113, var_115);
                // mesh_scale_sdf = wp.vec3(scale_data_sdf[0], scale_data_sdf[1], scale_data_sdf[2])       <L 1651>
                var_118 = wp::extract(var_108, var_117);
                var_120 = wp::extract(var_108, var_119);
                var_122 = wp::extract(var_108, var_121);
                var_123 = wp::vec_t<3, wp::float32>(var_118, var_120, var_122);
                // X_tri_ws = shape_transform[tri_shape]                                          <L 1653>
                var_124 = wp::address(var_shape_transform, var_74);
                var_126 = wp::load(var_124);
                var_125 = wp::copy(var_126);
                // X_sdf_ws = shape_transform[sdf_shape]                                          <L 1654>
                var_127 = wp::address(var_shape_transform, var_77);
                var_129 = wp::load(var_127);
                var_128 = wp::copy(var_129);
                // texture_sdf = TextureSDFData()                                                 <L 1656>
                var_130 = TextureSDFData_93572308();
                // if sdf_is_hfield:                                                              <L 1657>
                // if not use_bvh_for_sdf:                                                        <L 1660>
                var_131 = wp::unot(var_98);
                if (var_131) {
                    // texture_sdf = texture_sdf_table[sdf_idx]                                   <L 1661>
                    var_132 = wp::address(var_texture_sdf_table, var_101);
                    var_134 = wp::load(var_132);
                    var_133 = wp::copy(var_134);
                }
                var_135 = wp::where(var_131, var_133, var_130);
                // if wp.static(use_identity_sdf_scale):                                          <L 1662>
                // sdf_scale = wp.vec3(1.0, 1.0, 1.0)                                             <L 1663>
                var_140 = wp::vec_t<3, wp::float32>(var_137, var_138, var_139);
                // X_mesh_to_sdf = wp.transform_multiply(wp.transform_inverse(X_sdf_ws), X_tri_ws)       <L 1669>
                var_141 = wp::transform_inverse(var_128);
                var_142 = wp::transform_multiply(var_141, var_125);
                // triangle_mesh_margin = scale_data_tri[3]                                       <L 1671>
                var_144 = wp::extract(var_105, var_143);
                // sdf_mesh_margin = scale_data_sdf[3]                                            <L 1672>
                var_146 = wp::extract(var_108, var_145);
                // if wp.static(use_identity_sdf_scale):                                          <L 1674>
                // inv_sdf_scale = wp.vec3(1.0, 1.0, 1.0)                                         <L 1675>
                var_151 = wp::vec_t<3, wp::float32>(var_148, var_149, var_150);
                // min_sdf_scale = float(1.0)                                                     <L 1676>
                var_153 = wp::float(var_152);
                // edge_radius_scale = float(1.0)                                                 <L 1677>
                var_155 = wp::float(var_154);
                // contact_threshold = gap_sum + triangle_mesh_margin + sdf_mesh_margin           <L 1684>
                var_156 = wp::add(var_59, var_144);
                var_157 = wp::add(var_156, var_146);
                // contact_threshold_unscaled = contact_threshold / min_sdf_scale                 <L 1685>
                var_158 = wp::div(var_157, var_153);
        ...
        if ((var_197) == false) goto end_while_8;
                        ...
                        if (var_209) {
                            ...
                            // edge_idx,                                                          <L 1758>
                            _create_get_mesh_edge_bounding_sphere_func__locals__get_mesh_edge_bounding_sphere_func_1(var_83, var_mesh_edge_indices, var_mesh_edge_centers, var_173, var_116, var_142, var_151, var_155, var_205, var_211, var_212);
                            // threshold = bsphere_radius + contact_threshold_unscaled            <L 1761>
                            var_213 = wp::add(var_212, var_158);
                            // if wp.static(enable_heightfields) and sdf_is_heightfield:          <L 1763>
                            var_214 = var_215;
                            if (var_214) {
                                var_214 = var_214 && var_186;
                            }
                            if (var_214) {
                                // midpoint_sdf = sample_sdf_heightfield(hfd_sdf, heightfield_elevations, bsphere_center)       <L 1764>
                                var_216 = sample_sdf_heightfield_0(var_93, var_heightfield_elevations, var_211);
                                // add_edge = midpoint_sdf <= threshold                           <L 1765>
                                var_217 = (var_216 <= var_213);
                            }
                            if (!var_214) {
                                // elif wp.static(not use_texture_sdf_only) and use_bvh_for_sdf:       <L 1766>
                                var_218 = var_219;
                                if (var_218) {
                                    var_218 = var_218 && var_98;
                                }
                                if (var_218) {
                                    ...
                                    var_221 = wp::mul(var_220, var_213);
                                    // sdf_mesh_query_type,                                       <L 1771>
                                    var_222 = sample_sdf_using_mesh_0(var_86, var_211, var_221, var_96);
                                    // add_edge = midpoint_sdf <= threshold                       <L 1773>
                                    var_223 = (var_222 <= var_213);
                                }
                                if (!var_218) {
                                    // culling_radius = threshold                                 <L 1775>
                                    var_224 = wp::copy(var_213);
                                    // clamped = wp.min(wp.max(bsphere_center, sdf_aabb_lower), sdf_aabb_upper)       <L 1776>
                                    var_225 = wp::max(var_211, var_188);
                                    var_226 = wp::min(var_225, var_191);
                                    // aabb_dist_sq = wp.length_sq(bsphere_center - clamped)       <L 1777>
                                    var_227 = wp::sub(var_211, var_226);
                                    var_228 = wp::length_sq(var_227);
                                    // if aabb_dist_sq > culling_radius * culling_radius:         <L 1778>
                                    var_229 = wp::mul(var_224, var_224);
                                    ...
                                    if (!var_230) {
                                        ...
                                        var_235 = (var_228 > var_234);
                                        if (var_235) {
                                            // diff_mag = wp.sqrt(aabb_dist_sq)                   <L 1783>
                                            var_236 = wp::sqrt(var_228);
                                        }
                                        var_237 = wp::where(var_235, var_236, var_233);
                                        // midpoint_sdf = wp.static(sample_clamped)(texture_sdf, clamped, diff_mag)       <L 1784>
                                        var_238 = _texture_sample_sdf_hw_clamped_0(var_135, var_226, var_237);
                                        // add_edge = midpoint_sdf <= culling_radius              <L 1785>
                                        var_239 = (var_238 <= var_224);
                                    }
                                    var_240 = wp::where(var_230, var_231, var_239);
                                    var_241 = wp::where(var_230, var_208, var_238);
                                }
                                var_242 = wp::where(var_218, var_223, var_240);
                                var_243 = wp::where(var_218, var_222, var_241);
                            }
                            var_244 = wp::where(var_214, var_217, var_242);
                            var_245 = wp::where(var_214, var_216, var_243);
                        }
                        var_246 = wp::where(var_209, var_244, var_206);
                        var_247 = wp::where(var_209, var_245, var_208);
                        // cull_result = EdgeCullResult()                                         <L 1787>
                        var_248 = EdgeCullResult_d4aae4ab();
                        // cull_result.edge_idx = edge_idx                                        <L 1788>
                        var_248.edge_idx = var_205;
                        // cull_result.midpoint_sdf = midpoint_sdf                                <L 1789>
                        var_248.midpoint_sdf = var_247;
                        // wp.tile_stack_push(edge_stack, cull_result, add_edge)                  <L 1790>
                        var_249 = wp::tile_stack_push(var_14, var_248, var_246);
                        // wp.tile_scatter_masked(progress, 0, base_edge_idx + capacity, t == 0)       <L 1791>
                        var_251 = wp::add(var_204, var_196);
                        var_253 = (var_1 == var_252);
                        wp::tile_scatter_masked(var_17, var_250, var_251, var_253);
        goto start_while_8;
        end_while_8:;
                    // while wp.tile_stack_count(edge_stack) > 0:                                 <L 1798>
        start_while_10:;
                    var_254 = wp::tile_stack_count(var_14);
                    var_256 = (var_254 > var_255);
        if ((var_256) == false) goto end_while_10;
                        // popped, edge_slot = wp.tile_stack_pop(edge_stack)                      <L 1799>
                        wp::tile_stack_pop(var_14, var_257, var_258);
                        // my_edge_idx = popped.edge_idx                                          <L 1800>
                        var_259 = &((var_257).edge_idx);
                        var_261 = wp::load(var_259);
                        var_260 = wp::copy(var_261);
                        // cached_sdf_val = popped.midpoint_sdf                                   <L 1801>
                        var_262 = &((var_257).midpoint_sdf);
                        var_264 = wp::load(var_262);
                        var_263 = wp::copy(var_264);
                        // has_edge = edge_slot >= 0                                              <L 1802>
                        var_266 = (var_258 >= var_265);
                        // if has_edge:                                                           <L 1804>
                        if (var_266) {
                            // corner_ownership = int(0)                                          <L 1805>
                            var_268 = wp::int(var_267);
                            ...
                            // my_edge_idx,                                                       <L 1834>
                            _create_mesh_edge_accessor_func__locals__get_edge_from_mesh_func_1(var_83, var_mesh_edge_indices, var_mesh_edge_centers, var_mesh_edge_halves, var_173, var_116, var_142, var_260, var_270, var_271, var_272);
                            // v0 = wp.cw_mul(v0s, inv_sdf_scale)                                 <L 1836>
                            var_273 = wp::cw_mul(var_270, var_151);
                            // v1 = wp.cw_mul(v1s, inv_sdf_scale)                                 <L 1837>
                            var_274 = wp::cw_mul(var_271, var_151);
                            ...
                            _create_sdf_contact_funcs__locals__do_edge_sdf_collision_func_1(var_135, var_86, var_273, var_274, var_263, var_98, var_96, var_80, var_93, var_heightfield_elevations, var_171, var_275, var_276, var_277);
                            // dist_approx = dist_unscaled * min_sdf_scale                        <L 1859>
                            var_278 = wp::mul(var_275, var_153);
                            // bsphere_center_inner, bsphere_radius_inner = get_edge_bounding_sphere(v0, v1)       <L 1860>
                            get_edge_bounding_sphere_0(var_273, var_274, var_279, var_280);
                            // inner_cull_consistent = mesh_sdf_contact_passes_inner_cull_consistency(       <L 1861>
                            // dist_approx,                                                       <L 1862>
                            // triangle_mesh_margin + sdf_mesh_margin,                            <L 1863>
                            var_281 = wp::add(var_144, var_146);
                            ...
                            var_282 = mesh_sdf_contact_passes_inner_cull_consistency_0(var_278, var_281, var_263, var_279, var_280, var_188, var_191, var_153, var_168);
                            // owns_endpoint = (                                                  <L 1872>
                            // best_endpoint == 0 or corner_ownership == 0 or (corner_ownership & best_endpoint) != 0       <L 1873>
                            var_285 = (var_277 == var_284);
                            var_283 = var_285;
                            if (!var_283) {
                                var_287 = (var_272 == var_286);
                                var_283 = var_283 || var_287;
                            }
                            if (!var_283) {
                                var_288 = wp::bit_and(var_272, var_277);
                                var_290 = (var_288 != var_289);
                                var_283 = var_283 || var_290;
                            }
                            // if dist_approx < contact_threshold and inner_cull_consistent and owns_endpoint:       <L 1875>
                            var_292 = (var_278 < var_157);
                            var_291 = var_292;
                            if (var_291) {
                                var_291 = var_291 && var_282;
                            }
                            if (var_291) {
                                var_291 = var_291 && var_283;
                            }
                            if (var_291) {
                                ...
                                if (var_294) {
                                    ...
                                    sample_sdf_grad_using_mesh_0(var_86, var_276, var_296, var_96, var_297, var_298);
                                }
                                if (!var_294) {
                                    // direction_unscaled = wp.static(sample_grad)(texture_sdf, point_unscaled)       <L 1907>
                                    var_299 = texture_sample_sdf_grad_only_hw_0(var_135, var_276);
                                }
                                var_300 = wp::where(var_294, var_297, var_275);
                                var_301 = wp::where(var_294, var_298, var_299);
                                // if wp.static(use_identity_sdf_scale):                          <L 1909>
                                // dist = dist_unscaled                                           <L 1910>
                                var_303 = wp::copy(var_300);
                                // direction = direction_unscaled                                 <L 1911>
                                var_304 = wp::copy(var_301);
                                // point = point_unscaled                                         <L 1912>
                                var_305 = wp::copy(var_276);
                                // point_world = wp.transform_point(X_sdf_ws, point)              <L 1918>
                                var_306 = wp::transform_point(var_128, var_305);
                                // direction_world = wp.transform_vector(X_sdf_ws, direction)       <L 1920>
                                var_307 = wp::transform_vector(var_128, var_304);
                                // direction_len_sq = wp.length_sq(direction_world)               <L 1921>
                                var_308 = wp::length_sq(var_307);
                                ...
                                // reducer_data,                                                  <L 1966>
                                var_366 = export_and_reduce_contact_centered_two_spatial_depths_0(var_357, var_359, var_306, var_329, var_303, var_364, var_365, var_353, var_354, var_333, var_335, var_338, var_341, var_reducer_data);
                                // if wp.static(speculative):                                     <L 1968>
                            }
                            var_368 = wp::where(var_291, var_300, var_275);
                        }
        goto start_while_10;
        end_while_10:;
