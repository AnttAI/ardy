...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/sdf_mc.py:105
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/sdf_mc.py:111
    ...
    wp::int32 var_num_inside)
{
    ...
    // d0 = vert_depths[0]                                                                    <L 127>
    var_7 = wp::extract(var_vert_depths, var_6);
    // d1 = vert_depths[1]                                                                    <L 128>
    var_9 = wp::extract(var_vert_depths, var_8);
    // d2 = vert_depths[2]                                                                    <L 129>
    var_11 = wp::extract(var_vert_depths, var_10);
    // if num_inside == 1:                                                                    <L 130>
    var_13 = (var_num_inside == var_12);
    if (var_13) {
        // if vert_depths[1] < 0.0:                                                           <L 132>
        var_15 = wp::extract(var_vert_depths, var_14);
        var_17 = (var_15 < var_16);
        if (var_17) {
            // d0 = vert_depths[1]                                                            <L 133>
            var_19 = wp::extract(var_vert_depths, var_18);
            // d1 = vert_depths[2]                                                            <L 134>
            var_21 = wp::extract(var_vert_depths, var_20);
            // d2 = vert_depths[0]                                                            <L 135>
            var_23 = wp::extract(var_vert_depths, var_22);
        }
        if (!var_17) {
            // elif vert_depths[2] < 0.0:                                                     <L 136>
            var_25 = wp::extract(var_vert_depths, var_24);
            var_27 = (var_25 < var_26);
            if (var_27) {
                // d0 = vert_depths[2]                                                        <L 137>
                var_29 = wp::extract(var_vert_depths, var_28);
                // d1 = vert_depths[0]                                                        <L 138>
                var_31 = wp::extract(var_vert_depths, var_30);
                // d2 = vert_depths[1]                                                        <L 139>
                var_33 = wp::extract(var_vert_depths, var_32);
            }
            var_34 = wp::where(var_27, var_29, var_7);
            var_35 = wp::where(var_27, var_31, var_9);
            var_36 = wp::where(var_27, var_33, var_11);
        }
        var_37 = wp::where(var_17, var_19, var_34);
        var_38 = wp::where(var_17, var_21, var_35);
        var_39 = wp::where(var_17, var_23, var_36);
    }
    if (!var_13) {
        // if vert_depths[1] >= 0.0:                                                          <L 142>
        var_41 = wp::extract(var_vert_depths, var_40);
        var_43 = (var_41 >= var_42);
        if (var_43) {
            // d0 = vert_depths[1]                                                            <L 143>
            var_45 = wp::extract(var_vert_depths, var_44);
            // d1 = vert_depths[2]                                                            <L 144>
            var_47 = wp::extract(var_vert_depths, var_46);
            // d2 = vert_depths[0]                                                            <L 145>
            var_49 = wp::extract(var_vert_depths, var_48);
        }
        if (!var_43) {
            // elif vert_depths[2] >= 0.0:                                                    <L 146>
            var_51 = wp::extract(var_vert_depths, var_50);
            var_53 = (var_51 >= var_52);
            if (var_53) {
                // d0 = vert_depths[2]                                                        <L 147>
                var_55 = wp::extract(var_vert_depths, var_54);
                // d1 = vert_depths[0]                                                        <L 148>
                var_57 = wp::extract(var_vert_depths, var_56);
                // d2 = vert_depths[1]                                                        <L 149>
                var_59 = wp::extract(var_vert_depths, var_58);
            }
            var_60 = wp::where(var_53, var_55, var_7);
            var_61 = wp::where(var_53, var_57, var_9);
            var_62 = wp::where(var_53, var_59, var_11);
        }
        var_63 = wp::where(var_43, var_45, var_60);
        var_64 = wp::where(var_43, var_47, var_61);
        var_65 = wp::where(var_43, var_49, var_62);
    }
    var_66 = wp::where(var_13, var_37, var_63);
    var_67 = wp::where(var_13, var_38, var_64);
    var_68 = wp::where(var_13, var_39, var_65);
    // denom = (d0 - d1) * (d0 - d2)                                                          <L 151>
    var_69 = wp::sub(var_66, var_67);
    var_70 = wp::sub(var_66, var_68);
    var_71 = wp::mul(var_69, var_70);
    // eps = wp.float32(1e-8)                                                                 <L 152>
    var_73 = wp::float32(var_72);
    // if wp.abs(denom) < eps:                                                                <L 153>
    var_74 = wp::abs(var_71);
    var_75 = (var_74 < var_73);
    if (var_75) {
        // if num_inside == 1:                                                                <L 154>
        var_77 = (var_num_inside == var_76);
        if (var_77) {
            // return 0.0                                                                     <L 155>
            return var_78;
        }
    ...
    // fraction = wp.clamp((d0 * d0) / denom, 0.0, 1.0)                                       <L 159>
    var_80 = wp::mul(var_66, var_66);
    var_81 = wp::div(var_80, var_71);
    var_84 = wp::clamp(var_81, var_82, var_83);
    // if num_inside == 2:                                                                    <L 160>
    var_86 = (var_num_inside == var_85);
    if (var_86) {
        // return 1.0 - fraction                                                              <L 161>
        var_88 = wp::sub(var_87, var_84);
        return var_88;
    }
    if (!var_86) {
        // return fraction                                                                    <L 163>
        return var_84;
    }
    return {};
}
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/sdf_mc.py:166
    ...
    wp::mat_t<3, 3, wp::float32> & ret_4)
{
    ...
    // vert_depths[vi] = depth  # Keep SDF convention: negative = inside/penetrating          <L 219>
    ...
    // n = wp.cross(face_verts[1] - face_verts[0], face_verts[2] - face_verts[0])             <L 223>
    ...
    // pen_depth = (vert_depths[0] + vert_depths[1] + vert_depths[2]) / 3.0                   <L 234>
    ...
    // area *= get_triangle_fraction(vert_depths, num_inside)                                 <L 235>
    var_204 = get_triangle_fraction_0(var_1, var_158);
    var_205 = wp::mul(var_182, var_204);
    // return area, normal, center, pen_depth, face_verts                                     <L 236>
    ret_0 = var_205;
    ret_1 = var_183;
    ret_2 = var_193;
    ret_3 = var_203;
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:180
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:213
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:147
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:277
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:347
static CUDA_CALLABLE wp::vec_t<4, wp::float32> _sdf_barrel_cylinder_data_z_0(
    wp::vec_t<3, wp::float32> var_point,
    wp::float32 var_radius,
    wp::float32 var_half_height,
    wp::float32 var_barrel_radius)
{
    ...
    //---------
    // forward
    // def _sdf_barrel_cylinder_data_z(point: wp.vec3, radius: float, half_height: float, barrel_radius: float):       <L 348>
    // radial = wp.length(wp.vec2(point[0], point[1]))                                        <L 350>
    var_1 = wp::extract(var_point, var_0);
    var_3 = wp::extract(var_point, var_2);
    var_4 = wp::vec_t<2, wp::float32>(var_1, var_3);
    var_5 = wp::length(var_4);
    // z_abs = wp.abs(point[2])                                                               <L 351>
    var_7 = wp::extract(var_point, var_6);
    var_8 = wp::abs(var_7);
    // end_radial_offset = wp.sqrt(wp.max(barrel_radius * barrel_radius - half_height * half_height, 0.0))       <L 352>
    var_9 = wp::mul(var_barrel_radius, var_barrel_radius);
    var_10 = wp::mul(var_half_height, var_half_height);
    var_11 = wp::sub(var_9, var_10);
    var_13 = wp::max(var_11, var_12);
    var_14 = wp::sqrt(var_13);
    // center = radius - end_radial_offset                                                    <L 353>
    var_15 = wp::sub(var_radius, var_14);
    // arc_delta = wp.vec2(radial - center, z_abs)                                            <L 356>
    var_16 = wp::sub(var_5, var_15);
    var_17 = wp::vec_t<2, wp::float32>(var_16, var_8);
    // arc_delta_len = wp.length(arc_delta)                                                   <L 357>
    var_18 = wp::length(var_17);
    // arc_radial = center + barrel_radius                                                    <L 358>
    var_19 = wp::add(var_15, var_barrel_radius);
    // arc_z = 0.0                                                                            <L 359>
    // if arc_delta_len > 1.0e-8:                                                             <L 360>
    var_22 = (var_18 > var_21);
    if (var_22) {
        // arc_radial = center + barrel_radius * arc_delta[0] / arc_delta_len                 <L 361>
        var_24 = wp::extract(var_17, var_23);
        var_25 = wp::mul(var_barrel_radius, var_24);
        var_26 = wp::div(var_25, var_18);
        var_27 = wp::add(var_15, var_26);
        // arc_z = barrel_radius * arc_delta[1] / arc_delta_len                               <L 362>
        var_29 = wp::extract(var_17, var_28);
        var_30 = wp::mul(var_barrel_radius, var_29);
        var_31 = wp::div(var_30, var_18);
    }
    var_32 = wp::where(var_22, var_27, var_19);
    var_33 = wp::where(var_22, var_31, var_20);
    // if arc_radial - center < end_radial_offset:                                            <L 363>
    var_34 = wp::sub(var_32, var_15);
    var_35 = (var_34 < var_14);
    if (var_35) {
        // arc_radial = radius                                                                <L 364>
        var_36 = wp::copy(var_radius);
        // arc_z = half_height                                                                <L 365>
        var_37 = wp::copy(var_half_height);
    }
    var_38 = wp::where(var_35, var_36, var_32);
    var_39 = wp::where(var_35, var_37, var_33);
    // arc_offset = wp.vec2(radial - arc_radial, z_abs - arc_z)                               <L 367>
    var_40 = wp::sub(var_5, var_38);
    var_41 = wp::sub(var_8, var_39);
    var_42 = wp::vec_t<2, wp::float32>(var_40, var_41);
    // arc_distance = wp.length(arc_offset)                                                   <L 368>
    var_43 = wp::length(var_42);
    // cap_radial = wp.min(radial, radius)                                                    <L 371>
    var_44 = wp::min(var_5, var_radius);
    // cap_offset = wp.vec2(radial - cap_radial, z_abs - half_height)                         <L 372>
    var_45 = wp::sub(var_5, var_44);
    var_46 = wp::sub(var_8, var_half_height);
    var_47 = wp::vec_t<2, wp::float32>(var_45, var_46);
    // cap_distance = wp.length(cap_offset)                                                   <L 373>
    var_48 = wp::length(var_47);
    // use_cap = cap_distance < arc_distance                                                  <L 374>
    var_49 = (var_48 < var_43);
    // boundary_radial = wp.where(use_cap, cap_radial, arc_radial)                            <L 375>
    var_50 = wp::where(var_49, var_44, var_38);
    // boundary_z = wp.where(use_cap, half_height, arc_z)                                     <L 376>
    var_51 = wp::where(var_49, var_half_height, var_39);
    // distance = wp.min(cap_distance, arc_distance)                                          <L 377>
    var_52 = wp::min(var_48, var_43);
    // profile_radius = center + wp.sqrt(wp.max(barrel_radius * barrel_radius - z_abs * z_abs, 0.0))       <L 379>
    var_53 = wp::mul(var_barrel_radius, var_barrel_radius);
    var_54 = wp::mul(var_8, var_8);
    var_55 = wp::sub(var_53, var_54);
    var_57 = wp::max(var_55, var_56);
    var_58 = wp::sqrt(var_57);
    var_59 = wp::add(var_15, var_58);
    // inside = z_abs <= half_height and radial <= profile_radius                             <L 380>
    var_61 = (var_8 <= var_half_height);
    var_60 = var_61;
    if (var_60) {
        var_62 = (var_5 <= var_59);
        var_60 = var_60 && var_62;
    }
    // signed_distance = wp.where(inside, -distance, distance)                                <L 381>
    var_63 = wp::neg(var_52);
    var_64 = wp::where(var_60, var_63, var_52);
    // return wp.vec4(signed_distance, boundary_radial, boundary_z, wp.where(use_cap, 1.0, 0.0))       <L 382>
    var_67 = wp::where(var_49, var_65, var_66);
    var_68 = wp::vec_t<4, wp::float32>(var_64, var_50, var_51, var_67);
    return var_68;
}


// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:385
static CUDA_CALLABLE wp::float32 _sdf_barrel_cylinder_z_0(
    wp::vec_t<3, wp::float32> var_point,
    wp::float32 var_radius,
    wp::float32 var_half_height,
    wp::float32 var_barrel_radius)
{
    ...
    //---------
    // forward
    // def _sdf_barrel_cylinder_z(point: wp.vec3, radius: float, half_height: float, barrel_radius: float):       <L 386>
    // return _sdf_barrel_cylinder_data_z(point, radius, half_height, barrel_radius)[0]       <L 387>
    var_0 = _sdf_barrel_cylinder_data_z_0(var_point, var_radius, var_half_height, var_barrel_radius);
    var_2 = wp::extract(var_0, var_1);
    return var_2;
}


// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:156
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:418
    ...
    wp::float32 var_barrel_radius)
{
    ...
    //---------
    // forward
    // def sdf_cylinder(                                                                      <L 419>
    // point_z_up = _sdf_point_to_z_up(point, up_axis)                                        <L 441>
    var_0 = _sdf_point_to_z_up_0(var_point, var_up_axis);
    // if barrel_radius > 0.0:                                                                <L 442>
    var_2 = (var_barrel_radius > var_1);
    if (var_2) {
        // return _sdf_barrel_cylinder_z(point_z_up, radius, half_height, barrel_radius)       <L 443>
        var_3 = _sdf_barrel_cylinder_z_0(var_0, var_radius, var_half_height, var_barrel_radius);
        return var_3;
    }
    // if top_radius < 0.0 or wp.abs(top_radius - radius) <= 1.0e-6:                          <L 444>
    var_6 = (var_top_radius < var_5);
    var_4 = var_6;
    if (!var_4) {
        var_7 = wp::sub(var_top_radius, var_radius);
        var_8 = wp::abs(var_7);
        var_10 = (var_8 <= var_9);
        var_4 = var_4 || var_10;
    }
    if (var_4) {
        // dx = wp.length(wp.vec3(point_z_up[0], point_z_up[1], 0.0)) - radius                <L 445>
        var_12 = wp::extract(var_0, var_11);
        var_14 = wp::extract(var_0, var_13);
        var_16 = wp::vec_t<3, wp::float32>(var_12, var_14, var_15);
        var_17 = wp::length(var_16);
        var_18 = wp::sub(var_17, var_radius);
        // dy = wp.abs(point_z_up[2]) - half_height                                           <L 446>
        var_20 = wp::extract(var_0, var_19);
        var_21 = wp::abs(var_20);
        var_22 = wp::sub(var_21, var_half_height);
        // return wp.min(wp.max(dx, dy), 0.0) + wp.length(wp.vec2(wp.max(dx, 0.0), wp.max(dy, 0.0)))       <L 447>
        var_23 = wp::max(var_18, var_22);
        var_25 = wp::min(var_23, var_24);
        var_27 = wp::max(var_18, var_26);
        var_29 = wp::max(var_22, var_28);
        var_30 = wp::vec_t<2, wp::float32>(var_27, var_29);
        var_31 = wp::length(var_30);
        var_32 = wp::add(var_25, var_31);
        return var_32;
    }
    // return _sdf_capped_cone_z(radius, top_radius, half_height, point_z_up)                 <L 448>
    var_33 = _sdf_capped_cone_z_0(var_radius, var_top_radius, var_half_height, var_0);
    return var_33;
}


// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:546
    ...
    wp::vec_t<3, wp::float32> var_radii)
{
    ...
    //---------
    // forward
    // def sdf_ellipsoid(point: wp.vec3, radii: wp.vec3):                                     <L 547>
    // eps = 1.0e-8                                                                           <L 559>
    // r = wp.vec3(                                                                           <L 560>
    // wp.max(wp.abs(radii[0]), eps),                                                         <L 561>
    var_2 = wp::extract(var_radii, var_1);
    var_3 = wp::abs(var_2);
    var_4 = wp::max(var_3, var_0);
    // wp.max(wp.abs(radii[1]), eps),                                                         <L 562>
    var_6 = wp::extract(var_radii, var_5);
    var_7 = wp::abs(var_6);
    var_8 = wp::max(var_7, var_0);
    // wp.max(wp.abs(radii[2]), eps),                                                         <L 563>
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:612
    ...
    wp::int32 var_up_axis)
{
    ...
    //---------
    // forward
    // def sdf_cone(point: wp.vec3, radius: float, half_height: float, up_axis: int = int(Axis.Y)):       <L 613>
    // point_z_up = _sdf_point_to_z_up(point, up_axis)                                        <L 625>
    var_0 = _sdf_point_to_z_up_0(var_point, var_up_axis);
    // return _sdf_capped_cone_z(radius, 0.0, half_height, point_z_up)                        <L 626>
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:347
static CUDA_CALLABLE void adj__sdf_barrel_cylinder_data_z_0(
    wp::vec_t<3, wp::float32> var_point,
    wp::float32 var_radius,
    wp::float32 var_half_height,
    wp::float32 var_barrel_radius,
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/kernels.py:385
static CUDA_CALLABLE void adj__sdf_barrel_cylinder_z_0(
    wp::vec_t<3, wp::float32> var_point,
    wp::float32 var_radius,
    wp::float32 var_half_height,
    wp::float32 var_barrel_radius,
...
extern "C" __global__ void generate_isomesh_kernel_ea035a7a_cuda_kernel_forward(
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_face_normals)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // tri_range_start = tri_range_table[cube_idx]                                            <L 1381>
        var_187 = wp::address(var_tri_range_table, var_186);
        var_189 = wp::load(var_187);
        var_188 = wp::copy(var_189);
        // tri_range_end = tri_range_table[cube_idx + 1]                                          <L 1382>
        ...
        // num_verts = tri_range_end - tri_range_start                                            <L 1383>
        var_195 = wp::sub(var_193, var_188);
        // num_faces = num_verts // 3                                                             <L 1385>
        var_197 = wp::floordiv(var_195, var_196);
        // out_idx_faces = wp.atomic_add(face_count, 0, num_faces)                                <L 1386>
        var_199 = wp::atomic_add(var_face_count, var_198, var_197);
        // if num_verts == 0:                                                                     <L 1388>
        var_201 = (var_195 == var_200);
        if (var_201) {
            // return                                                                             <L 1389>
            continue;
        }
        // for fi in range(5):                                                                    <L 1391>
        // if fi >= num_faces:                                                                    <L 1392>
        var_203 = (var_202 >= var_197);
        if (var_203) {
            // return                                                                             <L 1393>
            continue;
        }
        // _area, normal, _face_center, _pen_depth, face_verts = mc_calc_face(                    <L 1394>
        // flat_edge_verts_table,                                                                 <L 1395>
        // corner_offsets_table,                                                                  <L 1396>
        // tri_range_start + 3 * fi,                                                              <L 1397>
        ...
        // vertices[3 * out_idx_faces + 3 * fi + 0] = wp.vec3(face_verts[0])                      <L 1405>
        ...
        // vertices[3 * out_idx_faces + 3 * fi + 1] = wp.vec3(face_verts[1])                      <L 1406>
        ...
        // vertices[3 * out_idx_faces + 3 * fi + 2] = wp.vec3(face_verts[2])                      <L 1407>
        ...
        // face_normals[out_idx_faces + fi] = normal                                              <L 1408>
    ...
    wp::array_t<wp::int32> var_face_count)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def _count_dense_mc_faces_kernel(                                                      <L 1466>
        // x, y, z = wp.tid()                                                                     <L 1475>
        builtin_tid3d(var_0, var_1, var_2);
        // cube_idx = wp.int32(0)                                                                 <L 1476>
        var_4 = wp::int32(var_3);
        // for i in range(8):                                                                     <L 1477>
        // co = wp.vec3i(corner_offsets_table[i])                                                 <L 1478>
        var_6 = wp::address(var_corner_offsets_table, var_5);
        var_8 = wp::load(var_6);
        var_7 = wp::vec_t<3, wp::int32>(var_8);
        // v = sdf_values[(x + co[0]) * ny * nz + (y + co[1]) * nz + (z + co[2])]                 <L 1479>
        var_10 = wp::extract(var_7, var_9);
        ...
        // num_faces = (tri_end - tri_start) // 3                                                 <L 1484>
        var_229 = wp::sub(var_227, var_222);
        var_231 = wp::floordiv(var_229, var_230);
        // if num_faces > 0:                                                                      <L 1485>
        var_233 = (var_231 > var_232);
        if (var_233) {
            // wp.atomic_add(face_count, 0, num_faces)                                            <L 1486>
    ...
    wp::float32 var_winding_threshold)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def sdf_from_mesh_kernel(                                                              <L 703>
        // tile_idx, local_x, local_y, local_z = wp.tid()                                         <L 714>
        builtin_tid4d(var_0, var_1, var_2, var_3);
        // tile_origin = tile_points[tile_idx]                                                    <L 717>
        var_4 = wp::address(var_tile_points, var_0);
        var_6 = wp::load(var_4);
        var_5 = wp::copy(var_6);
        // x_id = tile_origin[0] + local_x                                                        <L 718>
        var_8 = wp::extract(var_5, var_7);
        var_9 = wp::add(var_8, var_1);
        // y_id = tile_origin[1] + local_y                                                        <L 719>
        var_11 = wp::extract(var_5, var_10);
        var_12 = wp::add(var_11, var_2);
        // z_id = tile_origin[2] + local_z                                                        <L 720>
        var_14 = wp::extract(var_5, var_13);
        var_15 = wp::add(var_14, var_3);
        // sample_pos = wp.volume_index_to_world(sdf, int_to_vec3f(x_id, y_id, z_id))             <L 722>
        var_16 = int_to_vec3f_0(var_9, var_12, var_15);
        var_17 = wp::volume_index_to_world(var_sdf, var_16);
        // signed_distance = get_distance_to_mesh(mesh, sample_pos, 10000.0, winding_threshold)       <L 723>
        var_19 = get_distance_to_mesh_0(var_mesh, var_17, var_18, var_winding_threshold);
        // signed_distance -= shape_margin                                                        <L 724>
        var_20 = wp::sub(var_19, var_shape_margin);
        // wp.volume_store(sdf, x_id, y_id, z_id, signed_distance)                                <L 725>
    ...
    wp::float32 adj_winding_threshold)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // reverse
        // adj: wp.volume_store(sdf, x_id, y_id, z_id, signed_distance)                           <L 725>
        wp::adj_sub(var_19, var_shape_margin, adj_19, adj_shape_margin, adj_20);
        // adj: signed_distance -= shape_margin                                                   <L 724>
        ...
        // adj: signed_distance = get_distance_to_mesh(mesh, sample_pos, 10000.0, winding_threshold)  <L 723>
...
extern "C" __global__ void sdf_from_primitive_kernel_d3577a28_cuda_kernel_forward(
    wp::launch_bounds_t<4> dim,
    ...
    wp::float32 var_shape_margin)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def sdf_from_primitive_kernel(                                                         <L 729>
        // tile_idx, local_x, local_y, local_z = wp.tid()                                         <L 740>
        builtin_tid4d(var_0, var_1, var_2, var_3);
        // tile_origin = tile_points[tile_idx]                                                    <L 742>
        var_4 = wp::address(var_tile_points, var_0);
        var_6 = wp::load(var_4);
        var_5 = wp::copy(var_6);
        // x_id = tile_origin[0] + local_x                                                        <L 743>
        var_8 = wp::extract(var_5, var_7);
        var_9 = wp::add(var_8, var_1);
        // y_id = tile_origin[1] + local_y                                                        <L 744>
        var_11 = wp::extract(var_5, var_10);
        var_12 = wp::add(var_11, var_2);
        // z_id = tile_origin[2] + local_z                                                        <L 745>
        var_14 = wp::extract(var_5, var_13);
        var_15 = wp::add(var_14, var_3);
        // sample_pos = wp.volume_index_to_world(sdf, int_to_vec3f(x_id, y_id, z_id))             <L 747>
        var_16 = int_to_vec3f_0(var_9, var_12, var_15);
        var_17 = wp::volume_index_to_world(var_sdf, var_16);
        // signed_distance = float(1.0e6)                                                         <L 748>
        var_19 = wp::float(var_18);
        // if shape_type == GeoType.SPHERE:                                                       <L 749>
        var_21 = (var_shape_type == var_20);
        if (var_21) {
            // signed_distance = sdf_sphere(sample_pos, shape_scale[0])                           <L 750>
            var_23 = wp::extract(var_shape_scale, var_22);
            var_24 = sdf_sphere_0(var_17, var_23);
        }
        if (!var_21) {
            // elif shape_type == GeoType.BOX:                                                    <L 751>
            var_26 = (var_shape_type == var_25);
            if (var_26) {
                // signed_distance = sdf_box(sample_pos, shape_scale[0], shape_scale[1], shape_scale[2])       <L 752>
            ...
            if (!var_26) {
                // elif shape_type == GeoType.CAPSULE:                                            <L 753>
                var_35 = (var_shape_type == var_34);
                if (var_35) {
                    // signed_distance = sdf_capsule(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z))       <L 754>
                ...
                if (!var_35) {
                    // elif shape_type == GeoType.CYLINDER:                                       <L 755>
                    var_45 = (var_shape_type == var_44);
                    if (var_45) {
                        // signed_distance = sdf_cylinder(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z), -1.0, shape_scale[2])       <L 756>
                        var_47 = wp::extract(var_shape_scale, var_46);
                        var_49 = wp::extract(var_shape_scale, var_48);
                        var_52 = wp::int(var_51);
                        var_55 = wp::extract(var_shape_scale, var_54);
                        var_56 = sdf_cylinder_0(var_17, var_47, var_49, var_52, var_53, var_55);
                    }
                    if (!var_45) {
                        // elif shape_type == GeoType.ELLIPSOID:                                  <L 757>
                        var_58 = (var_shape_type == var_57);
                        if (var_58) {
                            // signed_distance = sdf_ellipsoid(sample_pos, shape_scale)           <L 758>
                            var_59 = sdf_ellipsoid_0(var_17, var_shape_scale);
                        }
                        if (!var_58) {
                            // elif shape_type == GeoType.CONE:                                   <L 759>
                            var_61 = (var_shape_type == var_60);
                            if (var_61) {
                                // signed_distance = sdf_cone(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z))       <L 760>
                                var_63 = wp::extract(var_shape_scale, var_62);
                                var_65 = wp::extract(var_shape_scale, var_64);
                                var_68 = wp::int(var_67);
                                var_69 = sdf_cone_0(var_17, var_63, var_65, var_68);
                            }
                            var_70 = wp::where(var_61, var_69, var_19);
                        }
                        var_71 = wp::where(var_58, var_59, var_70);
                    }
                    var_72 = wp::where(var_45, var_56, var_71);
                }
                var_73 = wp::where(var_35, var_43, var_72);
            }
            var_74 = wp::where(var_26, var_33, var_73);
        }
        var_75 = wp::where(var_21, var_24, var_74);
        // signed_distance -= shape_margin                                                        <L 761>
        var_76 = wp::sub(var_75, var_shape_margin);
        // wp.volume_store(sdf, x_id, y_id, z_id, signed_distance)                                <L 762>
        wp::volume_store(var_sdf, var_9, var_12, var_15, var_76);
    }
}



extern "C" __global__ void _populate_dense_sdf_kernel_d4c9a555_cuda_kernel_forward(
    wp::launch_bounds_t<3> dim,
    wp::int32 var_shape_type,
    wp::vec_t<3, wp::float32> var_shape_scale,
    ...
    wp::array_t<wp::float32> var_sdf_values)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def _populate_dense_sdf_kernel(                                                        <L 1432>
        // x, y, z = wp.tid()                                                                     <L 1443>
        builtin_tid3d(var_0, var_1, var_2);
        // pos = wp.vec3(                                                                         <L 1444>
        // origin[0] + float(x) * voxel_size[0],                                                  <L 1445>
        ...
        // origin[1] + float(y) * voxel_size[1],                                                  <L 1446>
        ...
        // origin[2] + float(z) * voxel_size[2],                                                  <L 1447>
        ...
        // d = float(1.0e6)                                                                       <L 1449>
        var_26 = wp::float(var_25);
        // if shape_type == GeoType.SPHERE:                                                       <L 1450>
        var_28 = (var_shape_type == var_27);
        if (var_28) {
            // d = sdf_sphere(pos, shape_scale[0])                                                <L 1451>
            var_30 = wp::extract(var_shape_scale, var_29);
            var_31 = sdf_sphere_0(var_24, var_30);
        }
        if (!var_28) {
            // elif shape_type == GeoType.BOX:                                                    <L 1452>
            var_33 = (var_shape_type == var_32);
            if (var_33) {
                // d = sdf_box(pos, shape_scale[0], shape_scale[1], shape_scale[2])               <L 1453>
            ...
            if (!var_33) {
                // elif shape_type == GeoType.CAPSULE:                                            <L 1454>
                var_42 = (var_shape_type == var_41);
                if (var_42) {
                    // d = sdf_capsule(pos, shape_scale[0], shape_scale[1], int(Axis.Z))          <L 1455>
                ...
                if (!var_42) {
                    // elif shape_type == GeoType.CYLINDER:                                       <L 1456>
                    var_52 = (var_shape_type == var_51);
                    if (var_52) {
                        // d = sdf_cylinder(pos, shape_scale[0], shape_scale[1], int(Axis.Z), -1.0, shape_scale[2])       <L 1457>
                        var_54 = wp::extract(var_shape_scale, var_53);
                        var_56 = wp::extract(var_shape_scale, var_55);
                        var_59 = wp::int(var_58);
                        var_62 = wp::extract(var_shape_scale, var_61);
                        var_63 = sdf_cylinder_0(var_24, var_54, var_56, var_59, var_60, var_62);
                    }
                    if (!var_52) {
                        // elif shape_type == GeoType.ELLIPSOID:                                  <L 1458>
                        var_65 = (var_shape_type == var_64);
                        if (var_65) {
                            // d = sdf_ellipsoid(pos, shape_scale)                                <L 1459>
                            var_66 = sdf_ellipsoid_0(var_24, var_shape_scale);
                        }
                        if (!var_65) {
                            // elif shape_type == GeoType.CONE:                                   <L 1460>
                            var_68 = (var_shape_type == var_67);
                            if (var_68) {
                                // d = sdf_cone(pos, shape_scale[0], shape_scale[1], int(Axis.Z))       <L 1461>
                                var_70 = wp::extract(var_shape_scale, var_69);
                                var_72 = wp::extract(var_shape_scale, var_71);
                                var_75 = wp::int(var_74);
                                var_76 = sdf_cone_0(var_24, var_70, var_72, var_75);
                            }
                            var_77 = wp::where(var_68, var_76, var_26);
                        }
                        var_78 = wp::where(var_65, var_66, var_77);
                    }
                    var_79 = wp::where(var_52, var_63, var_78);
                }
                var_80 = wp::where(var_42, var_50, var_79);
            }
            var_81 = wp::where(var_33, var_40, var_80);
        }
        var_82 = wp::where(var_28, var_31, var_81);
        // sdf_values[x * ny * nz + y * nz + z] = d - shape_offset                                <L 1462>
        var_83 = wp::sub(var_82, var_shape_offset);
        var_84 = wp::mul(var_0, var_ny);
        var_85 = wp::mul(var_84, var_nz);
        var_86 = wp::mul(var_1, var_nz);
        var_87 = wp::add(var_85, var_86);
        var_88 = wp::add(var_87, var_2);
        wp::array_store(var_sdf_values, var_88, var_83);
    }
}
    ...
    wp::array_t<wp::vec_t<3, wp::float32>> var_face_normals)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def _generate_dense_mc_kernel(                                                         <L 1490>
        // x, y, z = wp.tid()                                                                     <L 1504>
        builtin_tid3d(var_0, var_1, var_2);
        // cube_idx = wp.int32(0)                                                                 <L 1505>
        var_4 = wp::int32(var_3);
        // corner_vals = vec8f()                                                                  <L 1506>
        var_5 = wp::vec_t<8, wp::float32>();
        // for i in range(8):                                                                     <L 1507>
        // co = wp.vec3i(corner_offsets_table[i])                                                 <L 1508>
        var_7 = wp::address(var_corner_offsets_table, var_6);
        var_9 = wp::load(var_7);
        var_8 = wp::vec_t<3, wp::int32>(var_9);
        // v = sdf_values[(x + co[0]) * ny * nz + (y + co[1]) * nz + (z + co[2])]                 <L 1509>
        ...
        // num_verts = tri_end - tri_start                                                        <L 1516>
        var_230 = wp::sub(var_228, var_223);
        // num_faces = num_verts // 3                                                             <L 1517>
        var_232 = wp::floordiv(var_230, var_231);
        // out_idx = wp.atomic_add(face_count, 0, num_faces)                                      <L 1518>
        var_234 = wp::atomic_add(var_face_count, var_233, var_232);
        // if num_verts == 0:                                                                     <L 1519>
        var_236 = (var_230 == var_235);
        if (var_236) {
            // return                                                                             <L 1520>
            continue;
        }
        // base = wp.vec3(float(x), float(y), float(z))                                           <L 1522>
        var_237 = wp::float(var_0);
        var_238 = wp::float(var_1);
        var_239 = wp::float(var_2);
        var_240 = wp::vec_t<3, wp::float32>(var_237, var_238, var_239);
        // for fi in range(5):                                                                    <L 1523>
        // if fi >= num_faces:                                                                    <L 1524>
        var_242 = (var_241 >= var_232);
        if (var_242) {
            // return                                                                             <L 1525>
            continue;
        }
        // face_verts = wp.mat33f()                                                               <L 1526>
        var_243 = wp::mat_t<3, 3, wp::float32>();
        // for vi in range(3):                                                                    <L 1527>
        // ev = wp.vec2i(flat_edge_verts_table[tri_start + 3 * fi + vi])                          <L 1528>
        ...
        // p_1 = wp.vec3f(corner_offsets_table[ev[1]])                                            <L 1532>
        ...
        // face_verts[vi] = wp.vec3(                                                              <L 1540>
        // origin[0] + local[0] * voxel_size[0],                                                  <L 1541>
        ...
        // origin[1] + local[1] * voxel_size[1],                                                  <L 1542>
        ...
        // origin[2] + local[2] * voxel_size[2],                                                  <L 1543>
        ...
        // n = wp.cross(face_verts[1] - face_verts[0], face_verts[2] - face_verts[0])             <L 1545>
        ...
        // vertices[3 * out_idx + 3 * fi + 1] = wp.vec3(face_verts[1])                            <L 1552>
        ...
        // vertices[3 * out_idx + 3 * fi + 2] = wp.vec3(face_verts[2])                            <L 1553>
        ...
        // face_normals[out_idx + fi] = normal                                                    <L 1554>
    ...
    wp::array_t<wp::float32> var_volume_sum)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def compute_mesh_signed_volume_kernel(                                                 <L 637>
        // tri_idx = wp.tid()                                                                     <L 643>
        var_0 = builtin_tid1d();
        // v0 = points[indices[tri_idx * 3 + 0]]                                                  <L 644>
        ...
        var_9 = wp::load(var_6);
        var_8 = wp::copy(var_9);
        // v1 = points[indices[tri_idx * 3 + 1]]                                                  <L 645>
        ...
        // v2 = points[indices[tri_idx * 3 + 2]]                                                  <L 646>
        ...
        // wp.atomic_add(volume_sum, 0, wp.dot(v0, wp.cross(v1, v2)) / 6.0)                       <L 647>
    ...
    wp::array_t<wp::float32> adj_volume_sum)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: wp.atomic_add(volume_sum, 0, wp.dot(v0, wp.cross(v1, v2)) / 6.0)                  <L 647>
        ...
        // adj: v2 = points[indices[tri_idx * 3 + 2]]                                             <L 646>
        ...
        // adj: v1 = points[indices[tri_idx * 3 + 1]]                                             <L 645>
        ...
        // adj: v0 = points[indices[tri_idx * 3 + 0]]                                             <L 644>
        // adj: tri_idx = wp.tid()                                                                <L 643>
        // adj: def compute_mesh_signed_volume_kernel(                                            <L 637>
        continue;
    }
}
    ...
    wp::array_t<bool> var_tile_occupied)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def check_tile_occupied_mesh_kernel(                                                   <L 766>
        // tid = wp.tid()                                                                         <L 773>
        var_0 = builtin_tid1d();
        // sample_pos = tile_points[tid]                                                          <L 774>
        var_1 = wp::address(var_tile_points, var_0);
        var_3 = wp::load(var_1);
        var_2 = wp::copy(var_3);
        // signed_distance = get_distance_to_mesh(mesh, sample_pos, 10000.0, winding_threshold)       <L 776>
        var_5 = get_distance_to_mesh_0(var_mesh, var_2, var_4, var_winding_threshold);
        // is_occupied = wp.bool(False)                                                           <L 777>
        var_7 = bool(var_6);
        // if wp.sign(signed_distance) > 0.0:                                                     <L 778>
        var_8 = wp::sign(var_5);
        var_10 = (var_8 > var_9);
        if (var_10) {
            // is_occupied = signed_distance < threshold[1]                                       <L 779>
            var_12 = wp::extract(var_threshold, var_11);
            var_13 = (var_5 < var_12);
        }
        if (!var_10) {
            // is_occupied = signed_distance > threshold[0]                                       <L 781>
            var_15 = wp::extract(var_threshold, var_14);
            var_16 = (var_5 > var_15);
        }
        var_17 = wp::where(var_10, var_13, var_16);
        // tile_occupied[tid] = is_occupied                                                       <L 782>
    ...
    wp::array_t<bool> adj_tile_occupied)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        // adj: tile_occupied[tid] = is_occupied                                                  <L 782>
        ...
        if (!var_10) {
            ...
            // adj: is_occupied = signed_distance > threshold[0]                                  <L 781>
        }
        if (var_10) {
            wp::adj_extract(var_threshold, var_11, adj_threshold, adj_11, adj_12);
            // adj: is_occupied = signed_distance < threshold[1]                                  <L 779>
        }
        // adj: if wp.sign(signed_distance) > 0.0:                                                <L 778>
        // adj: is_occupied = wp.bool(False)                                                      <L 777>
        adj_get_distance_to_mesh_0(var_mesh, var_2, var_4, var_winding_threshold, adj_mesh, adj_2, adj_4, adj_winding_threshold, adj_5);
        // adj: signed_distance = get_distance_to_mesh(mesh, sample_pos, 10000.0, winding_threshold)  <L 776>
        wp::adj_copy(var_3, adj_1, adj_2);
        wp::adj_address(var_tile_points, var_0, adj_tile_points, adj_0, adj_1);
        // adj: sample_pos = tile_points[tid]                                                     <L 774>
        // adj: tid = wp.tid()                                                                    <L 773>
        // adj: def check_tile_occupied_mesh_kernel(                                              <L 766>
        continue;
    }
}
...
extern "C" __global__ void check_tile_occupied_primitive_kernel_ae14c9ef_cuda_kernel_forward(
    wp::launch_bounds_t<1> dim,
    wp::int32 var_shape_type,
    wp::vec_t<3, wp::float32> var_shape_scale,
    wp::array_t<wp::vec_t<3, wp::float32>> var_tile_points,
    ...
    wp::array_t<bool> var_tile_occupied)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def check_tile_occupied_primitive_kernel(                                              <L 786>
        // tid = wp.tid()                                                                         <L 793>
        var_0 = builtin_tid1d();
        // sample_pos = tile_points[tid]                                                          <L 794>
        var_1 = wp::address(var_tile_points, var_0);
        var_3 = wp::load(var_1);
        var_2 = wp::copy(var_3);
        // signed_distance = float(1.0e6)                                                         <L 796>
        var_5 = wp::float(var_4);
        // if shape_type == GeoType.SPHERE:                                                       <L 797>
        var_7 = (var_shape_type == var_6);
        if (var_7) {
            // signed_distance = sdf_sphere(sample_pos, shape_scale[0])                           <L 798>
            var_9 = wp::extract(var_shape_scale, var_8);
            var_10 = sdf_sphere_0(var_2, var_9);
        }
        if (!var_7) {
            // elif shape_type == GeoType.BOX:                                                    <L 799>
            var_12 = (var_shape_type == var_11);
            if (var_12) {
                // signed_distance = sdf_box(sample_pos, shape_scale[0], shape_scale[1], shape_scale[2])       <L 800>
            ...
            if (!var_12) {
                // elif shape_type == GeoType.CAPSULE:                                            <L 801>
                var_21 = (var_shape_type == var_20);
                if (var_21) {
                    // signed_distance = sdf_capsule(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z))       <L 802>
                    var_23 = wp::extract(var_shape_scale, var_22);
                ...
                if (!var_21) {
                    // elif shape_type == GeoType.CYLINDER:                                       <L 803>
                    var_31 = (var_shape_type == var_30);
                    if (var_31) {
                        // signed_distance = sdf_cylinder(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z), -1.0, shape_scale[2])       <L 804>
                        var_33 = wp::extract(var_shape_scale, var_32);
                        var_35 = wp::extract(var_shape_scale, var_34);
                        var_38 = wp::int(var_37);
                        var_41 = wp::extract(var_shape_scale, var_40);
                        var_42 = sdf_cylinder_0(var_2, var_33, var_35, var_38, var_39, var_41);
                    }
                    if (!var_31) {
                        // elif shape_type == GeoType.ELLIPSOID:                                  <L 805>
                        var_44 = (var_shape_type == var_43);
                        if (var_44) {
                            // signed_distance = sdf_ellipsoid(sample_pos, shape_scale)           <L 806>
                            var_45 = sdf_ellipsoid_0(var_2, var_shape_scale);
                        }
                        if (!var_44) {
                            // elif shape_type == GeoType.CONE:                                   <L 807>
                            var_47 = (var_shape_type == var_46);
                            if (var_47) {
                                // signed_distance = sdf_cone(sample_pos, shape_scale[0], shape_scale[1], int(Axis.Z))       <L 808>
                                var_49 = wp::extract(var_shape_scale, var_48);
                                var_51 = wp::extract(var_shape_scale, var_50);
                                var_54 = wp::int(var_53);
                                var_55 = sdf_cone_0(var_2, var_49, var_51, var_54);
                            }
                            var_56 = wp::where(var_47, var_55, var_5);
                        }
                        var_57 = wp::where(var_44, var_45, var_56);
                    }
                    var_58 = wp::where(var_31, var_42, var_57);
                }
                var_59 = wp::where(var_21, var_29, var_58);
            }
            var_60 = wp::where(var_12, var_19, var_59);
        }
        var_61 = wp::where(var_7, var_10, var_60);
        // is_occupied = wp.bool(False)                                                           <L 810>
        var_63 = bool(var_62);
        // if wp.sign(signed_distance) > 0.0:                                                     <L 811>
        var_64 = wp::sign(var_61);
        var_66 = (var_64 > var_65);
        if (var_66) {
            // is_occupied = signed_distance < threshold[1]                                       <L 812>
            var_68 = wp::extract(var_threshold, var_67);
            var_69 = (var_61 < var_68);
        }
        if (!var_66) {
            // is_occupied = signed_distance > threshold[0]                                       <L 814>
            var_71 = wp::extract(var_threshold, var_70);
            var_72 = (var_61 > var_71);
        }
        var_73 = wp::where(var_66, var_69, var_72);
        // tile_occupied[tid] = is_occupied                                                       <L 815>
        wp::array_store(var_tile_occupied, var_0, var_73);
    }
}
    ...
    wp::array_t<wp::int32> var_face_count)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        //---------
        // forward
        // def count_isomesh_faces_kernel(                                                        <L 1304>
        // tile_idx, local_x, local_y, local_z = wp.tid()                                         <L 1315>
        builtin_tid4d(var_0, var_1, var_2, var_3);
        // tile_origin = tile_points[tile_idx]                                                    <L 1317>
        var_4 = wp::address(var_tile_points, var_0);
        var_6 = wp::load(var_4);
        var_5 = wp::copy(var_6);
        // x_id = tile_origin[0] + local_x                                                        <L 1318>
        var_8 = wp::extract(var_5, var_7);
        var_9 = wp::add(var_8, var_1);
        // y_id = tile_origin[1] + local_y                                                        <L 1319>
        var_11 = wp::extract(var_5, var_10);
        var_12 = wp::add(var_11, var_2);
        // z_id = tile_origin[2] + local_z                                                        <L 1320>
        var_14 = wp::extract(var_5, var_13);
        var_15 = wp::add(var_14, var_3);
        // cube_idx = wp.int32(0)                                                                 <L 1322>
        var_17 = wp::int32(var_16);
        // for i in range(8):                                                                     <L 1323>
        // corner_offset = wp.vec3i(corner_offsets_table[i])                                      <L 1324>
        var_19 = wp::address(var_corner_offsets_table, var_18);
        var_21 = wp::load(var_19);
        var_20 = wp::vec_t<3, wp::int32>(var_21);
        // x = x_id + corner_offset.x                                                             <L 1325>
        var_23 = wp::extract(var_20, var_22);
        var_24 = wp::add(var_9, var_23);
        // y = y_id + corner_offset.y                                                             <L 1326>
        var_26 = wp::extract(var_20, var_25);
        var_27 = wp::add(var_12, var_26);
        // z = z_id + corner_offset.z                                                             <L 1327>
        var_29 = wp::extract(var_20, var_28);
        var_30 = wp::add(var_15, var_29);
        // v = wp.volume_lookup_f(sdf, x, y, z)                                                   <L 1328>
        var_31 = wp::volume_lookup_f(var_sdf, var_24, var_27, var_30);
        // if v >= wp.static(MAXVAL * 0.99):                                                      <L 1329>
        var_33 = (var_31 >= var_32);
        if (var_33) {
            // return                                                                             <L 1330>
            continue;
        }
        // if v < isovalue:                                                                       <L 1331>
        ...
        // tri_range_start = tri_range_table[cube_idx]                                            <L 1335>
        var_186 = wp::address(var_tri_range_table, var_185);
        var_188 = wp::load(var_186);
        var_187 = wp::copy(var_188);
        // tri_range_end = tri_range_table[cube_idx + 1]                                          <L 1336>
        ...
        // num_verts = tri_range_end - tri_range_start                                            <L 1337>
        var_194 = wp::sub(var_192, var_187);
        // num_faces = num_verts // 3                                                             <L 1339>
        var_196 = wp::floordiv(var_194, var_195);
        // if num_faces > 0:                                                                      <L 1340>
        var_198 = (var_196 > var_197);
        if (var_198) {
            // wp.atomic_add(face_count, 0, num_faces)                                            <L 1341>
