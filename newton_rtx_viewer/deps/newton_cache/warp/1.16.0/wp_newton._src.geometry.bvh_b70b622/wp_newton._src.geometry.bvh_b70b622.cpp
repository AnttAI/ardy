...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:82
static void compute_sphere_bounds_0(
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:62
static void compute_box_bounds_0(
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:87
static void compute_capsule_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:95
static void compute_cylinder_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    var_3 = wp::extract(var_size, var_2);
    // barrel_radius = size[2]                                                                <L 99>
    var_5 = wp::extract(var_size, var_4);
    // radial_extent = radius                                                                 <L 100>
    var_6 = wp::copy(var_1);
    // if barrel_radius > 0.0:                                                                <L 101>
    var_8 = (var_5 > var_7);
    if (var_8) {
        // radial_extent += (half_length * half_length) / (                                   <L 102>
        var_9 = wp::mul(var_3, var_3);
        // barrel_radius + wp.sqrt(barrel_radius * barrel_radius - half_length * half_length)       <L 103>
        var_10 = wp::mul(var_5, var_5);
        var_11 = wp::mul(var_3, var_3);
        var_12 = wp::sub(var_10, var_11);
        var_13 = wp::sqrt(var_12);
        var_14 = wp::add(var_5, var_13);
        var_15 = wp::div(var_9, var_14);
        // radial_extent += (half_length * half_length) / (                                   <L 102>
        var_16 = wp::add(var_6, var_15);
    }
    var_17 = wp::where(var_8, var_16, var_6);
    // extent = wp.vec3f(radial_extent, radial_extent, half_length)                           <L 105>
    var_18 = wp::vec_t<3, wp::float32>(var_17, var_17, var_3);
    // return compute_box_bounds(transform, extent)                                           <L 106>
    compute_box_bounds_0(var_transform, var_18, var_19, var_20);
    ret_0 = var_19;
    ret_1 = var_20;
    return;
}
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:109
static void compute_cone_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    //---------
    // forward
    // def compute_cone_bounds(transform: wp.transformf, size: wp.vec3f) -> tuple[wp.vec3f, wp.vec3f]:       <L 110>
    // extent = wp.vec3f(size[0], size[0], size[1])                                           <L 111>
    var_1 = wp::extract(var_size, var_0);
    var_3 = wp::extract(var_size, var_2);
    var_5 = wp::extract(var_size, var_4);
    var_6 = wp::vec_t<3, wp::float32>(var_1, var_3, var_5);
    // return compute_box_bounds(transform, extent)                                           <L 112>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:115
static void compute_plane_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    //---------
    // forward
    // def compute_plane_bounds(transform: wp.transformf, size: wp.vec3f) -> tuple[wp.vec3f, wp.vec3f]:       <L 116>
    // size_scale = wp.max(size[0], size[1]) * 2.0                                            <L 118>
    var_1 = wp::extract(var_size, var_0);
    var_3 = wp::extract(var_size, var_2);
    var_4 = wp::max(var_1, var_3);
    var_6 = wp::mul(var_4, var_5);
    // if size[0] <= 0.0 or size[1] <= 0.0:                                                   <L 119>
    ...
    if (var_7) {
        // size_scale = 1000.0                                                                <L 120>
    }
    var_17 = wp::where(var_7, var_16, var_6);
    // min_bound = wp.vec3f(MAXVAL)                                                           <L 122>
    var_19 = wp::vec_t<3, wp::float32>(var_18);
    // max_bound = wp.vec3f(-MAXVAL)                                                          <L 123>
    var_21 = wp::vec_t<3, wp::float32>(var_20);
    // for x in range(2):                                                                     <L 125>
    // for y in range(2):                                                                     <L 126>
    // local_corner = wp.vec3f(                                                               <L 127>
    // size_scale * (2.0 * wp.float32(x) - 1.0),                                              <L 128>
    var_25 = wp::float32(var_22);
    var_26 = wp::mul(var_24, var_25);
    var_28 = wp::sub(var_26, var_27);
    var_29 = wp::mul(var_17, var_28);
    // size_scale * (2.0 * wp.float32(y) - 1.0),                                              <L 129>
    ...
    // world_corner = wp.transform_point(transform, local_corner)                             <L 132>
    var_38 = wp::transform_point(var_transform, var_37);
    // min_bound = wp.min(min_bound, world_corner)                                            <L 133>
    var_39 = wp::min(var_19, var_38);
    // max_bound = wp.max(max_bound, world_corner)                                            <L 134>
    ...
    // extent = wp.vec3f(0.1)                                                                 <L 136>
    var_97 = wp::vec_t<3, wp::float32>(var_96);
    // return min_bound - extent, max_bound + extent                                          <L 137>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:140
static void compute_ellipsoid_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    //---------
    // forward
    // def compute_ellipsoid_bounds(transform: wp.transformf, size: wp.vec3f) -> tuple[wp.vec3f, wp.vec3f]:       <L 141>
    // extent = wp.vec3f(wp.abs(size[0]), wp.abs(size[1]), wp.abs(size[2]))                   <L 142>
    var_1 = wp::extract(var_size, var_0);
    var_2 = wp::abs(var_1);
    ...
    // return compute_box_bounds(transform, extent)                                           <L 143>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:17
static void compute_shape_bounds_0(
    wp::transform_t<wp::float32> var_transform,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:146
static bool is_supported_shape_type_0(
    wp::int32 var_shape_type)
{
    ...
    //---------
    // forward
    // def is_supported_shape_type(shape_type: wp.int32) -> wp.bool:                          <L 147>
    // if shape_type == GeoType.BOX:                                                          <L 148>
    var_1 = (var_shape_type == var_0);
    if (var_1) {
        // return True                                                                        <L 149>
        return var_2;
    }
    // if shape_type == GeoType.CAPSULE:                                                      <L 150>
    var_4 = (var_shape_type == var_3);
    if (var_4) {
        // return True                                                                        <L 151>
        return var_5;
    }
    // if shape_type == GeoType.CYLINDER:                                                     <L 152>
    var_7 = (var_shape_type == var_6);
    if (var_7) {
        // return True                                                                        <L 153>
        return var_8;
    }
    // if shape_type == GeoType.ELLIPSOID:                                                    <L 154>
    var_10 = (var_shape_type == var_9);
    if (var_10) {
        // return True                                                                        <L 155>
        return var_11;
    }
    // if shape_type == GeoType.PLANE:                                                        <L 156>
    var_13 = (var_shape_type == var_12);
    if (var_13) {
        // return True                                                                        <L 157>
        return var_14;
    }
    // if shape_type == GeoType.SPHERE:                                                       <L 158>
    var_16 = (var_shape_type == var_15);
    if (var_16) {
        // return True                                                                        <L 159>
        return var_17;
    }
    // if shape_type == GeoType.CONE:                                                         <L 160>
    var_19 = (var_shape_type == var_18);
    if (var_19) {
        // return True                                                                        <L 161>
        return var_20;
    }
    // if shape_type == GeoType.MESH:                                                         <L 162>
    var_22 = (var_shape_type == var_21);
    if (var_22) {
        // return True                                                                        <L 163>
        return var_23;
    }
    // if shape_type == GeoType.CONVEX_MESH:                                                  <L 164>
    var_25 = (var_shape_type == var_24);
    if (var_25) {
        // return True                                                                        <L 165>
        return var_26;
    }
    // if shape_type == GeoType.HFIELD:                                                       <L 166>
    var_28 = (var_shape_type == var_27);
    if (var_28) {
        // return True                                                                        <L 167>
        return var_29;
    }
    // if shape_type == GeoType.GAUSSIAN:                                                     <L 168>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:193
static void compute_gaussian_bounds_0(
    ...
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    //---------
    // forward
    // def compute_gaussian_bounds(gaussians_data: Gaussian.Data, tid: wp.int32) -> tuple[wp.vec3f, wp.vec3f]:       <L 194>
    // transform = gaussians_data.transforms[tid]                                             <L 195>
    var_0 = &((var_gaussians_data).transforms);
    var_2 = wp::load(var_0);
    var_1 = wp::address(var_2, var_tid);
    var_4 = wp::load(var_1);
    var_3 = wp::copy(var_4);
    // scale = gaussians_data.scales[tid]                                                     <L 196>
    var_5 = &((var_gaussians_data).scales);
    var_7 = wp::load(var_5);
    var_6 = wp::address(var_7, var_tid);
    var_9 = wp::load(var_6);
    var_8 = wp::copy(var_9);
    // mod = gaussians_data.min_response / wp.max(gaussians_data.opacities[tid], wp.float32(1e-6))       <L 198>
    ...
    // return compute_ellipsoid_bounds(transform, scale)                                      <L 203>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:82
static void adj_compute_sphere_bounds_0(
    wp::vec_t<3, wp::float32> var_pos,
    wp::float32 var_radius,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:62
static void adj_compute_box_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:87
static void adj_compute_capsule_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:95
static void adj_compute_cylinder_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:109
static void adj_compute_cone_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:115
static void adj_compute_plane_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:140
static void adj_compute_ellipsoid_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_size,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:17
static void adj_compute_shape_bounds_0(
    wp::transform_t<wp::float32> var_transform,
    wp::vec_t<3, wp::float32> var_scale,
    wp::vec_t<3, wp::float32> var_shape_min_bounds,
    wp::vec_t<3, wp::float32> var_shape_max_bounds,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:146
static void adj_is_supported_shape_type_0(
    wp::int32 var_shape_type,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/bvh.py:193
static void adj_compute_gaussian_bounds_0(
    Gaussian__Data_f03ae6a1 var_gaussians_data,
    wp::int32 var_tid,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<3, wp::float32> & ret_1,
...
struct wp_args_compute_bvh_group_roots_a4d4455c {
    wp::uint64 bvh_id;
    wp::array_t<wp::int32> out_bvh_group_roots;
};


void compute_bvh_group_roots_a4d4455c_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_bvh_group_roots_a4d4455c *_wp_args)
{
    //---------
    // argument vars
    wp::uint64 var_bvh_id = _wp_args->bvh_id;
    wp::array_t<wp::int32> var_out_bvh_group_roots = _wp_args->out_bvh_group_roots;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    //---------
    // forward
    // def compute_bvh_group_roots(bvh_id: wp.uint64, out_bvh_group_roots: wp.array[wp.int32]):       <L 354>
    // tid = wp.tid()                                                                         <L 355>
    var_0 = builtin_tid1d();
    // out_bvh_group_roots[tid] = wp.bvh_get_group_root(bvh_id, tid)                          <L 356>
...
WP_API void compute_bvh_group_roots_a4d4455c_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_bvh_group_roots_a4d4455c *_wp_args)
{
    ...
    {
        compute_bvh_group_roots_a4d4455c_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_particle_bvh_bounds_af1b7974 {
    wp::int32 num_particles;
    wp::int32 world_count;
    wp::array_t<wp::int32> particle_world_index;
    wp::array_t<wp::vec_t<3, wp::float32>> particle_position;
    wp::array_t<wp::float32> particle_radius;
    wp::array_t<wp::vec_t<3, wp::float32>> out_bvh_lowers;
    wp::array_t<wp::vec_t<3, wp::float32>> out_bvh_uppers;
    wp::array_t<wp::int32> out_bvh_groups;
};


void compute_particle_bvh_bounds_af1b7974_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_particle_bvh_bounds_af1b7974 *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_num_particles = _wp_args->num_particles;
    wp::int32 var_world_count = _wp_args->world_count;
    wp::array_t<wp::int32> var_particle_world_index = _wp_args->particle_world_index;
    wp::array_t<wp::vec_t<3, wp::float32>> var_particle_position = _wp_args->particle_position;
    wp::array_t<wp::float32> var_particle_radius = _wp_args->particle_radius;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_bvh_lowers = _wp_args->out_bvh_lowers;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_bvh_uppers = _wp_args->out_bvh_uppers;
    wp::array_t<wp::int32> var_out_bvh_groups = _wp_args->out_bvh_groups;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32 var_1;
    ...
    //---------
    // forward
    // def compute_particle_bvh_bounds(                                                       <L 322>
    // tid = wp.tid()                                                                         <L 332>
    var_0 = builtin_tid1d();
    // bvh_index_local = tid % num_particles                                                  <L 333>
    var_1 = wp::mod(var_0, var_num_particles);
    // if bvh_index_local >= num_particles:                                                   <L 334>
    var_2 = (var_1 >= var_num_particles);
    if (var_2) {
        // return                                                                             <L 335>
        return;
    }
    // particle_index = bvh_index_local                                                       <L 337>
    var_3 = wp::copy(var_1);
    // world_index = particle_world_index[particle_index]                                     <L 339>
    var_4 = wp::address(var_particle_world_index, var_3);
    var_6 = wp::load(var_4);
    var_5 = wp::copy(var_6);
    // if world_index < 0:                                                                    <L 340>
    var_8 = (var_5 < var_7);
    if (var_8) {
        // world_index = world_count + world_index                                            <L 341>
        var_9 = wp::add(var_world_count, var_5);
    }
    var_10 = wp::where(var_8, var_9, var_5);
    // if world_index >= world_count:                                                         <L 343>
    var_11 = (var_10 >= var_world_count);
    if (var_11) {
        // return                                                                             <L 344>
        return;
    }
    // lower, upper = compute_sphere_bounds(particle_position[particle_index], particle_radius[particle_index])       <L 346>
    ...
    // out_bvh_lowers[bvh_index_local] = lower                                                <L 348>
    wp::array_store(var_out_bvh_lowers, var_1, var_14);
    // out_bvh_uppers[bvh_index_local] = upper                                                <L 349>
    wp::array_store(var_out_bvh_uppers, var_1, var_15);
    // out_bvh_groups[bvh_index_local] = world_index                                          <L 350>
...
// Python CPU entry points
WP_API void compute_particle_bvh_bounds_af1b7974_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_particle_bvh_bounds_af1b7974 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_particle_bvh_bounds_af1b7974_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_shape_bvh_bounds_5cdd8bf7 {
    wp::int32 shape_count_enabled;
    wp::int32 world_count;
    wp::array_t<wp::int32> shape_world_index;
    wp::array_t<wp::uint32> shape_enabled;
    wp::array_t<wp::int32> shape_types;
    wp::array_t<wp::vec_t<3, wp::float32>> shape_sizes;
    wp::array_t<wp::transform_t<wp::float32>> shape_transforms;
    wp::array_t<wp::vec_t<3, wp::float32>> shape_bounds;
    wp::array_t<wp::vec_t<3, wp::float32>> out_bvh_lowers;
    wp::array_t<wp::vec_t<3, wp::float32>> out_bvh_uppers;
    wp::array_t<wp::int32> out_bvh_groups;
};
...
void compute_shape_bvh_bounds_5cdd8bf7_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_shape_bvh_bounds_5cdd8bf7 *_wp_args)
{
    //---------
    // argument vars
    wp::int32 var_shape_count_enabled = _wp_args->shape_count_enabled;
    wp::int32 var_world_count = _wp_args->world_count;
    wp::array_t<wp::int32> var_shape_world_index = _wp_args->shape_world_index;
    wp::array_t<wp::uint32> var_shape_enabled = _wp_args->shape_enabled;
    wp::array_t<wp::int32> var_shape_types = _wp_args->shape_types;
    wp::array_t<wp::vec_t<3, wp::float32>> var_shape_sizes = _wp_args->shape_sizes;
    wp::array_t<wp::transform_t<wp::float32>> var_shape_transforms = _wp_args->shape_transforms;
    wp::array_t<wp::vec_t<3, wp::float32>> var_shape_bounds = _wp_args->shape_bounds;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_bvh_lowers = _wp_args->out_bvh_lowers;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_bvh_uppers = _wp_args->out_bvh_uppers;
    wp::array_t<wp::int32> var_out_bvh_groups = _wp_args->out_bvh_groups;
    //---------
    ...
    //---------
    // forward
    // def compute_shape_bvh_bounds(                                                          <L 258>
    // tid = wp.tid()                                                                         <L 271>
    var_0 = builtin_tid1d();
    // bvh_index_local = tid % shape_count_enabled                                            <L 272>
    var_1 = wp::mod(var_0, var_shape_count_enabled);
    // if bvh_index_local >= shape_count_enabled:                                             <L 273>
    var_2 = (var_1 >= var_shape_count_enabled);
    if (var_2) {
        // return                                                                             <L 274>
        return;
    }
    // shape_index = shape_enabled[bvh_index_local]                                           <L 276>
    var_3 = wp::address(var_shape_enabled, var_1);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // world_index = shape_world_index[shape_index]                                           <L 278>
    var_6 = wp::address(var_shape_world_index, var_4);
    var_8 = wp::load(var_6);
    var_7 = wp::copy(var_8);
    // if world_index < 0:                                                                    <L 279>
    var_10 = (var_7 < var_9);
    if (var_10) {
        // world_index = world_count + world_index                                            <L 280>
        var_11 = wp::add(var_world_count, var_7);
    }
    var_12 = wp::where(var_10, var_11, var_7);
    // if world_index >= world_count:                                                         <L 282>
    var_13 = (var_12 >= var_world_count);
    if (var_13) {
        // return                                                                             <L 283>
        return;
    }
    // transform = shape_transforms[shape_index]                                              <L 285>
    var_14 = wp::address(var_shape_transforms, var_4);
    var_16 = wp::load(var_14);
    var_15 = wp::copy(var_16);
    // size = shape_sizes[shape_index]                                                        <L 286>
    var_17 = wp::address(var_shape_sizes, var_4);
    var_19 = wp::load(var_17);
    var_18 = wp::copy(var_19);
    // geom_type = shape_types[shape_index]                                                   <L 287>
    var_20 = wp::address(var_shape_types, var_4);
    var_22 = wp::load(var_20);
    var_21 = wp::copy(var_22);
    // lower = wp.vec3f()                                                                     <L 289>
    var_23 = wp::vec_t<3, wp::float32>();
    // upper = wp.vec3f()                                                                     <L 290>
    var_24 = wp::vec_t<3, wp::float32>();
    // if geom_type == GeoType.SPHERE:                                                        <L 292>
    var_26 = (var_21 == var_25);
    if (var_26) {
        // lower, upper = compute_sphere_bounds(wp.transform_get_translation(transform), size[0])       <L 293>
    ...
    if (!var_26) {
        // elif geom_type == GeoType.CAPSULE:                                                 <L 294>
        var_33 = (var_21 == var_32);
        if (var_33) {
            // lower, upper = compute_capsule_bounds(transform, size)                         <L 295>
            compute_capsule_bounds_0(var_15, var_18, var_34, var_35);
        }
        if (!var_33) {
            // elif geom_type == GeoType.CYLINDER:                                            <L 296>
            var_37 = (var_21 == var_36);
            if (var_37) {
                // lower, upper = compute_cylinder_bounds(transform, size)                    <L 297>
                compute_cylinder_bounds_0(var_15, var_18, var_38, var_39);
            }
            if (!var_37) {
                // elif geom_type == GeoType.CONE:                                            <L 298>
                var_41 = (var_21 == var_40);
                if (var_41) {
                    // lower, upper = compute_cone_bounds(transform, size)                    <L 299>
                    compute_cone_bounds_0(var_15, var_18, var_42, var_43);
                }
                if (!var_41) {
                    // elif geom_type == GeoType.PLANE:                                       <L 300>
                    var_45 = (var_21 == var_44);
                    if (var_45) {
                        // lower, upper = compute_plane_bounds(transform, size)               <L 301>
                        compute_plane_bounds_0(var_15, var_18, var_46, var_47);
                    }
                    if (!var_45) {
                        // elif geom_type == GeoType.ELLIPSOID:                               <L 302>
                        var_49 = (var_21 == var_48);
                        if (var_49) {
                            // lower, upper = compute_ellipsoid_bounds(transform, size)       <L 303>
                            compute_ellipsoid_bounds_0(var_15, var_18, var_50, var_51);
                        }
                        if (!var_49) {
                            // elif geom_type == GeoType.BOX:                                 <L 304>
                            var_53 = (var_21 == var_52);
                            if (var_53) {
                                // lower, upper = compute_box_bounds(transform, size)         <L 305>
                                compute_box_bounds_0(var_15, var_18, var_54, var_55);
                            }
                            if (!var_53) {
                                // elif (                                                     <L 306>
                                // geom_type == GeoType.MESH                                  <L 307>
                                var_58 = (var_21 == var_57);
                                var_56 = var_58;
                                if (!var_56) {
                                    // or geom_type == GeoType.CONVEX_MESH                    <L 308>
                                    var_60 = (var_21 == var_59);
                                    var_56 = var_56 || var_60;
                                }
                                if (!var_56) {
                                    // or geom_type == GeoType.HFIELD                         <L 309>
                                    var_62 = (var_21 == var_61);
                                    var_56 = var_56 || var_62;
                                }
                                if (!var_56) {
                                    // or geom_type == GeoType.GAUSSIAN                       <L 310>
                                    var_64 = (var_21 == var_63);
                                    var_56 = var_56 || var_64;
                                }
                                if (var_56) {
                                    // min_bounds = shape_bounds[shape_index, 0]              <L 312>
                                    var_66 = wp::address(var_shape_bounds, var_4, var_65);
                                    var_68 = wp::load(var_66);
                                    var_67 = wp::copy(var_68);
                                    // max_bounds = shape_bounds[shape_index, 1]              <L 313>
                                    var_70 = wp::address(var_shape_bounds, var_4, var_69);
                                    var_72 = wp::load(var_70);
                                    var_71 = wp::copy(var_72);
                                    // lower, upper = compute_shape_bounds(transform, size, min_bounds, max_bounds)       <L 314>
    ...
    // out_bvh_lowers[bvh_index_local] = lower                                                <L 316>
    wp::array_store(var_out_bvh_lowers, var_1, var_89);
    // out_bvh_uppers[bvh_index_local] = upper                                                <L 317>
    wp::array_store(var_out_bvh_uppers, var_1, var_90);
    // out_bvh_groups[bvh_index_local] = world_index                                          <L 318>
...
// Python CPU entry points
WP_API void compute_shape_bvh_bounds_5cdd8bf7_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_shape_bvh_bounds_5cdd8bf7 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_shape_bvh_bounds_5cdd8bf7_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_shape_world_transforms_47e17149 {
    wp::array_t<wp::transform_t<wp::float32>> in_body_transforms;
    wp::array_t<wp::int32> in_shape_body;
    wp::array_t<wp::transform_t<wp::float32>> in_shape_transform;
    wp::array_t<wp::transform_t<wp::float32>> out_transforms;
};


void compute_shape_world_transforms_47e17149_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_shape_world_transforms_47e17149 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::transform_t<wp::float32>> var_in_body_transforms = _wp_args->in_body_transforms;
    wp::array_t<wp::int32> var_in_shape_body = _wp_args->in_shape_body;
    wp::array_t<wp::transform_t<wp::float32>> var_in_shape_transform = _wp_args->in_shape_transform;
    wp::array_t<wp::transform_t<wp::float32>> var_out_transforms = _wp_args->out_transforms;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
    ...
    //---------
    // forward
    // def compute_shape_world_transforms(                                                    <L 241>
    // tid = wp.tid()                                                                         <L 247>
    var_0 = builtin_tid1d();
    // body = in_shape_body[tid]                                                              <L 249>
    var_1 = wp::address(var_in_shape_body, var_0);
    var_3 = wp::load(var_1);
    var_2 = wp::copy(var_3);
    // body_transform = wp.transform_identity()                                               <L 250>
    var_4 = wp::transform_identity<wp::float32>();
    // if body >= 0:                                                                          <L 251>
    var_6 = (var_2 >= var_5);
    if (var_6) {
        // body_transform = in_body_transforms[body]                                          <L 252>
        var_7 = wp::address(var_in_body_transforms, var_2);
        var_9 = wp::load(var_7);
        var_8 = wp::copy(var_9);
    }
    var_10 = wp::where(var_6, var_8, var_4);
    // out_transforms[tid] = wp.mul(body_transform, in_shape_transform[tid])                  <L 254>
...
// Python CPU entry points
WP_API void compute_shape_world_transforms_47e17149_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_shape_world_transforms_47e17149 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_shape_world_transforms_47e17149_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_enabled_shapes_70ba08e9 {
    wp::array_t<wp::int32> shape_type;
    wp::array_t<wp::int32> shape_flags;
    wp::int32 shape_flags_mask;
    wp::array_t<wp::uint32> out_shape_enabled;
    wp::array_t<wp::int32> out_shape_enabled_count;
};


void compute_enabled_shapes_70ba08e9_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_enabled_shapes_70ba08e9 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_shape_type = _wp_args->shape_type;
    wp::array_t<wp::int32> var_shape_flags = _wp_args->shape_flags;
    wp::int32 var_shape_flags_mask = _wp_args->shape_flags_mask;
    wp::array_t<wp::uint32> var_out_shape_enabled = _wp_args->out_shape_enabled;
    wp::array_t<wp::int32> var_out_shape_enabled_count = _wp_args->out_shape_enabled_count;
    //---------
    // primal vars
    wp::int32 var_0;
    wp::int32* var_1;
    ...
    //---------
    // forward
    // def compute_enabled_shapes(                                                            <L 174>
    // tid = wp.tid()                                                                         <L 181>
    var_0 = builtin_tid1d();
    // if not bool(shape_flags[tid] & shape_flags_mask):                                      <L 183>
    ...
    // if not is_supported_shape_type(shape_type[tid]):                                       <L 186>
    ...
    // index = wp.atomic_add(out_shape_enabled_count, 0, 1)                                   <L 189>
    var_12 = wp::atomic_add(var_out_shape_enabled_count, var_10, var_11);
    // out_shape_enabled[index] = wp.uint32(tid)                                              <L 190>
...
// Python CPU entry points
WP_API void compute_enabled_shapes_70ba08e9_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_enabled_shapes_70ba08e9 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_enabled_shapes_70ba08e9_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}

} // extern C

struct wp_args_compute_shape_local_bounds_5bec0069 {
    wp::array_t<wp::int32> in_shape_type;
    wp::array_t<wp::uint64> in_shape_ptr;
    wp::array_t<Gaussian__Data_f03ae6a1> in_gaussians;
    wp::array_t<wp::vec_t<3, wp::float32>> out_bounds;
};


void compute_shape_local_bounds_5bec0069_cpu_kernel_forward(
    wp::launch_bounds_t<1> dim,
    size_t task_index,
    wp_args_compute_shape_local_bounds_5bec0069 *_wp_args)
{
    //---------
    // argument vars
    wp::array_t<wp::int32> var_in_shape_type = _wp_args->in_shape_type;
    wp::array_t<wp::uint64> var_in_shape_ptr = _wp_args->in_shape_ptr;
    wp::array_t<Gaussian__Data_f03ae6a1> var_in_gaussians = _wp_args->in_gaussians;
    wp::array_t<wp::vec_t<3, wp::float32>> var_out_bounds = _wp_args->out_bounds;
    //---------
    // primal vars
    wp::int32 var_0;
    ...
    //---------
    // forward
    // def compute_shape_local_bounds(                                                        <L 207>
    // tid = wp.tid()                                                                         <L 213>
    var_0 = builtin_tid1d();
    // min_point = wp.vec3(MAXVAL)                                                            <L 215>
    var_2 = wp::vec_t<3, wp::float32>(var_1);
    // max_point = wp.vec3(-MAXVAL)                                                           <L 216>
    var_4 = wp::vec_t<3, wp::float32>(var_3);
    // if (                                                                                   <L 218>
    // in_shape_type[tid] == GeoType.MESH                                                     <L 219>
    var_6 = wp::address(var_in_shape_type, var_0);
    var_9 = wp::load(var_6);
    var_8 = (var_9 == var_7);
    var_5 = var_8;
    if (!var_5) {
        // or in_shape_type[tid] == GeoType.CONVEX_MESH                                       <L 220>
    ...
    if (!var_5) {
        // or in_shape_type[tid] == GeoType.HFIELD                                            <L 221>
    ...
    if (!var_5) {
        ...
        if (var_40) {
            ...
            start_for_2:;
                ...
                // lower, upper = compute_gaussian_bounds(in_gaussians[gaussian_id], i)       <L 232>
                var_50 = wp::address(var_in_gaussians, var_43);
                var_53 = wp::load(var_50);
                compute_gaussian_bounds_0(var_53, var_49, var_51, var_52);
                // min_point = wp.min(min_point, lower)                                       <L 233>
                var_54 = wp::min(var_2, var_51);
                // max_point = wp.max(max_point, upper)                                       <L 234>
    ...
    // out_bounds[tid, 0] = min_point                                                         <L 236>
    wp::array_store(var_out_bounds, var_0, var_57, var_2);
    // out_bounds[tid, 1] = max_point                                                         <L 237>
...
// Python CPU entry points
WP_API void compute_shape_local_bounds_5bec0069_cpu_forward(
    wp::launch_bounds_t<1> *dim,
    wp_args_compute_shape_local_bounds_5bec0069 *_wp_args)
{
    wp::tile_shared_storage_t tile_mem;
    ...
    for (size_t task_index = 0; task_index < dim->size; ++task_index)
    {
        compute_shape_local_bounds_5bec0069_cpu_kernel_forward(*dim, task_index, _wp_args);
    }
}
