...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:60
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:375
static CUDA_CALLABLE void extract_shape_data_0(
    ...
    GenericShapeData_f25f19f5 & ret_2,
    ...
    wp::float32 & ret_4)
{
    ...
    //---------
    // forward
    // def extract_shape_data(                                                                <L 376>
    // X_ws = shape_transform[shape_idx]                                                      <L 397>
    var_0 = wp::address(var_shape_transform, var_shape_idx);
    var_2 = wp::load(var_0);
    var_1 = wp::copy(var_2);
    // position = wp.transform_get_translation(X_ws)                                          <L 399>
    var_3 = wp::transform_get_translation(var_1);
    // orientation = wp.transform_get_rotation(X_ws)                                          <L 400>
    var_4 = wp::transform_get_rotation(var_1);
    // data = shape_data[shape_idx]                                                           <L 404>
    var_5 = wp::address(var_shape_data, var_shape_idx);
    var_7 = wp::load(var_5);
    var_6 = wp::copy(var_7);
    // scale = wp.vec3(data[0], data[1], data[2])                                             <L 405>
    ...
    // margin_offset = data[3]                                                                <L 406>
    var_16 = wp::extract(var_6, var_15);
    // result = GenericShapeData()                                                            <L 409>
    var_17 = GenericShapeData_f25f19f5();
    // result.shape_type = shape_types[shape_idx]                                             <L 410>
    var_18 = wp::address(var_shape_types, var_shape_idx);
    var_20 = wp::load(var_18);
    var_19 = wp::copy(var_20);
    var_17.shape_type = var_19;
    // result.scale = scale                                                                   <L 411>
    var_17.scale = var_14;
    // result.auxiliary = wp.vec3(0.0, 0.0, 0.0)                                              <L 412>
    var_24 = wp::vec_t<3, wp::float32>(var_21, var_22, var_23);
    var_17.auxiliary = var_24;
    // result.center = wp.vec3(0.0, 0.0, 0.0)                                                 <L 413>
    var_28 = wp::vec_t<3, wp::float32>(var_25, var_26, var_27);
    var_17.center = var_28;
    // if shape_types[shape_idx] == GeoType.CONVEX_MESH:                                      <L 416>
    var_29 = wp::address(var_shape_types, var_shape_idx);
    var_32 = wp::load(var_29);
    var_31 = (var_32 == var_30);
    if (var_31) {
        // result.auxiliary = pack_mesh_ptr(shape_source[shape_idx])                          <L 417>
        var_33 = wp::address(var_shape_source, var_shape_idx);
        var_35 = wp::load(var_33);
        var_34 = pack_mesh_ptr_0(var_35);
        var_17.auxiliary = var_34;
    }
    // return position, orientation, result, scale, margin_offset                             <L 419>
    ret_0 = var_3;
    ret_1 = var_4;
    ret_2 = var_17;
    ret_3 = var_14;
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:494
static CUDA_CALLABLE void compute_bounding_sphere_from_aabb_0(
    ...
    wp::float32 & ret_1)
{
    ...
    //---------
    // forward
    // def compute_bounding_sphere_from_aabb(aabb_lower: wp.vec3, aabb_upper: wp.vec3) -> tuple[wp.vec3, float]:       <L 495>
    // center = 0.5 * (aabb_lower + aabb_upper)                                               <L 502>
    var_1 = wp::add(var_aabb_lower, var_aabb_upper);
    var_2 = wp::mul(var_0, var_1);
    // half_extents = 0.5 * (aabb_upper - aabb_lower)                                         <L 503>
    var_4 = wp::sub(var_aabb_upper, var_aabb_lower);
    var_5 = wp::mul(var_3, var_4);
    // radius = wp.length(half_extents)                                                       <L 504>
    var_6 = wp::length(var_5);
    // return center, radius                                                                  <L 505>
    ret_0 = var_2;
    ret_1 = var_6;
    return;
}
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:570
static CUDA_CALLABLE bool check_infinite_plane_bsphere_overlap_0(
    GenericShapeData_f25f19f5 var_shape_data_a,
    GenericShapeData_f25f19f5 var_shape_data_b,
    wp::vec_t<3, wp::float32> var_pos_a,
    wp::vec_t<3, wp::float32> var_pos_b,
    wp::quat_t<wp::float32> var_quat_a,
    wp::quat_t<wp::float32> var_quat_b,
    wp::vec_t<3, wp::float32> var_bsphere_center_a,
    wp::vec_t<3, wp::float32> var_bsphere_center_b,
    wp::float32 var_bsphere_radius_a,
    wp::float32 var_bsphere_radius_b)
{
    //---------
    // primal vars
    wp::int32* var_0;
    ...
    //---------
    // forward
    // def check_infinite_plane_bsphere_overlap(                                              <L 571>
    // type_a = shape_data_a.shape_type                                                       <L 590>
    var_0 = &((var_shape_data_a).shape_type);
    var_2 = wp::load(var_0);
    var_1 = wp::copy(var_2);
    // type_b = shape_data_b.shape_type                                                       <L 591>
    var_3 = &((var_shape_data_b).shape_type);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // scale_a = shape_data_a.scale                                                           <L 592>
    var_6 = &((var_shape_data_a).scale);
    var_8 = wp::load(var_6);
    var_7 = wp::copy(var_8);
    // scale_b = shape_data_b.scale                                                           <L 593>
    var_9 = &((var_shape_data_b).scale);
    var_11 = wp::load(var_9);
    var_10 = wp::copy(var_11);
    // is_infinite_plane_a = (type_a == GeoType.PLANE) and (scale_a[0] == 0.0 and scale_a[1] == 0.0)       <L 596>
    var_14 = (var_1 == var_13);
    var_12 = var_14;
    if (var_12) {
    ...
    // is_infinite_plane_b = (type_b == GeoType.PLANE) and (scale_b[0] == 0.0 and scale_b[1] == 0.0)       <L 597>
    var_26 = (var_4 == var_25);
    var_24 = var_26;
    if (var_24) {
        ...
        var_27 = var_31;
        if (var_27) {
            var_33 = wp::extract(var_10, var_32);
            var_35 = (var_33 == var_34);
            var_27 = var_27 && var_35;
        }
        var_24 = var_24 && var_27;
    }
    // if not (is_infinite_plane_a or is_infinite_plane_b):                                   <L 600>
    var_36 = var_12;
    if (!var_36) {
        var_36 = var_36 || var_24;
    }
    var_37 = wp::unot(var_36);
    if (var_37) {
        // return True                                                                        <L 601>
        return var_38;
    }
    // if is_infinite_plane_a:                                                                <L 604>
    if (var_12) {
        // plane_pos = pos_a                                                                  <L 605>
        var_39 = wp::copy(var_pos_a);
        // plane_quat = quat_a                                                                <L 606>
        var_40 = wp::copy(var_quat_a);
        // other_center = bsphere_center_b                                                    <L 607>
        var_41 = wp::copy(var_bsphere_center_b);
        // other_radius = bsphere_radius_b                                                    <L 608>
        var_42 = wp::copy(var_bsphere_radius_b);
    }
    if (!var_12) {
        // plane_pos = pos_b                                                                  <L 610>
        var_43 = wp::copy(var_pos_b);
        // plane_quat = quat_b                                                                <L 611>
        var_44 = wp::copy(var_quat_b);
        // other_center = bsphere_center_a                                                    <L 612>
        var_45 = wp::copy(var_bsphere_center_a);
        // other_radius = bsphere_radius_a                                                    <L 613>
        var_46 = wp::copy(var_bsphere_radius_a);
    }
    var_47 = wp::where(var_12, var_39, var_43);
    var_48 = wp::where(var_12, var_40, var_44);
    var_49 = wp::where(var_12, var_41, var_45);
    var_50 = wp::where(var_12, var_42, var_46);
    // plane_normal = wp.quat_rotate(plane_quat, wp.vec3(0.0, 0.0, 1.0))                      <L 616>
    var_54 = wp::vec_t<3, wp::float32>(var_51, var_52, var_53);
    var_55 = wp::quat_rotate(var_48, var_54);
    // center_dist = wp.dot(other_center - plane_pos, plane_normal)                           <L 619>
    var_56 = wp::sub(var_49, var_47);
    var_57 = wp::dot(var_56, var_55);
    // return center_dist <= other_radius                                                     <L 623>
    var_58 = (var_57 <= var_50);
    return var_58;
}


// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:508
static CUDA_CALLABLE void convert_infinite_plane_to_cube_0(
    GenericShapeData_f25f19f5 var_shape_data,
    wp::quat_t<wp::float32> var_plane_rotation,
    wp::vec_t<3, wp::float32> var_plane_position,
    wp::vec_t<3, wp::float32> var_other_position,
    wp::float32 var_other_radius,
    GenericShapeData_f25f19f5 & ret_0,
    wp::vec_t<3, wp::float32> & ret_1)
{
    //---------
    // primal vars
    GenericShapeData_f25f19f5 var_0;
    const wp::int32 var_1 = 7;
    const wp::float32 var_2 = 10.0;
    wp::float32 var_3;
    const wp::float32 var_4 = 10.0;
    wp::float32 var_5;
    wp::vec_t<3, wp::float32> var_6;
    ...
    //---------
    // forward
    // def convert_infinite_plane_to_cube(                                                    <L 509>
    // result = GenericShapeData()                                                            <L 536>
    var_0 = GenericShapeData_f25f19f5();
    // result.shape_type = GeoType.BOX                                                        <L 537>
    var_0.shape_type = var_1;
    // lateral_size = other_radius * 10.0                                                     <L 542>
    var_3 = wp::mul(var_other_radius, var_2);
    // depth = other_radius * 10.0                                                            <L 546>
    var_5 = wp::mul(var_other_radius, var_4);
    // result.scale = wp.vec3(lateral_size, lateral_size, depth)                              <L 551>
    var_6 = wp::vec_t<3, wp::float32>(var_3, var_3, var_5);
    var_0.scale = var_6;
    // plane_normal = wp.quat_rotate(plane_rotation, wp.vec3(0.0, 0.0, 1.0))                  <L 555>
    var_10 = wp::vec_t<3, wp::float32>(var_7, var_8, var_9);
    var_11 = wp::quat_rotate(var_plane_rotation, var_10);
    // to_other = other_position - plane_position                                             <L 556>
    var_12 = wp::sub(var_other_position, var_plane_position);
    // distance_along_normal = wp.dot(to_other, plane_normal)                                 <L 557>
    var_13 = wp::dot(var_12, var_11);
    // plane_surface_point = other_position - plane_normal * distance_along_normal            <L 560>
    var_14 = wp::mul(var_11, var_13);
    var_15 = wp::sub(var_other_position, var_14);
    // adjusted_position = plane_surface_point - plane_normal * depth                         <L 565>
    var_16 = wp::mul(var_11, var_5);
    var_17 = wp::sub(var_15, var_16);
    // return result, adjusted_position                                                       <L 567>
    ret_0 = var_0;
    ret_1 = var_17;
    return;
}
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:71
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:422
    ...
    wp::vec_t<3, wp::float32> var_tri_c)
{
    ...
    //---------
    // forward
    // def closest_point_on_triangle(                                                         <L 423>
    // ab = tri_b - tri_a                                                                     <L 444>
    var_0 = wp::sub(var_tri_b, var_tri_a);
    // ac = tri_c - tri_a                                                                     <L 445>
    var_1 = wp::sub(var_tri_c, var_tri_a);
    // ab_sq = wp.dot(ab, ab)                                                                 <L 450>
    var_2 = wp::dot(var_0, var_0);
    // ac_sq = wp.dot(ac, ac)                                                                 <L 451>
    var_3 = wp::dot(var_1, var_1);
    // EPS2 = 1.0e-20                                                                         <L 452>
    // if wp.dot(wp.cross(ab, ac), wp.cross(ab, ac)) < EPS2:                                  <L 453>
    var_5 = wp::cross(var_0, var_1);
    var_6 = wp::cross(var_0, var_1);
    var_7 = wp::dot(var_5, var_6);
    var_8 = (var_7 < var_4);
    if (var_8) {
        // bc = tri_c - tri_b                                                                 <L 454>
        var_9 = wp::sub(var_tri_c, var_tri_b);
        // bc_sq = wp.dot(bc, bc)                                                             <L 455>
        var_10 = wp::dot(var_9, var_9);
        // if ab_sq >= ac_sq and ab_sq >= bc_sq:                                              <L 456>
        var_12 = (var_2 >= var_3);
        var_11 = var_12;
        if (var_11) {
            var_13 = (var_2 >= var_10);
    ...
    // d1 = wp.dot(ab, ap)                                                                    <L 470>
    var_43 = wp::dot(var_0, var_42);
    // d2 = wp.dot(ac, ap)                                                                    <L 471>
    var_44 = wp::dot(var_1, var_42);
    // if d1 <= 0.0 and d2 <= 0.0:                                                            <L 472>
    ...
    // d3 = wp.dot(ab, bp)                                                                    <L 476>
    var_51 = wp::dot(var_0, var_50);
    // d4 = wp.dot(ac, bp)                                                                    <L 477>
    var_52 = wp::dot(var_1, var_50);
    // if d3 >= 0.0 and d4 <= d3:                                                             <L 478>
    ...
    // d5 = wp.dot(ab, cp)                                                                    <L 482>
    var_58 = wp::dot(var_0, var_57);
    // d6 = wp.dot(ac, cp)                                                                    <L 483>
    var_59 = wp::dot(var_1, var_57);
    // if d6 >= 0.0 and d5 <= d6:                                                             <L 484>
    ...
    if (var_95) {
        ...
        // return tri_b + w * (tri_c - tri_b)                                                 <L 500>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE Vert_99873389 create_support_map_function__locals__geometric_center_16(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:332
static CUDA_CALLABLE wp::vec_t<3, wp::float32> support_map_lean_0(
    ...
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    wp::vec_t<3, wp::float32> var_13;
    wp::vec_t<3, wp::float32> var_14;
    const wp::float32 var_15 = -10000000000.0;
    wp::float32 var_16;
    ...
    wp::range_t var_24;
    wp::int32 var_25;
    wp::array_t<wp::vec_t<3, wp::float32>>* var_26;
    ...
    //---------
    // forward
    // def support_map_lean(geom: GenericShapeData, direction: wp.vec3, data_provider: SupportMapDataProvider) -> wp.vec3:       <L 333>
    // result = wp.vec3(0.0, 0.0, 0.0)                                                        <L 341>
    var_3 = wp::vec_t<3, wp::float32>(var_0, var_1, var_2);
    // if geom.shape_type == GeoType.CONVEX_MESH:                                             <L 343>
    var_4 = &((var_geom).shape_type);
    var_7 = wp::load(var_4);
    var_6 = (var_7 == var_5);
    if (var_6) {
        // mesh_ptr = unpack_mesh_ptr(geom.auxiliary)                                         <L 344>
        var_8 = &((var_geom).auxiliary);
        var_10 = wp::load(var_8);
        var_9 = unpack_mesh_ptr_0(var_10);
        // mesh = wp.mesh_get(mesh_ptr)                                                       <L 345>
        var_11 = wp::mesh_get(var_9);
        // scaled_dir = wp.cw_mul(direction, geom.scale)                                      <L 346>
        var_12 = &((var_geom).scale);
        var_14 = wp::load(var_12);
        var_13 = wp::cw_mul(var_direction, var_14);
        // max_dot = float(-1.0e10)                                                           <L 347>
        var_16 = wp::float(var_15);
        // best_idx = int(0)                                                                  <L 348>
        var_18 = wp::int(var_17);
        // for i in range(mesh.points.shape[0]):                                              <L 349>
        var_19 = &((var_11).points);
        var_20 = &(var_19->shape);
        var_23 = wp::load(var_20);
        var_22 = wp::extract(var_23, var_21);
        var_24 = wp::range(var_22);
        start_for_0:;
            if (iter_cmp(var_24) == 0) goto end_for_0;
            var_25 = wp::iter_next(var_24);
            // dot_val = wp.dot(mesh.points[i], scaled_dir)                                   <L 350>
            var_26 = &((var_11).points);
            var_28 = wp::load(var_26);
            var_27 = wp::address(var_28, var_25);
            var_30 = wp::load(var_27);
            var_29 = wp::dot(var_30, var_13);
            // if dot_val > max_dot:                                                          <L 351>
            var_31 = (var_29 > var_16);
            if (var_31) {
                // max_dot = dot_val                                                          <L 352>
                var_32 = wp::copy(var_29);
                // best_idx = i                                                               <L 353>
                var_33 = wp::copy(var_25);
            }
            var_34 = wp::where(var_31, var_32, var_16);
            var_35 = wp::where(var_31, var_33, var_18);
            wp::assign(var_16, var_34);
            wp::assign(var_18, var_35);
            goto start_for_0;
        end_for_0:;
        // result = wp.cw_mul(mesh.points[best_idx], geom.scale)                              <L 354>
        var_36 = &((var_11).points);
        var_38 = wp::load(var_36);
        var_37 = wp::address(var_38, var_18);
        var_39 = &((var_geom).scale);
        var_41 = wp::load(var_37);
        var_42 = wp::load(var_39);
        var_40 = wp::cw_mul(var_41, var_42);
    }
    if (!var_6) {
        // elif geom.shape_type == GeoType.BOX:                                               <L 356>
        var_43 = &((var_geom).shape_type);
        var_46 = wp::load(var_43);
        var_45 = (var_46 == var_44);
        if (var_45) {
            // threshold = BOX_SUPPORT_DEADBAND * wp.length(direction)                        <L 357>
            var_48 = wp::length(var_direction);
            var_49 = wp::mul(var_47, var_48);
            // sx = 1.0 if direction[0] >= -threshold else -1.0                               <L 358>
            var_51 = wp::extract(var_direction, var_50);
            var_52 = wp::neg(var_49);
            var_53 = (var_51 >= var_52);
            if (var_53) {
            }
            if (!var_53) {
            }
            var_56 = wp::where(var_53, var_54, var_55);
            // sy = 1.0 if direction[1] >= -threshold else -1.0                               <L 359>
            var_58 = wp::extract(var_direction, var_57);
            var_59 = wp::neg(var_49);
            var_60 = (var_58 >= var_59);
            if (var_60) {
            }
            if (!var_60) {
            }
            var_63 = wp::where(var_60, var_61, var_62);
            // sz = 1.0 if direction[2] >= -threshold else -1.0                               <L 360>
            var_65 = wp::extract(var_direction, var_64);
            var_66 = wp::neg(var_49);
            var_67 = (var_65 >= var_66);
            if (var_67) {
            }
            if (!var_67) {
            }
            var_70 = wp::where(var_67, var_68, var_69);
            // result = wp.vec3(sx * geom.scale[0], sy * geom.scale[1], sz * geom.scale[2])       <L 361>
            var_71 = &((var_geom).scale);
            var_74 = wp::load(var_71);
            var_73 = wp::extract(var_74, var_72);
            var_75 = wp::mul(var_56, var_73);
            var_76 = &((var_geom).scale);
            var_79 = wp::load(var_76);
            var_78 = wp::extract(var_79, var_77);
            var_80 = wp::mul(var_63, var_78);
            var_81 = &((var_geom).scale);
            var_84 = wp::load(var_81);
            var_83 = wp::extract(var_84, var_82);
            var_85 = wp::mul(var_70, var_83);
            var_86 = wp::vec_t<3, wp::float32>(var_75, var_80, var_85);
        }
        if (!var_45) {
            // elif geom.shape_type == GeoType.SPHERE:                                        <L 363>
            var_87 = &((var_geom).shape_type);
            var_90 = wp::load(var_87);
            var_89 = (var_90 == var_88);
            if (var_89) {
                // radius = geom.scale[0]                                                     <L 364>
                var_91 = &((var_geom).scale);
                var_94 = wp::load(var_91);
                var_93 = wp::extract(var_94, var_92);
                // dir_len_sq = wp.length_sq(direction)                                       <L 365>
                var_95 = wp::length_sq(var_direction);
                // if dir_len_sq > 1.0e-12:                                                   <L 366>
                var_97 = (var_95 > var_96);
                if (var_97) {
                    // n = wp.normalize(direction)                                            <L 367>
                    var_98 = wp::normalize(var_direction);
                }
                if (!var_97) {
                    // n = wp.vec3(1.0, 0.0, 0.0)                                             <L 369>
                    var_102 = wp::vec_t<3, wp::float32>(var_99, var_100, var_101);
                }
                var_103 = wp::where(var_97, var_98, var_102);
                // result = n * radius                                                        <L 370>
                var_104 = wp::mul(var_103, var_93);
            }
            var_105 = wp::where(var_89, var_104, var_3);
        }
        var_106 = wp::where(var_45, var_86, var_105);
    }
    var_107 = wp::where(var_6, var_40, var_106);
    // return result                                                                          <L 372>
    return var_107;
}
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE wp::vec_t<3, wp::float32> create_solve_mpr__locals__centered_box_support_8(
    GenericShapeData_f25f19f5 var_geom,
    wp::vec_t<3, wp::float32> var_direction,
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    var_0 = support_map_lean_0(var_geom, var_direction, var_data_provider);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE wp::vec_t<3, wp::float32> create_support_map_function__locals__support_map_b_17(
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    var_1 = create_solve_mpr__locals__centered_box_support_8(var_geom_b, var_0, var_data_provider);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE Vert_99873389 create_support_map_function__locals__minkowski_support_17(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    ...
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    var_1 = create_solve_mpr__locals__centered_box_support_8(var_geom_a, var_direction, var_data_provider);
    ...
    var_3 = create_support_map_function__locals__support_map_b_17(var_geom_b, var_2, var_orientation_b, var_position_b, var_data_provider);
    var_0.B = var_3;
    // if extend != 0.0:                                                                      <L 35>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:52
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void create_solve_mpr__locals__solve_mpr_core_8(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
    ...
    wp::float32 & ret_4)
{
    ...
    var_15 = create_support_map_function__locals__geometric_center_16(var_geom_a, var_geom_b, var_orientation_b, var_position_b, var_data_provider);
    // normal = v0.BtoA                                                                       <L 48>
    var_16 = &((var_15).BtoA);
    ...
    if (var_20) {
        ...
        if (var_90) {
            ...
            var_103 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_101, var_orientation_b, var_position_b, var_extend, var_data_provider);
            ...
            // sv = mpr_support(geom_a, geom_b, probe, orientation_b, position_b, extend, data_provider)       <L 82>
            var_118 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_116, var_orientation_b, var_position_b, var_extend, var_data_provider);
            // d = wp.dot(sv.BtoA, probe)                                                     <L 83>
            ...
            // sv = mpr_support(geom_a, geom_b, probe, orientation_b, position_b, extend, data_provider)       <L 82>
            var_133 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_131, var_orientation_b, var_position_b, var_extend, var_data_provider);
            // d = wp.dot(sv.BtoA, probe)                                                     <L 83>
    ...
    var_147 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_145, var_orientation_b, var_position_b, var_extend, var_data_provider);
    ...
    var_179 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_178, var_orientation_b, var_position_b, var_extend, var_data_provider);
    ...
    if ((var_223) == false) goto end_while_3;
        ...
        var_228 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_215, var_orientation_b, var_position_b, var_extend, var_data_provider);
    ...
    if ((var_286) == false) goto end_while_7;
        ...
        var_312 = create_support_map_function__locals__minkowski_support_17(var_geom_a, var_geom_b, var_299, var_orientation_b, var_position_b, var_extend, var_data_provider);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:77
static CUDA_CALLABLE Vert_99873389 create_solve_closest_distance__locals__simplex_get_vertex_8(
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:293
static CUDA_CALLABLE void create_solve_closest_distance__locals__simplex_get_closest_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    ...
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    start_for_0:;
        ...
        var_19 = create_solve_closest_distance__locals__simplex_get_vertex_8(var_v, var_10);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE wp::vec_t<3, wp::float32> create_support_map_function__locals__support_map_b_16(
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    var_0 = wp::quat_rotate_inv(var_orientation_b, var_direction);
    // result = support_func(geom_b, tmp, data_provider)                                      <L 25>
    var_1 = support_map_lean_0(var_geom_b, var_0, var_data_provider);
    // result = wp.quat_rotate(orientation_b, result)                                         <L 28>
    var_2 = wp::quat_rotate(var_orientation_b, var_1);
    // result = result + position_b                                                           <L 29>
    var_3 = wp::add(var_2, var_position_b);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE Vert_99873389 create_support_map_function__locals__minkowski_support_16(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    ...
    SupportMapDataProvider_e77f8b9f var_data_provider)
{
    ...
    var_0 = Vert_99873389();
    // point_a = support_func(geom_a, direction, data_provider)                               <L 28>
    var_1 = support_map_lean_0(var_geom_a, var_direction, var_data_provider);
    // tmp_direction = -direction                                                             <L 31>
    var_2 = wp::neg(var_direction);
    // v.B = support_map_b(geom_b, tmp_direction, orientation_b, position_b, data_provider)       <L 32>
    var_3 = create_support_map_function__locals__support_map_b_16(var_geom_b, var_2, var_orientation_b, var_position_b, var_data_provider);
    var_0.B = var_3;
    // if extend != 0.0:                                                                      <L 35>
    var_5 = (var_extend != var_4);
    if (var_5) {
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:91
static CUDA_CALLABLE void create_solve_closest_distance__locals__closest_segment_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::int32 var_i0,
    wp::int32 var_i1,
    wp::vec_t<3, wp::float32> & ret_0,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:134
static CUDA_CALLABLE void create_solve_closest_distance__locals__closest_triangle_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::int32 var_i0,
    wp::int32 var_i1,
    wp::int32 var_i2,
    ...
    wp::uint32 & ret_2)
{
    ...
    if (var_47) {
        ...
        create_solve_closest_distance__locals__closest_segment_8(var_v, var_i1, var_i2, var_50, var_51, var_52);
    ...
    if (var_67) {
        ...
        create_solve_closest_distance__locals__closest_segment_8(var_v, var_i0, var_i2, var_70, var_71, var_72);
    ...
    if (var_91) {
        ...
        create_solve_closest_distance__locals__closest_segment_8(var_v, var_i0, var_i1, var_94, var_95, var_96);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:210
static CUDA_CALLABLE wp::float32 create_solve_closest_distance__locals__determinant_8(
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:215
static CUDA_CALLABLE void create_solve_closest_distance__locals__closest_tetrahedron_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<4, wp::float32> & ret_1,
    wp::uint32 & ret_2)
{
    ...
    var_24 = create_solve_closest_distance__locals__determinant_8(var_5, var_11, var_17, var_23);
    ...
    var_37 = create_solve_closest_distance__locals__determinant_8(var_36, var_11, var_17, var_23);
    var_38 = wp::mul(var_37, var_32);
    // lambda1 = determinant(v0, zero, v2, v3) * inverse_det_t                                <L 237>
    var_39 = create_solve_closest_distance__locals__determinant_8(var_5, var_36, var_17, var_23);
    var_40 = wp::mul(var_39, var_32);
    // lambda2 = determinant(v0, v1, zero, v3) * inverse_det_t                                <L 238>
    var_41 = create_solve_closest_distance__locals__determinant_8(var_5, var_11, var_36, var_23);
    ...
    if (var_59) {
        ...
        create_solve_closest_distance__locals__closest_triangle_8(var_v, var_62, var_63, var_64, var_65, var_66, var_67);
    ...
    if (var_82) {
        ...
        create_solve_closest_distance__locals__closest_triangle_8(var_v, var_85, var_86, var_87, var_88, var_89, var_90);
    ...
    if (var_109) {
        ...
        create_solve_closest_distance__locals__closest_triangle_8(var_v, var_112, var_113, var_114, var_115, var_116, var_117);
    ...
    if (var_136) {
        ...
        create_solve_closest_distance__locals__closest_triangle_8(var_v, var_139, var_140, var_141, var_142, var_143, var_144);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:0
static CUDA_CALLABLE void create_solve_closest_distance__locals__solve_closest_distance_core_8(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
    ...
    wp::float32 & ret_4)
{
    ...
    var_23 = create_support_map_function__locals__geometric_center_16(var_geom_a, var_geom_b, var_orientation_b, var_position_b, var_data_provider);
    // v = center.BtoA                                                                        <L 56>
    var_24 = &((var_23).BtoA);
    ...
    if ((var_33) == false) goto end_while_0;
        ...
        if (var_37) {
            ...
            create_solve_closest_distance__locals__simplex_get_closest_8(var_14, var_19, var_21, var_43, var_44);
        ...
        var_52 = create_support_map_function__locals__minkowski_support_16(var_geom_a, var_geom_b, var_50, var_orientation_b, var_position_b, var_extend, var_data_provider);
        // w_v = w.BtoA                                                                       <L 80>
        var_53 = &((var_52).BtoA);
        ...
        if (!var_175) {
            ...
            if (var_189) {
                ...
                create_solve_closest_distance__locals__closest_segment_8(var_14, var_191, var_193, var_194, var_195, var_196);
            ...
            if (!var_189) {
                ...
                if (var_200) {
                    ...
                    create_solve_closest_distance__locals__closest_triangle_8(var_14, var_202, var_204, var_206, var_207, var_208, var_209);
                ...
                if (!var_200) {
                    ...
                    if (var_213) {
                        ...
                        create_solve_closest_distance__locals__closest_tetrahedron_8(var_14, var_214, var_215, var_216);
        ...
        if (var_248) {
            ...
            create_solve_closest_distance__locals__simplex_get_closest_8(var_14, var_242, var_243, var_254, var_255);
    ...
    create_solve_closest_distance__locals__simplex_get_closest_8(var_14, var_19, var_21, var_264, var_265);
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:144
static CUDA_CALLABLE ContactData_40360d7c post_process_minkowski_only_0(
    ContactData_40360d7c var_contact_data,
    GenericShapeData_f25f19f5 var_shape_a,
    wp::vec_t<3, wp::float32> var_pos_a_adjusted,
    wp::quat_t<wp::float32> var_rot_a,
    GenericShapeData_f25f19f5 var_shape_b,
    ...
    wp::quat_t<wp::float32> var_rot_b)
{
    ...
    //---------
    // forward
    // def post_process_minkowski_only(                                                       <L 145>
    // type_a = shape_a.shape_type                                                            <L 155>
    var_0 = &((var_shape_a).shape_type);
    var_2 = wp::load(var_0);
    var_1 = wp::copy(var_2);
    // type_b = shape_b.shape_type                                                            <L 156>
    var_3 = &((var_shape_b).shape_type);
    var_5 = wp::load(var_3);
    var_4 = wp::copy(var_5);
    // normal = contact_data.contact_normal_a_to_b                                            <L 157>
    var_6 = &((var_contact_data).contact_normal_a_to_b);
    var_8 = wp::load(var_6);
    var_7 = wp::copy(var_8);
    // radius_eff_a = contact_data.radius_eff_a                                               <L 158>
    var_9 = &((var_contact_data).radius_eff_a);
    var_11 = wp::load(var_9);
    var_10 = wp::copy(var_11);
    // radius_eff_b = contact_data.radius_eff_b                                               <L 159>
    var_12 = &((var_contact_data).radius_eff_b);
    var_14 = wp::load(var_12);
    var_13 = wp::copy(var_14);
    // if type_a == GeoType.SPHERE or type_a == GeoType.CAPSULE:                              <L 161>
    var_17 = (var_1 == var_16);
    var_15 = var_17;
    if (!var_15) {
        var_19 = (var_1 == var_18);
    ...
    if (var_15) {
        // contact_data.contact_point_center = contact_data.contact_point_center + normal * (radius_eff_a * 0.5)       <L 162>
        ...
        // contact_data.contact_distance = contact_data.contact_distance - radius_eff_a       <L 163>
        var_26 = &((var_contact_data).contact_distance);
        var_28 = wp::load(var_26);
        var_27 = wp::sub(var_28, var_10);
        var_contact_data.contact_distance = var_27;
    }
    // if type_b == GeoType.SPHERE or type_b == GeoType.CAPSULE:                              <L 165>
    var_31 = (var_4 == var_30);
    var_29 = var_31;
    if (!var_29) {
        var_33 = (var_4 == var_32);
    ...
    if (var_29) {
        // contact_data.contact_point_center = contact_data.contact_point_center - normal * (radius_eff_b * 0.5)       <L 166>
        ...
        // contact_data.contact_distance = contact_data.contact_distance - radius_eff_b       <L 167>
        var_40 = &((var_contact_data).contact_distance);
        var_42 = wp::load(var_40);
        var_41 = wp::sub(var_42, var_13);
        var_contact_data.contact_distance = var_41;
    }
    // return contact_data                                                                    <L 169>
    return var_contact_data;
}


// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/contact_data.py:59
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/sim/collide.py:90
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/sim/collide.py:134
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:621
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:141
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:167
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:189
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:43
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:62
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:263
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:289
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:307
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:398
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:581
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:485
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:87
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:239
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:0
static CUDA_CALLABLE void create_build_manifold__locals__extract_4_point_contact_manifolds_5(
    ...
    wp::float32 & ret_1)
{
    ...
    if (var_10) {
        ...
        start_for_0:;
            ...
            var_54 = post_process_minkowski_only_0(var_48, var_geom_a, var_position_a, var_quaternion_a, var_geom_b, var_position_b, var_quaternion_b);
            // writer_func(contact_data, writer_data, -1)                                     <L 96>
            write_contact_0(var_54, var_writer_data, var_55);
            goto start_for_0;
        end_for_0:;
    }
    if (!var_10) {
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:38
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:0
static CUDA_CALLABLE wp::int32 create_build_manifold__locals__build_manifold_5(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_a,
    wp::vec_t<3, wp::float32> var_position_a_world,
    ...
    ContactData_40360d7c var_contact_template)
{
    ...
    var_81 = support_map_lean_0(var_geom_a, var_80, var_data_provider);
    ...
    var_98 = support_map_lean_0(var_geom_b, var_97, var_data_provider);
    ...
    // pt_a_3d = support_func(geom_a, dir_a, data_provider)                                   <L 96>
    var_146 = support_map_lean_0(var_geom_a, var_145, var_data_provider);
    // projected_a = pt_a_3d - center                                                         <L 97>
    ...
    // pt_b_local = support_func(geom_b, local_dir_b, data_provider)                          <L 105>
    var_162 = support_map_lean_0(var_geom_b, var_161, var_data_provider);
    // pt_b_3d = wp.quat_rotate(relative_orientation_b, pt_b_local) + relative_position_b       <L 106>
    ...
    // pt_a_3d = support_func(geom_a, dir_a, data_provider)                                   <L 96>
    var_210 = support_map_lean_0(var_geom_a, var_209, var_data_provider);
    // projected_a = pt_a_3d - center                                                         <L 97>
    ...
    // pt_b_local = support_func(geom_b, local_dir_b, data_provider)                          <L 105>
    var_226 = support_map_lean_0(var_geom_b, var_225, var_data_provider);
    // pt_b_3d = wp.quat_rotate(relative_orientation_b, pt_b_local) + relative_position_b       <L 106>
    ...
    // pt_a_3d = support_func(geom_a, dir_a, data_provider)                                   <L 96>
    var_274 = support_map_lean_0(var_geom_a, var_273, var_data_provider);
    // projected_a = pt_a_3d - center                                                         <L 97>
    ...
    // pt_b_local = support_func(geom_b, local_dir_b, data_provider)                          <L 105>
    var_290 = support_map_lean_0(var_geom_b, var_289, var_data_provider);
    // pt_b_3d = wp.quat_rotate(relative_orientation_b, pt_b_local) + relative_position_b       <L 106>
    ...
    // pt_a_3d = support_func(geom_a, dir_a, data_provider)                                   <L 96>
    var_338 = support_map_lean_0(var_geom_a, var_337, var_data_provider);
    // projected_a = pt_a_3d - center                                                         <L 97>
    ...
    // pt_b_local = support_func(geom_b, local_dir_b, data_provider)                          <L 105>
    var_354 = support_map_lean_0(var_geom_b, var_353, var_data_provider);
    // pt_b_3d = wp.quat_rotate(relative_orientation_b, pt_b_local) + relative_position_b       <L 106>
    ...
    if (!var_373) {
        ...
        if (!var_382) {
            ...
            create_build_manifold__locals__extract_4_point_contact_manifolds_5(var_36, var_343, var_25, var_361, var_normal, var_16, var_17, var_22, var_380, var_381, var_orientation_a, var_position_a_world, var_367, var_writer_data, var_contact_template, var_geom_a, var_geom_b, var_368, var_370, var_371, var_372, var_391, var_392);
    ...
    if (var_399) {
        ...
        var_416 = post_process_minkowski_only_0(var_410, var_geom_a, var_368, var_371, var_geom_b, var_370, var_372);
        // writer_func(contact_data, writer_data, -1)                                         <L 174>
        write_contact_0(var_416, var_writer_data, var_417);
        // count_out += 1                                                                     <L 176>
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_convex.py:0
static CUDA_CALLABLE wp::int32 create_solve_convex_multi_contact__locals__solve_convex_multi_contact_4(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_a,
    wp::quat_t<wp::float32> var_orientation_b,
    ...
    ContactData_40360d7c var_contact_template)
{
    ...
    // enlarge,                                                                               <L 40>
    // data_provider,                                                                         <L 41>
    create_solve_mpr__locals__solve_mpr_core_8(var_geom_a, var_geom_b, var_1, var_3, var_18, var_data_provider, var_24, var_25, var_19, var_20, var_21, var_22, var_23);
    // if collision:                                                                          <L 44>
    if (var_19) {
    ...
    if (!var_19) {
        ...
        // 0.0,                                                                               <L 59>
        // data_provider,                                                                     <L 60>
        create_solve_closest_distance__locals__solve_closest_distance_core_8(var_geom_a, var_geom_b, var_1, var_3, var_34, var_data_provider, var_40, var_41, var_35, var_36, var_37, var_38, var_39);
    }
    ...
    if (var_46) {
        ...
        var_59 = post_process_minkowski_only_0(var_54, var_geom_a, var_position_a, var_orientation_a, var_geom_b, var_position_b, var_orientation_b);
        // writer_func(contact_data, writer_data, -1)                                         <L 77>
        write_contact_0(var_59, var_writer_data, var_60);
        // return 1                                                                           <L 78>
        return var_61;
    }
    ...
    var_62 = create_build_manifold__locals__build_manifold_5(var_geom_a, var_geom_b, var_orientation_a, var_position_a, var_1, var_3, var_42, var_43, var_44, var_data_provider, var_writer_data, var_contact_template);
    // return count                                                                           <L 99>
    return var_62;
}


// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:0
static CUDA_CALLABLE void create_compute_gjk_mpr_contacts__locals__compute_gjk_mpr_contacts_3(
    GenericShapeData_f25f19f5 var_shape_a_data,
    GenericShapeData_f25f19f5 var_shape_b_data,
    wp::quat_t<wp::float32> var_rot_a,
    wp::quat_t<wp::float32> var_rot_b,
    wp::vec_t<3, wp::float32> var_pos_a_adjusted,
    wp::vec_t<3, wp::float32> var_pos_b_adjusted,
    ...
    wp::int32 var_sort_sub_key)
{
    ...
    var_53 = create_solve_convex_multi_contact__locals__solve_convex_multi_contact_4(var_shape_a_data, var_shape_b_data, var_rot_a, var_rot_b, var_pos_a_adjusted, var_pos_b_adjusted, var_0, var_43, var_44, var_writer_data, var_38);
}


// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:0
static CUDA_CALLABLE void create_find_contacts__locals__find_contacts_1(
    wp::vec_t<3, wp::float32> var_pos_a,
    wp::vec_t<3, wp::float32> var_pos_b,
    wp::quat_t<wp::float32> var_quat_a,
    wp::quat_t<wp::float32> var_quat_b,
    GenericShapeData_f25f19f5 var_shape_data_a,
    GenericShapeData_f25f19f5 var_shape_data_b,
    bool var_is_infinite_plane_a,
    bool var_is_infinite_plane_b,
    wp::float32 var_bsphere_radius_a,
    wp::float32 var_bsphere_radius_b,
    wp::float32 var_rigid_gap,
    wp::int32 var_shape_a,
    ...
    ContactWriterData_4222ebad var_writer_data)
{
    ...
    wp::vec_t<3, wp::float32> var_8;
    wp::float32 var_9;
    GenericShapeData_f25f19f5 var_10;
    wp::vec_t<3, wp::float32> var_11;
    GenericShapeData_f25f19f5 var_12;
    wp::vec_t<3, wp::float32> var_13;
    wp::vec_t<3, wp::float32> var_14;
    wp::float32 var_15;
    GenericShapeData_f25f19f5 var_16;
    wp::vec_t<3, wp::float32> var_17;
    GenericShapeData_f25f19f5 var_18;
    wp::vec_t<3, wp::float32> var_19;
    const wp::int32 var_20 = 0;
    //---------
    // forward
    // def find_contacts(                                                                     <L 1>
    // if writer_data.contact_count[0] >= writer_data.contact_max:                            <L 40>
    var_0 = &((var_writer_data).contact_count);
    var_3 = wp::load(var_0);
    var_2 = wp::address(var_3, var_1);
    var_4 = &((var_writer_data).contact_max);
    var_6 = wp::load(var_2);
    var_7 = wp::load(var_4);
    var_5 = (var_6 >= var_7);
    if (var_5) {
    ...
    // pos_a_adjusted = pos_a                                                                 <L 46>
    var_8 = wp::copy(var_pos_a);
    // if is_infinite_plane_a:                                                                <L 47>
    if (var_is_infinite_plane_a) {
        // shape_data_a, pos_a_adjusted = convert_infinite_plane_to_cube(                     <L 50>
        // shape_data_a, quat_a, pos_a, pos_b, bsphere_radius_b + rigid_gap                   <L 51>
        var_9 = wp::add(var_bsphere_radius_b, var_rigid_gap);
        convert_infinite_plane_to_cube_0(var_shape_data_a, var_quat_a, var_pos_a, var_pos_b, var_9, var_10, var_11);
    }
    var_12 = wp::where(var_is_infinite_plane_a, var_10, var_shape_data_a);
    var_13 = wp::where(var_is_infinite_plane_a, var_11, var_8);
    // pos_b_adjusted = pos_b                                                                 <L 54>
    var_14 = wp::copy(var_pos_b);
    // if is_infinite_plane_b:                                                                <L 55>
    if (var_is_infinite_plane_b) {
        // shape_data_b, pos_b_adjusted = convert_infinite_plane_to_cube(                     <L 58>
        // shape_data_b, quat_b, pos_b, pos_a, bsphere_radius_a + rigid_gap                   <L 59>
        var_15 = wp::add(var_bsphere_radius_a, var_rigid_gap);
        convert_infinite_plane_to_cube_0(var_shape_data_b, var_quat_b, var_pos_b, var_pos_a, var_15, var_16, var_17);
    }
    var_18 = wp::where(var_is_infinite_plane_b, var_16, var_shape_data_b);
    var_19 = wp::where(var_is_infinite_plane_b, var_17, var_14);
    // wp.static(                                                                             <L 63>
    // shape_data_a,                                                                          <L 68>
    // shape_data_b,                                                                          <L 69>
    // quat_a,                                                                                <L 70>
    ...
    // margin_b,                                                                              <L 78>
    // writer_data,                                                                           <L 79>
    create_compute_gjk_mpr_contacts__locals__compute_gjk_mpr_contacts_3(var_12, var_18, var_quat_a, var_quat_b, var_13, var_19, var_rigid_gap, var_shape_a, var_shape_b, var_margin_a, var_margin_b, var_writer_data, var_20);
}
...
static CUDA_CALLABLE void adj_extract_shape_data_0(
    ...
    GenericShapeData_f25f19f5 & adj_ret_2,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:494
static CUDA_CALLABLE void adj_compute_bounding_sphere_from_aabb_0(
    wp::vec_t<3, wp::float32> var_aabb_lower,
    wp::vec_t<3, wp::float32> var_aabb_upper,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::float32 & ret_1,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:570
static CUDA_CALLABLE void adj_check_infinite_plane_bsphere_overlap_0(
    GenericShapeData_f25f19f5 var_shape_data_a,
    GenericShapeData_f25f19f5 var_shape_data_b,
    wp::vec_t<3, wp::float32> var_pos_a,
    wp::vec_t<3, wp::float32> var_pos_b,
    ...
    wp::float32 var_bsphere_radius_a,
    wp::float32 var_bsphere_radius_b,
    GenericShapeData_f25f19f5 & adj_shape_data_a,
    GenericShapeData_f25f19f5 & adj_shape_data_b,
    wp::vec_t<3, wp::float32> & adj_pos_a,
    wp::vec_t<3, wp::float32> & adj_pos_b,
    wp::quat_t<wp::float32> & adj_quat_a,
    wp::quat_t<wp::float32> & adj_quat_b,
    wp::vec_t<3, wp::float32> & adj_bsphere_center_a,
    wp::vec_t<3, wp::float32> & adj_bsphere_center_b,
    wp::float32 & adj_bsphere_radius_a,
    wp::float32 & adj_bsphere_radius_b,
    bool & adj_ret)
{
	// reverse mode disabled (module option "enable_backward" is False or no dependent kernel found with "enable_backward")
}
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:508
static CUDA_CALLABLE void adj_convert_infinite_plane_to_cube_0(
    GenericShapeData_f25f19f5 var_shape_data,
    wp::quat_t<wp::float32> var_plane_rotation,
    wp::vec_t<3, wp::float32> var_plane_position,
    wp::vec_t<3, wp::float32> var_other_position,
    ...
    wp::quat_t<wp::float32> & adj_plane_rotation,
    wp::vec_t<3, wp::float32> & adj_plane_position,
    wp::vec_t<3, wp::float32> & adj_other_position,
    wp::float32 & adj_other_radius,
    GenericShapeData_f25f19f5 & adj_ret_0,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_support_map_function__locals__geometric_center_16(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
    SupportMapDataProvider_e77f8b9f var_data_provider,
    GenericShapeData_f25f19f5 & adj_geom_a,
    GenericShapeData_f25f19f5 & adj_geom_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/support_function.py:332
static CUDA_CALLABLE void adj_support_map_lean_0(
    GenericShapeData_f25f19f5 var_geom,
    wp::vec_t<3, wp::float32> var_direction,
    SupportMapDataProvider_e77f8b9f var_data_provider,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_solve_mpr__locals__centered_box_support_8(
    GenericShapeData_f25f19f5 var_geom,
    wp::vec_t<3, wp::float32> var_direction,
    SupportMapDataProvider_e77f8b9f var_data_provider,
    GenericShapeData_f25f19f5 & adj_geom,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_support_map_function__locals__support_map_b_17(
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_support_map_function__locals__minkowski_support_17(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_solve_mpr__locals__solve_mpr_core_8(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:77
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__simplex_get_vertex_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::int32 var_i,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:293
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__simplex_get_closest_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::vec_t<4, wp::float32> var_barycentric,
    wp::uint32 var_usage_mask,
    wp::vec_t<3, wp::float32> & ret_0,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_support_map_function__locals__support_map_b_16(
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/mpr.py:0
static CUDA_CALLABLE void adj_create_support_map_function__locals__minkowski_support_16(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::vec_t<3, wp::float32> var_direction,
    wp::quat_t<wp::float32> var_orientation_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:91
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__closest_segment_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::int32 var_i0,
    wp::int32 var_i1,
    wp::vec_t<3, wp::float32> & ret_0,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:134
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__closest_triangle_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::int32 var_i0,
    wp::int32 var_i1,
    wp::int32 var_i2,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:210
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__determinant_8(
    wp::vec_t<3, wp::float32> var_a,
    wp::vec_t<3, wp::float32> var_b,
    wp::vec_t<3, wp::float32> var_c,
    wp::vec_t<3, wp::float32> var_d,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:215
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__closest_tetrahedron_8(
    wp::mat_t<8, 3, wp::float32> var_v,
    wp::vec_t<3, wp::float32> & ret_0,
    wp::vec_t<4, wp::float32> & ret_1,
    wp::uint32 & ret_2,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/simplex_solver.py:0
static CUDA_CALLABLE void adj_create_solve_closest_distance__locals__solve_closest_distance_core_8(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_b,
    wp::vec_t<3, wp::float32> var_position_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:144
static CUDA_CALLABLE void adj_post_process_minkowski_only_0(
    ContactData_40360d7c var_contact_data,
    GenericShapeData_f25f19f5 var_shape_a,
    wp::vec_t<3, wp::float32> var_pos_a_adjusted,
    wp::quat_t<wp::float32> var_rot_a,
    ...
    GenericShapeData_f25f19f5 & adj_shape_a,
    wp::vec_t<3, wp::float32> & adj_pos_a_adjusted,
    wp::quat_t<wp::float32> & adj_rot_a,
    GenericShapeData_f25f19f5 & adj_shape_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:0
static CUDA_CALLABLE void adj_create_build_manifold__locals__extract_4_point_contact_manifolds_5(
    wp::array_t<wp::vec_t<2, wp::float32>> var_m_a,
    wp::int32 var_m_a_count,
    wp::fixedarray_t<10, wp::vec_t<2, wp::float32>> var_m_b,
    wp::int32 var_m_b_count,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/multicontact.py:0
static CUDA_CALLABLE void adj_create_build_manifold__locals__build_manifold_5(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_a,
    wp::vec_t<3, wp::float32> var_position_a_world,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_convex.py:0
static CUDA_CALLABLE void adj_create_solve_convex_multi_contact__locals__solve_convex_multi_contact_4(
    GenericShapeData_f25f19f5 var_geom_a,
    GenericShapeData_f25f19f5 var_geom_b,
    wp::quat_t<wp::float32> var_orientation_a,
    wp::quat_t<wp::float32> var_orientation_b,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:0
static CUDA_CALLABLE void adj_create_compute_gjk_mpr_contacts__locals__compute_gjk_mpr_contacts_3(
    GenericShapeData_f25f19f5 var_shape_a_data,
    GenericShapeData_f25f19f5 var_shape_b_data,
    wp::quat_t<wp::float32> var_rot_a,
    wp::quat_t<wp::float32> var_rot_b,
    ...
    ContactWriterData_4222ebad var_writer_data,
    wp::int32 var_sort_sub_key,
    GenericShapeData_f25f19f5 & adj_shape_a_data,
    GenericShapeData_f25f19f5 & adj_shape_b_data,
    wp::quat_t<wp::float32> & adj_rot_a,
    wp::quat_t<wp::float32> & adj_rot_b,
    wp::vec_t<3, wp::float32> & adj_pos_a_adjusted,
    wp::vec_t<3, wp::float32> & adj_pos_b_adjusted,
...
// /home/jony/Downloads/ardy/newton_rtx_viewer/deps/newton/newton/_src/geometry/collision_core.py:0
static CUDA_CALLABLE void adj_create_find_contacts__locals__find_contacts_1(
    wp::vec_t<3, wp::float32> var_pos_a,
    wp::vec_t<3, wp::float32> var_pos_b,
    wp::quat_t<wp::float32> var_quat_a,
    wp::quat_t<wp::float32> var_quat_b,
    ...
    GenericShapeData_f25f19f5 & adj_shape_data_a,
    GenericShapeData_f25f19f5 & adj_shape_data_b,
    bool & adj_is_infinite_plane_a,
    bool & adj_is_infinite_plane_b,
    wp::float32 & adj_bsphere_radius_a,
    wp::float32 & adj_bsphere_radius_b,
    wp::float32 & adj_rigid_gap,
    wp::int32 & adj_shape_a,
...
extern "C" __global__ void create_narrow_phase_kernel_gjk_mpr__locals__narrow_phase_kernel_gjk_mpr_95ae89df_cuda_kernel_forward(
    ...
    wp::int32 var_total_num_threads)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        GenericShapeData_f25f19f5 var_34;
        wp::vec_t<3, wp::float32> var_35;
        wp::float32 var_36;
        wp::vec_t<3, wp::float32> var_37;
        wp::quat_t<wp::float32> var_38;
        GenericShapeData_f25f19f5 var_39;
        wp::vec_t<3, wp::float32> var_40;
        wp::float32 var_41;
        bool var_42;
        ...
        //---------
        // forward
        // def narrow_phase_kernel_gjk_mpr(                                                       <L 1>
        // tid = wp.tid()                                                                         <L 21>
        var_0 = builtin_tid1d();
        // num_work_items = wp.min(candidate_pair.shape[0], candidate_pair_count[0])              <L 23>
        ...
        start_for_1:;
            ...
            // if shape_a == shape_b or shape_a < 0 or shape_b < 0:                               <L 36>
            ...
            // type_a = shape_types[shape_a]                                                      <L 40>
            var_26 = wp::address(var_shape_types, var_17);
            var_28 = wp::load(var_26);
            var_27 = wp::copy(var_28);
            // type_b = shape_types[shape_b]                                                      <L 41>
            var_29 = wp::address(var_shape_types, var_19);
            var_31 = wp::load(var_29);
            var_30 = wp::copy(var_31);
            // pos_a, quat_a, shape_data_a, scale_a, margin_offset_a = extract_shape_data(        <L 44>
            // shape_a, shape_transform, shape_types, shape_data, shape_source                    <L 45>
            extract_shape_data_0(var_17, var_shape_transform, var_shape_types, var_shape_data, var_shape_source, var_32, var_33, var_34, var_35, var_36);
            // pos_b, quat_b, shape_data_b, scale_b, margin_offset_b = extract_shape_data(        <L 47>
            // shape_b, shape_transform, shape_types, shape_data, shape_source                    <L 48>
            extract_shape_data_0(var_19, var_shape_transform, var_shape_types, var_shape_data, var_shape_source, var_37, var_38, var_39, var_40, var_41);
            // is_infinite_plane_a = (type_a == GeoType.PLANE) and (scale_a[0] == 0.0 and scale_a[1] == 0.0)       <L 52>
            var_44 = (var_27 == var_43);
            var_42 = var_44;
            if (var_42) {
                var_47 = wp::extract(var_35, var_46);
                var_49 = (var_47 == var_48);
                var_45 = var_49;
                if (var_45) {
                    var_51 = wp::extract(var_35, var_50);
                    var_53 = (var_51 == var_52);
                    var_45 = var_45 && var_53;
                }
                var_42 = var_42 && var_45;
            }
            // is_infinite_plane_b = (type_b == GeoType.PLANE) and (scale_b[0] == 0.0 and scale_b[1] == 0.0)       <L 53>
            var_56 = (var_30 == var_55);
            var_54 = var_56;
            if (var_54) {
                var_59 = wp::extract(var_40, var_58);
                var_61 = (var_59 == var_60);
                var_57 = var_61;
                if (var_57) {
                    var_63 = wp::extract(var_40, var_62);
                    var_65 = (var_63 == var_64);
                    var_57 = var_57 && var_65;
                }
                var_54 = var_54 && var_57;
            }
            // if is_infinite_plane_a and is_infinite_plane_b:                                    <L 56>
            var_66 = var_42;
            if (var_66) {
                var_66 = var_66 && var_54;
            }
            if (var_66) {
                // continue                                                                       <L 57>
                goto start_for_1;
            }
            // bsphere_radius_a = float(0.0)                                                      <L 61>
            var_68 = wp::float(var_67);
            // bsphere_radius_b = float(0.0)                                                      <L 62>
            var_70 = wp::float(var_69);
            // has_infinite_plane = is_infinite_plane_a or is_infinite_plane_b                    <L 63>
            var_71 = var_42;
            if (!var_71) {
                var_71 = var_71 || var_54;
            }
            // if has_infinite_plane:                                                             <L 65>
            if (var_71) {
                // if wp.static(external_aabb):                                                   <L 67>
                // aabb_a_lower = shape_aabb_lower[shape_a]                                       <L 68>
                var_73 = wp::address(var_shape_aabb_lower, var_17);
                var_75 = wp::load(var_73);
                var_74 = wp::copy(var_75);
                // aabb_a_upper = shape_aabb_upper[shape_a]                                       <L 69>
                var_76 = wp::address(var_shape_aabb_upper, var_17);
                var_78 = wp::load(var_76);
                var_77 = wp::copy(var_78);
                // aabb_b_lower = shape_aabb_lower[shape_b]                                       <L 70>
                var_79 = wp::address(var_shape_aabb_lower, var_19);
                var_81 = wp::load(var_79);
                var_80 = wp::copy(var_81);
                // aabb_b_upper = shape_aabb_upper[shape_b]                                       <L 71>
                var_82 = wp::address(var_shape_aabb_upper, var_19);
                var_84 = wp::load(var_82);
                var_83 = wp::copy(var_84);
                // if wp.static(not external_aabb):                                               <L 72>
                // bsphere_center_a, bsphere_radius_a = compute_bounding_sphere_from_aabb(aabb_a_lower, aabb_a_upper)       <L 107>
                compute_bounding_sphere_from_aabb_0(var_74, var_77, var_86, var_87);
                // bsphere_center_b, bsphere_radius_b = compute_bounding_sphere_from_aabb(aabb_b_lower, aabb_b_upper)       <L 108>
                compute_bounding_sphere_from_aabb_0(var_80, var_83, var_88, var_89);
                // if wp.static(external_aabb and speculative):                                   <L 112>
                // if not check_infinite_plane_bsphere_overlap(                                   <L 119>
                // shape_data_a,                                                                  <L 120>
                // shape_data_b,                                                                  <L 121>
                // pos_a,                                                                         <L 122>
                // pos_b,                                                                         <L 123>
                // quat_a,                                                                        <L 124>
                // quat_b,                                                                        <L 125>
                // bsphere_center_a,                                                              <L 126>
                // bsphere_center_b,                                                              <L 127>
                // bsphere_radius_a,                                                              <L 128>
                // bsphere_radius_b,                                                              <L 129>
                var_91 = check_infinite_plane_bsphere_overlap_0(var_34, var_39, var_32, var_37, var_33, var_38, var_86, var_88, var_87, var_89);
                var_92 = wp::unot(var_91);
                if (var_92) {
                    // continue                                                                   <L 131>
                    goto start_for_1;
                }
            }
            var_93 = wp::where(var_71, var_87, var_68);
            var_94 = wp::where(var_71, var_89, var_70);
            // gap_a = shape_gap[shape_a]                                                         <L 134>
            var_95 = wp::address(var_shape_gap, var_17);
            var_97 = wp::load(var_95);
            var_96 = wp::copy(var_97);
            // gap_b = shape_gap[shape_b]                                                         <L 135>
            var_98 = wp::address(var_shape_gap, var_19);
            var_100 = wp::load(var_98);
            var_99 = wp::copy(var_100);
            // gap_sum = gap_a + gap_b                                                            <L 136>
            var_101 = wp::add(var_96, var_99);
            // wp.static(                                                                         <L 139>
            // pos_a,                                                                             <L 142>
            // pos_b,                                                                             <L 143>
            // quat_a,                                                                            <L 144>
            ...
            // shape_data_a,                                                                      <L 146>
            // shape_data_b,                                                                      <L 147>
            // is_infinite_plane_a,                                                               <L 148>
            // is_infinite_plane_b,                                                               <L 149>
            // bsphere_radius_a,                                                                  <L 150>
            // bsphere_radius_b,                                                                  <L 151>
            // gap_sum,                                                                           <L 152>
            // shape_a,                                                                           <L 153>
            // shape_b,                                                                           <L 154>
            // margin_offset_a,                                                                   <L 155>
            // margin_offset_b,                                                                   <L 156>
            // writer_data,                                                                       <L 157>
            create_find_contacts__locals__find_contacts_1(var_32, var_37, var_33, var_38, var_34, var_39, var_42, var_54, var_93, var_94, var_101, var_17, var_19, var_36, var_41, var_writer_data);
            goto start_for_1;
        end_for_1:;
    }
}
