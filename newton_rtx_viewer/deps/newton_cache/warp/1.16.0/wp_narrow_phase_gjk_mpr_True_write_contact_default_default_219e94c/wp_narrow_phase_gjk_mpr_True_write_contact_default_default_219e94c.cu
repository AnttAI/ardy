...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_core.py:494
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_core.py:570
static CUDA_CALLABLE bool check_infinite_plane_bsphere_overlap_0(
    GenericShapeData_ceaba563 var_shape_data_a,
    GenericShapeData_ceaba563 var_shape_data_b,
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_core.py:508
    ...
    wp::vec_t<3, wp::float32> & ret_1)
{
    //---------
    // primal vars
    GenericShapeData_ceaba563 var_0;
    ...
    var_0 = GenericShapeData_ceaba563();
    ...
    ContactWriterData_6ba3bf0a var_writer_data)
{
    ...
    wp::vec_t<3, wp::float32> var_8;
    wp::float32 var_9;
    GenericShapeData_ceaba563 var_10;
    wp::vec_t<3, wp::float32> var_11;
    GenericShapeData_ceaba563 var_12;
    wp::vec_t<3, wp::float32> var_13;
    wp::vec_t<3, wp::float32> var_14;
    wp::float32 var_15;
    GenericShapeData_ceaba563 var_16;
    wp::vec_t<3, wp::float32> var_17;
    GenericShapeData_ceaba563 var_18;
    wp::vec_t<3, wp::float32> var_19;
    const wp::int32 var_20 = 0;
    //---------
    // forward
...
static CUDA_CALLABLE void adj_check_infinite_plane_bsphere_overlap_0(
    ...
    wp::float32 var_bsphere_radius_a,
    wp::float32 var_bsphere_radius_b,
    GenericShapeData_ceaba563 & adj_shape_data_a,
    GenericShapeData_ceaba563 & adj_shape_data_b,
...
extern "C" __global__ void create_narrow_phase_kernel_gjk_mpr__locals__narrow_phase_kernel_gjk_mpr_7ce28e88_cuda_kernel_forward(
    ...
    wp::int32 var_total_num_threads)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        GenericShapeData_ceaba563 var_39;
        wp::vec_t<3, wp::float32> var_40;
        wp::float32 var_41;
        bool var_42;
        ...
        start_for_1:;
            ...
            if (var_71) {
                ...
                // if not check_infinite_plane_bsphere_overlap(                                   <L 110>
                // shape_data_a,                                                                  <L 111>
                // shape_data_b,                                                                  <L 112>
                // pos_a,                                                                         <L 113>
                // pos_b,                                                                         <L 114>
                // quat_a,                                                                        <L 115>
                // quat_b,                                                                        <L 116>
                // bsphere_center_a,                                                              <L 117>
                // bsphere_center_b,                                                              <L 118>
                // bsphere_radius_a,                                                              <L 119>
                // bsphere_radius_b,                                                              <L 120>
                var_90 = check_infinite_plane_bsphere_overlap_0(var_34, var_39, var_32, var_37, var_33, var_38, var_86, var_88, var_87, var_89);
                var_91 = wp::unot(var_90);
                if (var_91) {
                    // continue                                                                   <L 122>
                    goto start_for_1;
                }
            }
            var_92 = wp::where(var_71, var_87, var_68);
            var_93 = wp::where(var_71, var_89, var_70);
            // gap_a = shape_gap[shape_a]                                                         <L 125>
            var_94 = wp::address(var_shape_gap, var_17);
            var_96 = wp::load(var_94);
            var_95 = wp::copy(var_96);
            // gap_b = shape_gap[shape_b]                                                         <L 126>
            var_97 = wp::address(var_shape_gap, var_19);
            var_99 = wp::load(var_97);
            var_98 = wp::copy(var_99);
            // gap_sum = gap_a + gap_b                                                            <L 127>
            var_100 = wp::add(var_95, var_98);
            // wp.static(                                                                         <L 130>
            // pos_a,                                                                             <L 133>
            // pos_b,                                                                             <L 134>
            // quat_a,                                                                            <L 135>
            ...
            // shape_data_a,                                                                      <L 137>
            // shape_data_b,                                                                      <L 138>
            // is_infinite_plane_a,                                                               <L 139>
            // is_infinite_plane_b,                                                               <L 140>
            // bsphere_radius_a,                                                                  <L 141>
            // bsphere_radius_b,                                                                  <L 142>
            // gap_sum,                                                                           <L 143>
            // shape_a,                                                                           <L 144>
            // shape_b,                                                                           <L 145>
            // margin_offset_a,                                                                   <L 146>
            // margin_offset_b,                                                                   <L 147>
            // writer_data,                                                                       <L 148>
            create_find_contacts__locals__find_contacts_1(var_32, var_37, var_33, var_38, var_34, var_39, var_42, var_54, var_92, var_93, var_100, var_17, var_19, var_36, var_41, var_writer_data);
            goto start_for_1;
        end_for_1:;
    }
}
