...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:100
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:333
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:365
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:110
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/math/__init__.py:0
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:278
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:515
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:48
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:143
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:180
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:442
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/collision_primitive.py:1161
...
// /home/jony/miniconda3/envs/soma-retargeter/lib/python3.12/site-packages/newton/_src/geometry/contact_data.py:90
    ...
    ContactData_40360d7c var_contact_data)
{
    ...
    //---------
    // forward
    // def contact_passes_gap_check(                                                          <L 91>
    // total_separation_needed = (                                                            <L 103>
    // contact_data.radius_eff_a + contact_data.radius_eff_b + contact_data.margin_a + contact_data.margin_b       <L 104>
    ...
    // contact_normal_a_to_b = wp.normalize(contact_data.contact_normal_a_to_b)               <L 108>
    var_11 = &((var_contact_data).contact_normal_a_to_b);
    var_13 = wp::load(var_11);
    var_12 = wp::normalize(var_13);
    // a_contact_world = contact_data.contact_point_center - contact_normal_a_to_b * (        <L 110>
    var_14 = &((var_contact_data).contact_point_center);
    // 0.5 * contact_data.contact_distance + contact_data.radius_eff_a                        <L 111>
    ...
    // b_contact_world = contact_data.contact_point_center + contact_normal_a_to_b * (        <L 113>
    var_25 = &((var_contact_data).contact_point_center);
    // 0.5 * contact_data.contact_distance + contact_data.radius_eff_b                        <L 114>
    ...
    // diff = b_contact_world - a_contact_world                                               <L 117>
    var_36 = wp::sub(var_34, var_23);
    // distance = wp.dot(diff, contact_normal_a_to_b)                                         <L 118>
    var_37 = wp::dot(var_36, var_12);
    // d = distance - total_separation_needed                                                 <L 119>
    var_38 = wp::sub(var_37, var_9);
    // return d <= contact_data.gap_sum                                                       <L 121>
...
extern "C" __global__ void create_narrow_phase_primitive_kernel__locals__narrow_phase_primitive_kernel_81a38a1a_cuda_kernel_forward(
    ...
    wp::array_t<wp::int32> var_shape_pairs_sdf_sdf_count)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        wp::float32 var_270;
        wp::float32 var_271;
        const wp::float32 var_272 = 10000000000.0;
        wp::float32 var_273;
        wp::float32 var_274;
        wp::float32 var_275;
        wp::float32 var_276;
        ...
        wp::mat_t<3, 3, wp::float32> var_310;
        wp::vec_t<3, wp::float32> var_311;
        wp::vec_t<4, wp::float32> var_312;
        wp::mat_t<4, 3, wp::float32> var_313;
        ...
        const wp::float32 var_374 = 1.0;
        wp::vec_t<3, wp::float32> var_375;
        wp::vec_t<3, wp::float32> var_376;
        const wp::float32 var_377 = 0.0;
        const wp::float32 var_378 = 0.0;
        const wp::float32 var_379 = 1.0;
        ...
        wp::mat_t<2, 3, wp::float32> var_387;
        wp::mat_t<3, 3, wp::float32> var_388;
        ...
        const wp::int32 var_425 = 0;
        wp::float32 var_426;
        const wp::int32 var_427 = 1;
        wp::float32 var_428;
        wp::vec_t<4, wp::float32> var_429;
        wp::mat_t<4, 3, wp::float32> var_430;
        ...
        const wp::int32 var_461 = 0;
        wp::float32 var_462;
        const wp::int32 var_463 = 2;
        const wp::int32 var_464 = 1;
        wp::float32 var_465;
        const wp::int32 var_466 = 2;
        const wp::int32 var_467 = 2;
        wp::float32 var_468;
        wp::vec_t<3, wp::float32> var_469;
        const wp::int32 var_470 = 3;
        const wp::int32 var_471 = 0;
        wp::float32 var_472;
        const wp::int32 var_473 = 3;
        const wp::int32 var_474 = 1;
        wp::float32 var_475;
        const wp::int32 var_476 = 3;
        const wp::int32 var_477 = 2;
        wp::float32 var_478;
        wp::vec_t<3, wp::float32> var_479;
        bool var_480;
        const wp::int32 var_481 = 0;
        wp::float32 var_482;
        const wp::float32 var_483 = 0.0;
        const wp::float32 var_484 = 0.0;
        const wp::float32 var_485 = 1.0;
        ...
        wp::float32 var_513;
        wp::vec_t<2, wp::float32> var_514;
        wp::mat_t<2, 3, wp::float32> var_515;
        wp::vec_t<3, wp::float32> var_516;
        const wp::int32 var_517 = 0;
        wp::float32 var_518;
        ...
        const wp::float32 var_545 = 0.0;
        const wp::float32 var_546 = 1.0;
        wp::vec_t<3, wp::float32> var_547;
        wp::vec_t<3, wp::float32> var_548;
        const wp::int32 var_549 = 0;
        wp::float32 var_550;
        const wp::int32 var_551 = 1;
        wp::float32 var_552;
        wp::float32 var_553;
        ...
        wp::float32 var_558;
        wp::mat_t<3, 3, wp::float32> var_559;
        ...
        wp::vec_t<3, wp::float32> var_601;
        wp::vec_t<3, wp::float32> var_602;
        wp::vec_t<3, wp::float32> var_603;
        wp::vec_t<3, wp::float32> var_604;
        wp::float32 var_605;
        wp::float32 var_606;
        wp::vec_t<2, wp::float32> var_607;
        wp::mat_t<2, 3, wp::float32> var_608;
        wp::float32 var_609;
        wp::float32 var_610;
        wp::float32 var_611;
        wp::float32 var_612;
        ...
        bool var_665;
        ContactData_40360d7c var_666;
        const bool var_667 = false;
        bool var_668;
        bool var_669;
        bool var_670;
        const bool var_671 = false;
        bool var_672;
        bool var_673;
        bool var_674;
        const bool var_675 = false;
        bool var_676;
        bool var_677;
        bool var_678;
        const bool var_679 = false;
        bool var_680;
        bool var_681;
        bool var_682;
        wp::int32 var_683;
        ...
        bool var_691;
        wp::array_t<wp::int32>* var_692;
        const wp::int32 var_693 = 0;
        wp::int32 var_694;
        wp::array_t<wp::int32> var_695;
        wp::int32 var_696;
        wp::int32* var_697;
        bool var_698;
        wp::int32 var_699;
        ...
        const wp::int32 var_705 = 1;
        wp::int32 var_706;
        wp::int32 var_707;
        const wp::int32 var_708 = 2;
        const wp::int32 var_709 = 1;
        wp::int32 var_710;
        wp::int32 var_711;
        const wp::int32 var_712 = 3;
        const wp::int32 var_713 = 0;
        ...
        wp::shape_t var_719;
        bool var_720;
        wp::vec_t<2, wp::int32> var_721;
        //---------
        // forward
        // def narrow_phase_primitive_kernel(                                                     <L 1>
        // tid = wp.tid()                                                                         <L 39>
        var_0 = builtin_tid1d();
        // num_work_items = wp.min(candidate_pair.shape[0], candidate_pair_count[0])              <L 41>
        ...
        // if num_work_items == 0:                                                                <L 44>
        var_10 = (var_7 == var_9);
        if (var_10) {
            // return                                                                             <L 45>
            continue;
        }
        // for t in range(tid, num_work_items, total_num_threads):                                <L 47>
        var_11 = wp::range(var_0, var_7, var_total_num_threads);
        start_for_1:;
            if (iter_cmp(var_11) == 0) goto end_for_1;
            var_12 = wp::iter_next(var_11);
            // pair = candidate_pair[t]                                                           <L 49>
            ...
            // if shape_a == shape_b or shape_a < 0 or shape_b < 0:                               <L 54>
            ...
            // type_a = shape_types[shape_a]                                                      <L 58>
            var_26 = wp::address(var_shape_types, var_17);
            var_28 = wp::load(var_26);
            var_27 = wp::copy(var_28);
            // type_b = shape_types[shape_b]                                                      <L 59>
            var_29 = wp::address(var_shape_types, var_19);
            var_31 = wp::load(var_29);
            var_30 = wp::copy(var_31);
            // if type_a > type_b:                                                                <L 62>
            var_32 = (var_27 > var_30);
            if (var_32) {
                // shape_a, shape_b = shape_b, shape_a                                            <L 63>
                // type_a, type_b = type_b, type_a                                                <L 64>
            }
            ...
            // scale_b = wp.vec3(data_b[0], data_b[1], data_b[2])                                 <L 79>
            ...
            if (var_104) {
                ...
                if (var_111) {
                    ...
                    // if is_hfield_b:                                                            <L 114>
                    if (var_103) {
                        // encoded_a = shape_b | SHAPE_PAIR_HFIELD_BIT                            <L 115>
                        var_114 = wp::bit_or(var_34, var_113);
                        // encoded_b = shape_a                                                    <L 116>
                        var_115 = wp::copy(var_33);
                    }
                    if (!var_103) {
                        // elif is_hfield_a:                                                      <L 117>
                        if (var_101) {
                            // encoded_a = shape_a | SHAPE_PAIR_HFIELD_BIT                        <L 118>
                            var_117 = wp::bit_or(var_33, var_116);
                            // encoded_b = shape_b                                                <L 119>
                            var_118 = wp::copy(var_34);
                        }
                        if (!var_101) {
                            // encoded_a = shape_a                                                <L 121>
                            var_119 = wp::copy(var_33);
                            // encoded_b = shape_b                                                <L 122>
            ...
            // is_mesh_a = type_a == GeoType.MESH                                                 <L 142>
            var_149 = (var_35 == var_148);
            // is_mesh_b = type_b == GeoType.MESH                                                 <L 143>
            var_151 = (var_36 == var_150);
            // is_box_a = type_a == GeoType.BOX                                                   <L 144>
            var_153 = (var_35 == var_152);
            // is_box_b = type_b == GeoType.BOX                                                   <L 145>
            var_155 = (var_36 == var_154);
            // is_plane_a = type_a == GeoType.PLANE                                               <L 146>
            var_157 = (var_35 == var_156);
            // is_infinite_plane_a = is_plane_a and (scale_a[0] == 0.0 and scale_a[1] == 0.0)       <L 147>
            var_158 = var_157;
            if (var_158) {
            ...
            // has_sdf_edges_a = shape_sdf_index[shape_a] >= 0 and shape_edge_range[shape_a][1] > 0       <L 148>
            ...
            // has_sdf_edges_b = shape_sdf_index[shape_b] >= 0 and shape_edge_range[shape_b][1] > 0       <L 149>
            ...
            // if (is_mesh_a and is_mesh_b) or (                                                  <L 156>
            var_191 = var_149;
            if (var_191) {
            ...
            var_190 = var_191;
            if (!var_190) {
                // shape_pairs_mesh_mesh.shape[0] > 0                                             <L 157>
                ...
                var_192 = var_198;
                if (var_192) {
                    // and has_sdf_edges_a                                                        <L 158>
                    var_192 = var_192 && var_168;
                }
                if (var_192) {
                    // and has_sdf_edges_b                                                        <L 159>
                    var_192 = var_192 && var_179;
                }
                if (var_192) {
                    // and not (is_box_a and is_box_b)                                            <L 160>
                    var_199 = var_153;
                    if (var_199) {
            ...
            // is_sphere_a = type_a == GeoType.SPHERE                                             <L 191>
            var_247 = (var_35 == var_246);
            // is_sphere_b = type_b == GeoType.SPHERE                                             <L 192>
            var_249 = (var_36 == var_248);
            // is_capsule_a = type_a == GeoType.CAPSULE                                           <L 193>
            var_251 = (var_35 == var_250);
            // is_capsule_b = type_b == GeoType.CAPSULE                                           <L 194>
            var_253 = (var_36 == var_252);
            // is_ellipsoid_b = type_b == GeoType.ELLIPSOID                                       <L 195>
            var_255 = (var_36 == var_254);
            // is_cylinder_b = type_b == GeoType.CYLINDER                                         <L 196>
            var_257 = (var_36 == var_256);
            // is_box_b = type_b == GeoType.BOX                                                   <L 197>
            var_259 = (var_36 == var_258);
            // radius_eff_a = float(0.0)                                                          <L 201>
            var_261 = wp::float(var_260);
            // radius_eff_b = float(0.0)                                                          <L 202>
            var_263 = wp::float(var_262);
            // if is_sphere_a or is_capsule_a:                                                    <L 203>
            var_264 = var_247;
            if (!var_264) {
                var_264 = var_264 || var_251;
            }
            if (var_264) {
                // radius_eff_a = scale_a[0]                                                      <L 204>
                var_266 = wp::extract(var_71, var_265);
            }
            var_267 = wp::where(var_264, var_266, var_261);
            // if is_sphere_b or is_capsule_b:                                                    <L 205>
            var_268 = var_249;
            if (!var_268) {
                var_268 = var_268 || var_253;
            }
            if (var_268) {
                // radius_eff_b = scale_b[0]                                                      <L 206>
                var_270 = wp::extract(var_78, var_269);
            }
            var_271 = wp::where(var_268, var_270, var_263);
            // contact_dist_0 = float(MAXVAL)                                                     <L 211>
            var_273 = wp::float(var_272);
            // contact_dist_1 = float(MAXVAL)                                                     <L 212>
            var_274 = wp::float(var_272);
            // contact_dist_2 = float(MAXVAL)                                                     <L 213>
            var_275 = wp::float(var_272);
            // contact_dist_3 = float(MAXVAL)                                                     <L 214>
            var_276 = wp::float(var_272);
            // contact_pos_0 = wp.vec3()                                                          <L 215>
            var_277 = wp::vec_t<3, wp::float32>();
            // contact_pos_1 = wp.vec3()                                                          <L 216>
            var_278 = wp::vec_t<3, wp::float32>();
            // contact_pos_2 = wp.vec3()                                                          <L 217>
            var_279 = wp::vec_t<3, wp::float32>();
            // contact_pos_3 = wp.vec3()                                                          <L 218>
            var_280 = wp::vec_t<3, wp::float32>();
            // contact_normal = wp.vec3()                                                         <L 219>
            var_281 = wp::vec_t<3, wp::float32>();
            // if is_plane_a and is_sphere_b:                                                     <L 224>
            var_282 = var_157;
            if (var_282) {
                var_282 = var_282 && var_249;
            }
            if (var_282) {
                // plane_normal = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))                  <L 225>
                var_286 = wp::vec_t<3, wp::float32>(var_283, var_284, var_285);
                var_287 = wp::quat_rotate(var_91, var_286);
                // sphere_radius = scale_b[0]                                                     <L 226>
                var_289 = wp::extract(var_78, var_288);
                // contact_dist_0, contact_pos_0 = collide_plane_sphere(plane_normal, pos_a, pos_b, sphere_radius)       <L 227>
                collide_plane_sphere_0(var_287, var_89, var_90, var_289, var_290, var_291);
                // contact_normal = plane_normal                                                  <L 228>
                var_292 = wp::copy(var_287);
            }
            if (!var_282) {
                // elif is_plane_a and is_ellipsoid_b:                                            <L 234>
                var_293 = var_157;
                if (var_293) {
                    var_293 = var_293 && var_255;
                }
                if (var_293) {
                    // plane_normal = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))              <L 235>
                    var_297 = wp::vec_t<3, wp::float32>(var_294, var_295, var_296);
                    var_298 = wp::quat_rotate(var_91, var_297);
                    // ellipsoid_rot = wp.quat_to_matrix(quat_b)                                  <L 236>
                    var_299 = wp::quat_to_matrix(var_92);
                    // ellipsoid_size = scale_b                                                   <L 237>
                    var_300 = wp::copy(var_78);
                    // contact_dist_0, contact_pos_0, contact_normal = collide_plane_ellipsoid(       <L 238>
                    // plane_normal, pos_a, pos_b, ellipsoid_rot, ellipsoid_size                  <L 239>
                    collide_plane_ellipsoid_0(var_298, var_89, var_90, var_299, var_300, var_301, var_302, var_303);
                }
                if (!var_293) {
                    // elif is_plane_a and is_box_b:                                              <L 246>
                    var_304 = var_157;
                    if (var_304) {
                        var_304 = var_304 && var_259;
                    }
                    if (var_304) {
                        // plane_normal = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))          <L 247>
                        var_308 = wp::vec_t<3, wp::float32>(var_305, var_306, var_307);
                        var_309 = wp::quat_rotate(var_91, var_308);
                        // box_rot = wp.quat_to_matrix(quat_b)                                    <L 248>
                        var_310 = wp::quat_to_matrix(var_92);
                        // box_size = scale_b                                                     <L 249>
                        var_311 = wp::copy(var_78);
                        // dists4_box, positions4_box, contact_normal = collide_plane_box(        <L 251>
                        // plane_normal, pos_a, pos_b, box_rot, box_size, gap_sum                 <L 252>
                        collide_plane_box_0(var_309, var_89, var_90, var_310, var_311, var_99, var_312, var_313, var_314);
                        // contact_dist_0 = dists4_box[0]                                         <L 255>
                        var_316 = wp::extract(var_312, var_315);
                        // contact_dist_1 = dists4_box[1]                                         <L 256>
                        var_318 = wp::extract(var_312, var_317);
                        // contact_dist_2 = dists4_box[2]                                         <L 257>
                        var_320 = wp::extract(var_312, var_319);
                        // contact_dist_3 = dists4_box[3]                                         <L 258>
                        var_322 = wp::extract(var_312, var_321);
                        // contact_pos_0 = wp.vec3(positions4_box[0, 0], positions4_box[0, 1], positions4_box[0, 2])       <L 259>
                        var_325 = wp::extract(var_313, var_323, var_324);
                        var_328 = wp::extract(var_313, var_326, var_327);
                        var_331 = wp::extract(var_313, var_329, var_330);
                        var_332 = wp::vec_t<3, wp::float32>(var_325, var_328, var_331);
                        // contact_pos_1 = wp.vec3(positions4_box[1, 0], positions4_box[1, 1], positions4_box[1, 2])       <L 260>
                        var_335 = wp::extract(var_313, var_333, var_334);
                        var_338 = wp::extract(var_313, var_336, var_337);
                        var_341 = wp::extract(var_313, var_339, var_340);
                        var_342 = wp::vec_t<3, wp::float32>(var_335, var_338, var_341);
                        // contact_pos_2 = wp.vec3(positions4_box[2, 0], positions4_box[2, 1], positions4_box[2, 2])       <L 261>
                        var_345 = wp::extract(var_313, var_343, var_344);
                        var_348 = wp::extract(var_313, var_346, var_347);
                        var_351 = wp::extract(var_313, var_349, var_350);
                        var_352 = wp::vec_t<3, wp::float32>(var_345, var_348, var_351);
                        // contact_pos_3 = wp.vec3(positions4_box[3, 0], positions4_box[3, 1], positions4_box[3, 2])       <L 262>
                        var_355 = wp::extract(var_313, var_353, var_354);
                        var_358 = wp::extract(var_313, var_356, var_357);
                        var_361 = wp::extract(var_313, var_359, var_360);
                        var_362 = wp::vec_t<3, wp::float32>(var_355, var_358, var_361);
                    }
                    if (!var_304) {
                        // elif is_sphere_a and is_sphere_b:                                      <L 267>
                        var_363 = var_247;
                        if (var_363) {
                            var_363 = var_363 && var_249;
                        }
                        if (var_363) {
                            // radius_a = scale_a[0]                                              <L 268>
                            var_365 = wp::extract(var_71, var_364);
                            // radius_b = scale_b[0]                                              <L 269>
                            var_367 = wp::extract(var_78, var_366);
                            // contact_dist_0, contact_pos_0, contact_normal = collide_sphere_sphere(pos_a, radius_a, pos_b, radius_b)       <L 270>
                            collide_sphere_sphere_0(var_89, var_365, var_90, var_367, var_368, var_369, var_370);
                        }
                        if (!var_363) {
                            // elif is_plane_a and is_capsule_b:                                  <L 276>
                            var_371 = var_157;
                            if (var_371) {
                                var_371 = var_371 && var_253;
                            }
                            if (var_371) {
                                // plane_normal = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))       <L 277>
                                var_375 = wp::vec_t<3, wp::float32>(var_372, var_373, var_374);
                                var_376 = wp::quat_rotate(var_91, var_375);
                                // capsule_axis = wp.quat_rotate(quat_b, wp.vec3(0.0, 0.0, 1.0))       <L 278>
                                var_380 = wp::vec_t<3, wp::float32>(var_377, var_378, var_379);
                                var_381 = wp::quat_rotate(var_92, var_380);
                                // capsule_radius = scale_b[0]                                    <L 279>
                                var_383 = wp::extract(var_78, var_382);
                                // capsule_half_length = scale_b[1]                               <L 280>
                                var_385 = wp::extract(var_78, var_384);
                                // dists, positions, _frame = collide_plane_capsule(              <L 282>
                                // plane_normal, pos_a, pos_b, capsule_axis, capsule_radius, capsule_half_length       <L 283>
                                collide_plane_capsule_0(var_376, var_89, var_90, var_381, var_383, var_385, var_386, var_387, var_388);
                                // contact_dist_0 = dists[0]                                      <L 286>
                                var_390 = wp::extract(var_386, var_389);
                                // contact_dist_1 = dists[1]                                      <L 287>
                                var_392 = wp::extract(var_386, var_391);
                                // contact_pos_0 = wp.vec3(positions[0, 0], positions[0, 1], positions[0, 2])       <L 288>
                                var_395 = wp::extract(var_387, var_393, var_394);
                                var_398 = wp::extract(var_387, var_396, var_397);
                                var_401 = wp::extract(var_387, var_399, var_400);
                                var_402 = wp::vec_t<3, wp::float32>(var_395, var_398, var_401);
                                // contact_pos_1 = wp.vec3(positions[1, 0], positions[1, 1], positions[1, 2])       <L 289>
                                var_405 = wp::extract(var_387, var_403, var_404);
                                var_408 = wp::extract(var_387, var_406, var_407);
                                var_411 = wp::extract(var_387, var_409, var_410);
                                var_412 = wp::vec_t<3, wp::float32>(var_405, var_408, var_411);
                                // contact_normal = plane_normal                                  <L 290>
                                var_413 = wp::copy(var_376);
                            }
                            if (!var_371) {
                                // elif is_plane_a and is_cylinder_b:                             <L 296>
                                var_414 = var_157;
                                if (var_414) {
                                    var_414 = var_414 && var_257;
                                }
                                if (var_414) {
                                    // plane_normal = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))       <L 297>
                                    var_418 = wp::vec_t<3, wp::float32>(var_415, var_416, var_417);
                                    var_419 = wp::quat_rotate(var_91, var_418);
                                    // cylinder_axis = wp.quat_rotate(quat_b, wp.vec3(0.0, 0.0, 1.0))       <L 298>
                                    var_423 = wp::vec_t<3, wp::float32>(var_420, var_421, var_422);
                                    var_424 = wp::quat_rotate(var_92, var_423);
                                    // cylinder_radius = scale_b[0]                               <L 299>
                                    var_426 = wp::extract(var_78, var_425);
                                    // cylinder_half_height = scale_b[1]                          <L 300>
                                    var_428 = wp::extract(var_78, var_427);
                                    // dists4, positions4, contact_normal = collide_plane_cylinder(       <L 302>
                                    // plane_normal, pos_a, pos_b, cylinder_axis, cylinder_radius, cylinder_half_height       <L 303>
                                    collide_plane_cylinder_0(var_419, var_89, var_90, var_424, var_426, var_428, var_429, var_430, var_431);
                                    // contact_dist_0 = dists4[0]                                 <L 306>
                                    var_433 = wp::extract(var_429, var_432);
                                    // contact_dist_1 = dists4[1]                                 <L 307>
                                    var_435 = wp::extract(var_429, var_434);
                                    // contact_dist_2 = dists4[2]                                 <L 308>
                                    var_437 = wp::extract(var_429, var_436);
                                    // contact_dist_3 = dists4[3]                                 <L 309>
                                    var_439 = wp::extract(var_429, var_438);
                                    // contact_pos_0 = wp.vec3(positions4[0, 0], positions4[0, 1], positions4[0, 2])       <L 310>
                                    var_442 = wp::extract(var_430, var_440, var_441);
                                    var_445 = wp::extract(var_430, var_443, var_444);
                                    var_448 = wp::extract(var_430, var_446, var_447);
                                    var_449 = wp::vec_t<3, wp::float32>(var_442, var_445, var_448);
                                    // contact_pos_1 = wp.vec3(positions4[1, 0], positions4[1, 1], positions4[1, 2])       <L 311>
                                    var_452 = wp::extract(var_430, var_450, var_451);
                                    var_455 = wp::extract(var_430, var_453, var_454);
                                    var_458 = wp::extract(var_430, var_456, var_457);
                                    var_459 = wp::vec_t<3, wp::float32>(var_452, var_455, var_458);
                                    // contact_pos_2 = wp.vec3(positions4[2, 0], positions4[2, 1], positions4[2, 2])       <L 312>
                                    var_462 = wp::extract(var_430, var_460, var_461);
                                    var_465 = wp::extract(var_430, var_463, var_464);
                                    var_468 = wp::extract(var_430, var_466, var_467);
                                    var_469 = wp::vec_t<3, wp::float32>(var_462, var_465, var_468);
                                    // contact_pos_3 = wp.vec3(positions4[3, 0], positions4[3, 1], positions4[3, 2])       <L 313>
                                    var_472 = wp::extract(var_430, var_470, var_471);
                                    var_475 = wp::extract(var_430, var_473, var_474);
                                    var_478 = wp::extract(var_430, var_476, var_477);
                                    var_479 = wp::vec_t<3, wp::float32>(var_472, var_475, var_478);
                                }
                                if (!var_414) {
                                    // elif is_sphere_a and is_capsule_b:                         <L 318>
                                    var_480 = var_247;
                                    if (var_480) {
                                        var_480 = var_480 && var_253;
                                    }
                                    if (var_480) {
                                        // sphere_radius = scale_a[0]                             <L 319>
                                        var_482 = wp::extract(var_71, var_481);
                                        // capsule_axis = wp.quat_rotate(quat_b, wp.vec3(0.0, 0.0, 1.0))       <L 320>
                                        var_486 = wp::vec_t<3, wp::float32>(var_483, var_484, var_485);
                                        var_487 = wp::quat_rotate(var_92, var_486);
                                        // capsule_radius = scale_b[0]                            <L 321>
                                        var_489 = wp::extract(var_78, var_488);
                                        // capsule_half_length = scale_b[1]                       <L 322>
                                        var_491 = wp::extract(var_78, var_490);
                                        // contact_dist_0, contact_pos_0, contact_normal = collide_sphere_capsule(       <L 323>
                                        // pos_a, sphere_radius, pos_b, capsule_axis, capsule_radius, capsule_half_length       <L 324>
                                        collide_sphere_capsule_0(var_89, var_482, var_90, var_487, var_489, var_491, var_492, var_493, var_494);
                                    }
                                    if (!var_480) {
                                        // elif is_capsule_a and is_capsule_b:                    <L 331>
                                        var_495 = var_251;
                                        if (var_495) {
                                            var_495 = var_495 && var_253;
                                        }
                                        if (var_495) {
                                            // axis_a = wp.quat_rotate(quat_a, wp.vec3(0.0, 0.0, 1.0))       <L 332>
                                            var_499 = wp::vec_t<3, wp::float32>(var_496, var_497, var_498);
                                            var_500 = wp::quat_rotate(var_91, var_499);
                                            // axis_b = wp.quat_rotate(quat_b, wp.vec3(0.0, 0.0, 1.0))       <L 333>
                                            var_504 = wp::vec_t<3, wp::float32>(var_501, var_502, var_503);
                                            var_505 = wp::quat_rotate(var_92, var_504);
                                            // radius_a = scale_a[0]                              <L 334>
                                            var_507 = wp::extract(var_71, var_506);
                                            // half_length_a = scale_a[1]                         <L 335>
                                            var_509 = wp::extract(var_71, var_508);
                                            // radius_b = scale_b[0]                              <L 336>
                                            var_511 = wp::extract(var_78, var_510);
                                            // half_length_b = scale_b[1]                         <L 337>
                                            var_513 = wp::extract(var_78, var_512);
                                            // dists, positions, contact_normal = collide_capsule_capsule(       <L 339>
                                            // pos_a, axis_a, radius_a, half_length_a, pos_b, axis_b, radius_b, half_length_b       <L 340>
                                            collide_capsule_capsule_0(var_89, var_500, var_507, var_509, var_90, var_505, var_511, var_513, var_514, var_515, var_516);
                                            // contact_dist_0 = dists[0]                          <L 343>
                                            var_518 = wp::extract(var_514, var_517);
                                            // contact_pos_0 = wp.vec3(positions[0, 0], positions[0, 1], positions[0, 2])       <L 344>
                                            var_521 = wp::extract(var_515, var_519, var_520);
                                            var_524 = wp::extract(var_515, var_522, var_523);
                                            var_527 = wp::extract(var_515, var_525, var_526);
                                            var_528 = wp::vec_t<3, wp::float32>(var_521, var_524, var_527);
                                            // contact_dist_1 = dists[1]                          <L 345>
                                            var_530 = wp::extract(var_514, var_529);
                                            // contact_pos_1 = wp.vec3(positions[1, 0], positions[1, 1], positions[1, 2])       <L 346>
                                            var_533 = wp::extract(var_515, var_531, var_532);
                                            var_536 = wp::extract(var_515, var_534, var_535);
                                            var_539 = wp::extract(var_515, var_537, var_538);
                                            var_540 = wp::vec_t<3, wp::float32>(var_533, var_536, var_539);
                                        }
                                        if (!var_495) {
                                            // elif is_sphere_a and is_cylinder_b:                <L 351>
                                            var_541 = var_247;
                                            if (var_541) {
                                                var_541 = var_541 && var_257;
                                            }
                                            if (var_541) {
                                                // sphere_radius = scale_a[0]                     <L 352>
                                                var_543 = wp::extract(var_71, var_542);
                                                // cylinder_axis = wp.quat_rotate(quat_b, wp.vec3(0.0, 0.0, 1.0))       <L 353>
                                                var_547 = wp::vec_t<3, wp::float32>(var_544, var_545, var_546);
                                                var_548 = wp::quat_rotate(var_92, var_547);
                                                // cylinder_radius = scale_b[0]                   <L 354>
                                                var_550 = wp::extract(var_78, var_549);
                                                // cylinder_half_height = scale_b[1]              <L 355>
                                                var_552 = wp::extract(var_78, var_551);
                                                // contact_dist_0, contact_pos_0, contact_normal = collide_sphere_cylinder(       <L 356>
                                                // pos_a, sphere_radius, pos_b, cylinder_axis, cylinder_radius, cylinder_half_height       <L 357>
                                                collide_sphere_cylinder_0(var_89, var_543, var_90, var_548, var_550, var_552, var_553, var_554, var_555);
                                            }
                                            if (!var_541) {
                                                // elif is_sphere_a and is_box_b:                 <L 363>
                                                var_556 = var_247;
                                                if (var_556) {
                                                    var_556 = var_556 && var_259;
                                                }
                                                if (var_556) {
                                                    // sphere_radius = scale_a[0]                 <L 364>
                                                    var_558 = wp::extract(var_71, var_557);
                                                    // box_rot = wp.quat_to_matrix(quat_b)        <L 365>
                                                    var_559 = wp::quat_to_matrix(var_92);
                                                    // box_size = scale_b                         <L 366>
                                                    var_560 = wp::copy(var_78);
                                                    // contact_dist_0, contact_pos_0, contact_normal = collide_sphere_box(       <L 367>
                                                    // pos_a, sphere_radius, pos_b, box_rot, box_size       <L 368>
                                                    collide_sphere_box_0(var_89, var_558, var_90, var_559, var_560, var_561, var_562, var_563);
                                                }
                                                var_564 = wp::where(var_556, var_561, var_273);
                                                var_565 = wp::where(var_556, var_562, var_277);
                                                var_566 = wp::where(var_556, var_563, var_281);
                                            }
                                            var_567 = wp::where(var_541, var_553, var_564);
                                            var_568 = wp::where(var_541, var_554, var_565);
                                            var_569 = wp::where(var_541, var_555, var_566);
                                            var_570 = wp::where(var_541, var_543, var_558);
                                        }
                                        var_571 = wp::where(var_495, var_518, var_567);
                                        var_572 = wp::where(var_495, var_530, var_274);
                                        var_573 = wp::where(var_495, var_528, var_568);
                                        var_574 = wp::where(var_495, var_540, var_278);
                                        var_575 = wp::where(var_495, var_516, var_569);
                                    }
                                    var_576 = wp::where(var_480, var_492, var_571);
                                    var_577 = wp::where(var_480, var_274, var_572);
                                    var_578 = wp::where(var_480, var_493, var_573);
                                    var_579 = wp::where(var_480, var_278, var_574);
                                    var_580 = wp::where(var_480, var_494, var_575);
                                    var_581 = wp::where(var_480, var_482, var_570);
                                }
                                var_582 = wp::where(var_414, var_433, var_576);
                                var_583 = wp::where(var_414, var_435, var_577);
                                var_584 = wp::where(var_414, var_437, var_275);
                                var_585 = wp::where(var_414, var_439, var_276);
                                var_586 = wp::where(var_414, var_449, var_578);
                                var_587 = wp::where(var_414, var_459, var_579);
                                var_588 = wp::where(var_414, var_469, var_279);
                                var_589 = wp::where(var_414, var_479, var_280);
                                var_590 = wp::where(var_414, var_431, var_580);
                                var_591 = wp::where(var_414, var_424, var_548);
                                var_592 = wp::where(var_414, var_426, var_550);
                                var_593 = wp::where(var_414, var_428, var_552);
                            }
                            var_594 = wp::where(var_371, var_390, var_582);
                            var_595 = wp::where(var_371, var_392, var_583);
                            var_596 = wp::where(var_371, var_275, var_584);
                            var_597 = wp::where(var_371, var_276, var_585);
                            var_598 = wp::where(var_371, var_402, var_586);
                            var_599 = wp::where(var_371, var_412, var_587);
                            var_600 = wp::where(var_371, var_279, var_588);
                            var_601 = wp::where(var_371, var_280, var_589);
                            var_602 = wp::where(var_371, var_413, var_590);
                            var_603 = wp::where(var_371, var_376, var_419);
                            var_604 = wp::where(var_371, var_381, var_487);
                            var_605 = wp::where(var_371, var_383, var_489);
                            var_606 = wp::where(var_371, var_385, var_491);
                            var_607 = wp::where(var_371, var_386, var_514);
                            var_608 = wp::where(var_371, var_387, var_515);
                        }
                        var_609 = wp::where(var_363, var_368, var_594);
                        var_610 = wp::where(var_363, var_274, var_595);
                        var_611 = wp::where(var_363, var_275, var_596);
                        var_612 = wp::where(var_363, var_276, var_597);
                        var_613 = wp::where(var_363, var_369, var_598);
                        var_614 = wp::where(var_363, var_278, var_599);
                        var_615 = wp::where(var_363, var_279, var_600);
                        var_616 = wp::where(var_363, var_280, var_601);
                        var_617 = wp::where(var_363, var_370, var_602);
                        var_618 = wp::where(var_363, var_365, var_507);
                        var_619 = wp::where(var_363, var_367, var_511);
                    }
                    var_620 = wp::where(var_304, var_316, var_609);
                    var_621 = wp::where(var_304, var_318, var_610);
                    var_622 = wp::where(var_304, var_320, var_611);
                    var_623 = wp::where(var_304, var_322, var_612);
                    var_624 = wp::where(var_304, var_332, var_613);
                    var_625 = wp::where(var_304, var_342, var_614);
                    var_626 = wp::where(var_304, var_352, var_615);
                    var_627 = wp::where(var_304, var_362, var_616);
                    var_628 = wp::where(var_304, var_314, var_617);
                    var_629 = wp::where(var_304, var_309, var_603);
                    var_630 = wp::where(var_304, var_310, var_559);
                    var_631 = wp::where(var_304, var_311, var_560);
                }
                var_632 = wp::where(var_293, var_301, var_620);
                var_633 = wp::where(var_293, var_274, var_621);
                var_634 = wp::where(var_293, var_275, var_622);
                var_635 = wp::where(var_293, var_276, var_623);
                var_636 = wp::where(var_293, var_302, var_624);
                var_637 = wp::where(var_293, var_278, var_625);
                var_638 = wp::where(var_293, var_279, var_626);
                var_639 = wp::where(var_293, var_280, var_627);
                var_640 = wp::where(var_293, var_303, var_628);
                var_641 = wp::where(var_293, var_298, var_629);
            }
            var_642 = wp::where(var_282, var_290, var_632);
            var_643 = wp::where(var_282, var_274, var_633);
            var_644 = wp::where(var_282, var_275, var_634);
            var_645 = wp::where(var_282, var_276, var_635);
            var_646 = wp::where(var_282, var_291, var_636);
            var_647 = wp::where(var_282, var_278, var_637);
            var_648 = wp::where(var_282, var_279, var_638);
            var_649 = wp::where(var_282, var_280, var_639);
            var_650 = wp::where(var_282, var_292, var_640);
            var_651 = wp::where(var_282, var_287, var_641);
            var_652 = wp::where(var_282, var_289, var_581);
            // num_contacts = (                                                                   <L 374>
            // int(contact_dist_0 < MAXVAL)                                                       <L 375>
            var_653 = (var_642 < var_272);
            var_654 = wp::int(var_653);
            // + int(contact_dist_1 < MAXVAL)                                                     <L 376>
            var_655 = (var_643 < var_272);
            var_656 = wp::int(var_655);
            var_657 = wp::add(var_654, var_656);
            // + int(contact_dist_2 < MAXVAL)                                                     <L 377>
            var_658 = (var_644 < var_272);
            var_659 = wp::int(var_658);
            var_660 = wp::add(var_657, var_659);
            // + int(contact_dist_3 < MAXVAL)                                                     <L 378>
            var_661 = (var_645 < var_272);
            var_662 = wp::int(var_661);
            var_663 = wp::add(var_660, var_662);
            // if num_contacts > 0:                                                               <L 380>
            var_665 = (var_663 > var_664);
            if (var_665) {
                // contact_data = ContactData()                                                   <L 382>
                var_666 = ContactData_40360d7c();
                // contact_data.contact_normal_a_to_b = contact_normal                            <L 383>
                var_666.contact_normal_a_to_b = var_650;
                // contact_data.radius_eff_a = radius_eff_a                                       <L 384>
                var_666.radius_eff_a = var_267;
                // contact_data.radius_eff_b = radius_eff_b                                       <L 385>
                var_666.radius_eff_b = var_271;
                // contact_data.margin_a = margin_offset_a                                        <L 386>
                var_666.margin_a = var_80;
                // contact_data.margin_b = margin_offset_b                                        <L 387>
                var_666.margin_b = var_82;
                // contact_data.shape_a = shape_a                                                 <L 388>
                var_666.shape_a = var_33;
                // contact_data.shape_b = shape_b                                                 <L 389>
                var_666.shape_b = var_34;
                // contact_data.gap_sum = gap_sum                                                 <L 390>
                var_666.gap_sum = var_99;
                // contact_0_valid = False                                                        <L 393>
                // if contact_dist_0 < MAXVAL:                                                    <L 394>
                var_668 = (var_642 < var_272);
                if (var_668) {
                    // contact_data.contact_point_center = contact_pos_0                          <L 395>
                    var_666.contact_point_center = var_646;
                    // contact_data.contact_distance = contact_dist_0                             <L 396>
                    var_666.contact_distance = var_642;
                    // contact_0_valid = contact_passes_gap_check(contact_data)                   <L 397>
                    var_669 = contact_passes_gap_check_0(var_666);
                }
                var_670 = wp::where(var_668, var_669, var_667);
                // contact_1_valid = False                                                        <L 399>
                // if contact_dist_1 < MAXVAL:                                                    <L 400>
                var_672 = (var_643 < var_272);
                if (var_672) {
                    // contact_data.contact_point_center = contact_pos_1                          <L 401>
                    var_666.contact_point_center = var_647;
                    // contact_data.contact_distance = contact_dist_1                             <L 402>
                    var_666.contact_distance = var_643;
                    // contact_1_valid = contact_passes_gap_check(contact_data)                   <L 403>
                    var_673 = contact_passes_gap_check_0(var_666);
                }
                var_674 = wp::where(var_672, var_673, var_671);
                // contact_2_valid = False                                                        <L 405>
                // if contact_dist_2 < MAXVAL:                                                    <L 406>
                var_676 = (var_644 < var_272);
                if (var_676) {
                    // contact_data.contact_point_center = contact_pos_2                          <L 407>
                    var_666.contact_point_center = var_648;
                    // contact_data.contact_distance = contact_dist_2                             <L 408>
                    var_666.contact_distance = var_644;
                    // contact_2_valid = contact_passes_gap_check(contact_data)                   <L 409>
                    var_677 = contact_passes_gap_check_0(var_666);
                }
                var_678 = wp::where(var_676, var_677, var_675);
                // contact_3_valid = False                                                        <L 411>
                // if contact_dist_3 < MAXVAL:                                                    <L 412>
                var_680 = (var_645 < var_272);
                if (var_680) {
                    // contact_data.contact_point_center = contact_pos_3                          <L 413>
                    var_666.contact_point_center = var_649;
                    // contact_data.contact_distance = contact_dist_3                             <L 414>
                    var_666.contact_distance = var_645;
                    // contact_3_valid = contact_passes_gap_check(contact_data)                   <L 415>
                    var_681 = contact_passes_gap_check_0(var_666);
                }
                var_682 = wp::where(var_680, var_681, var_679);
                // num_valid = int(contact_0_valid) + int(contact_1_valid) + int(contact_2_valid) + int(contact_3_valid)       <L 418>
                var_683 = wp::int(var_670);
                var_684 = wp::int(var_674);
                var_685 = wp::add(var_683, var_684);
                var_686 = wp::int(var_678);
                var_687 = wp::add(var_685, var_686);
                var_688 = wp::int(var_682);
                var_689 = wp::add(var_687, var_688);
                // if num_valid > 0:                                                              <L 419>
                var_691 = (var_689 > var_690);
                if (var_691) {
                    // base_index = wp.atomic_add(writer_data.contact_count, 0, num_valid)        <L 420>
                    var_692 = &((var_writer_data).contact_count);
                    var_695 = wp::load(var_692);
                    var_694 = wp::atomic_add(var_695, var_693, var_689);
                    // if base_index + num_valid > writer_data.contact_max:                       <L 424>
                    var_696 = wp::add(var_694, var_689);
                    var_697 = &((var_writer_data).contact_max);
                    var_699 = wp::load(var_697);
                    var_698 = (var_696 > var_699);
                    if (var_698) {
                        // continue                                                               <L 425>
                        goto start_for_1;
                    }
                    // if contact_0_valid:                                                        <L 428>
                    if (var_670) {
                        // contact_data.contact_point_center = contact_pos_0                      <L 429>
                        var_666.contact_point_center = var_646;
                        // contact_data.contact_distance = contact_dist_0                         <L 430>
                        var_666.contact_distance = var_642;
                        // contact_data.sort_sub_key = 0                                          <L 431>
                        var_666.sort_sub_key = var_700;
                        // writer_func(contact_data, writer_data, base_index)                     <L 432>
                        write_contact_0(var_666, var_writer_data, var_694);
                        // base_index += 1                                                        <L 433>
                        var_702 = wp::add(var_694, var_701);
                    }
                    var_703 = wp::where(var_670, var_702, var_694);
                    // if contact_1_valid:                                                        <L 436>
                    if (var_674) {
                        // contact_data.contact_point_center = contact_pos_1                      <L 437>
                        var_666.contact_point_center = var_647;
                        // contact_data.contact_distance = contact_dist_1                         <L 438>
                        var_666.contact_distance = var_643;
                        // contact_data.sort_sub_key = 1                                          <L 439>
                        var_666.sort_sub_key = var_704;
                        // writer_func(contact_data, writer_data, base_index)                     <L 440>
                        write_contact_0(var_666, var_writer_data, var_703);
                        // base_index += 1                                                        <L 441>
                        var_706 = wp::add(var_703, var_705);
                    }
                    var_707 = wp::where(var_674, var_706, var_703);
                    // if contact_2_valid:                                                        <L 444>
                    if (var_678) {
                        // contact_data.contact_point_center = contact_pos_2                      <L 445>
                        var_666.contact_point_center = var_648;
                        // contact_data.contact_distance = contact_dist_2                         <L 446>
                        var_666.contact_distance = var_644;
                        // contact_data.sort_sub_key = 2                                          <L 447>
                        var_666.sort_sub_key = var_708;
                        // writer_func(contact_data, writer_data, base_index)                     <L 448>
                        write_contact_0(var_666, var_writer_data, var_707);
                        // base_index += 1                                                        <L 449>
                        var_710 = wp::add(var_707, var_709);
                    }
                    var_711 = wp::where(var_678, var_710, var_707);
                    // if contact_3_valid:                                                        <L 452>
                    if (var_682) {
                        // contact_data.contact_point_center = contact_pos_3                      <L 453>
                        var_666.contact_point_center = var_649;
                        // contact_data.contact_distance = contact_dist_3                         <L 454>
                        var_666.contact_distance = var_645;
                        // contact_data.sort_sub_key = 3                                          <L 455>
                        var_666.sort_sub_key = var_712;
                        // writer_func(contact_data, writer_data, base_index)                     <L 456>
                        write_contact_0(var_666, var_writer_data, var_711);
                    }
                }
                // continue                                                                       <L 458>
                goto start_for_1;
            }
            // idx = wp.atomic_add(gjk_candidate_pairs_count, 0, 1)                               <L 463>
            var_715 = wp::atomic_add(var_gjk_candidate_pairs_count, var_713, var_714);
            // if idx < gjk_candidate_pairs.shape[0]:                                             <L 464>
            var_716 = &(var_gjk_candidate_pairs.shape);
            var_719 = wp::load(var_716);
            var_718 = wp::extract(var_719, var_717);
            var_720 = (var_715 < var_718);
            if (var_720) {
                // gjk_candidate_pairs[idx] = wp.vec2i(shape_a, shape_b)                          <L 465>
                var_721 = wp::vec_t<2, wp::int32>(var_33, var_34);
                wp::array_store(var_gjk_candidate_pairs, var_715, var_721);
            }
            goto start_for_1;
        end_for_1:;
    }
