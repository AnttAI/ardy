    ...
    wp::array_t<wp::int32> var_triangle_pairs_count)
{
    ...
    bool var_65;
    wp::tile_register_t<wp::int32,wp::tile_layout_register_t<wp::tile_shape_t<128>>> var_66 = wp::tile_register_t<wp::int32,wp::tile_layout_register_t<wp::tile_shape_t<128>>>{};
    wp::int32 var_67;
    ...
    wp::int32 var_72;
    wp::tile_register_t<wp::int32,wp::tile_layout_register_t<wp::tile_shape_t<128>>> var_73 = wp::tile_register_t<wp::int32,wp::tile_layout_register_t<wp::tile_shape_t<128>>>{};
    wp::tile_shared_t<wp::int32,wp::tile_layout_strided_t<wp::tile_shape_t<128>, wp::tile_stride_t<1>>, true> var_74 = wp::tile_alloc_empty<wp::int32,wp::tile_shape_t<128>,wp::tile_stride_t<1>,false>();
    ...
    wp::int32 var_90;
    wp::int32 var_91;
    wp::tile_shared_t<wp::int32,wp::tile_layout_strided_t<wp::tile_shape_t<128>, wp::tile_stride_t<1>>, true> var_92 = wp::tile_alloc_empty<wp::int32,wp::tile_shape_t<128>,wp::tile_stride_t<1>,false>();
    wp::int32 var_93;
    const wp::int32 var_94 = 1;
    wp::int32 var_95;
    const wp::int32 var_96 = 0;
    const wp::int32 var_97 = 128;
    bool var_98;
    wp::int32 var_99;
    wp::int32 var_100;
    wp::int32 var_101;
