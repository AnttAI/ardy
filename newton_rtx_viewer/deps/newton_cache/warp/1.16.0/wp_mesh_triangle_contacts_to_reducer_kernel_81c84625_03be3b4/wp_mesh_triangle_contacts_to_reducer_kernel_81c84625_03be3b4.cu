...
// /home/jony/Downloads/newton/repos/newton/newton/_src/utils/heightfield.py:280
    ...
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    GenericShapeData_f25f19f5 var_126;
    ...
    var_126 = GenericShapeData_f25f19f5();
    ...
    // shape_data.center = wp.vec3(0.0, 0.0, 0.0)                                             <L 361>
    var_135 = wp::vec_t<3, wp::float32>(var_132, var_133, var_134);
    var_126.center = var_135;
    // return shape_data, v0_world                                                            <L 363>
    ret_0 = var_126;
    ret_1 = var_125;
    return;
}
...
// /home/jony/Downloads/newton/repos/newton/newton/_src/geometry/collision_core.py:1083
    ...
    wp::vec_t<3, wp::float32> & ret_1)
{
    ...
    GenericShapeData_f25f19f5 var_61;
    ...
    var_61 = GenericShapeData_f25f19f5();
...
static CUDA_CALLABLE void adj_create_build_manifold__locals__extract_4_point_contact_manifolds_8(
    ...
    GlobalContactReducerData_0c09c456 & adj_writer_data,
...
extern "C" __global__ void mesh_triangle_contacts_to_reducer_kernel_5be09219_cuda_kernel_forward(
    ...
    wp::int32 var_total_num_threads)
{
         ...
         _idx += static_cast<size_t>(blockDim.x) * static_cast<size_t>(gridDim.x))
    {
        ...
        GenericShapeData_f25f19f5 var_52;
        wp::vec_t<3, wp::float32> var_53;
        wp::transform_t<wp::float32> var_54;
        GenericShapeData_f25f19f5 var_55;
        wp::vec_t<3, wp::float32> var_56;
        wp::vec_t<3, wp::float32> var_57;
        wp::quat_t<wp::float32> var_58;
        GenericShapeData_f25f19f5 var_59;
        wp::vec_t<3, wp::float32> var_60;
        wp::float32 var_61;
        wp::vec_t<3, wp::float32> var_62;
        const wp::int32 var_63 = 2;
        ...
        //---------
        // forward
        // def mesh_triangle_contacts_to_reducer_kernel(                                          <L 2289>
        // tid = wp.tid()                                                                         <L 2311>
        var_0 = builtin_tid1d();
        // num_triangle_pairs = triangle_pairs_count[0]                                           <L 2313>
        var_2 = wp::address(var_triangle_pairs_count, var_1);
        var_4 = wp::load(var_2);
        var_3 = wp::copy(var_4);
        // for i in range(tid, num_triangle_pairs, total_num_threads):                            <L 2315>
        var_5 = wp::range(var_0, var_3, var_total_num_threads);
        start_for_0:;
            if (iter_cmp(var_5) == 0) goto end_for_0;
            var_6 = wp::iter_next(var_5);
            // if i >= triangle_pairs.shape[0]:                                                   <L 2316>
            ...
            if (!var_25) {
                ...
                // X_ws_a = shape_transform[shape_a]                                              <L 2336>
                var_49 = wp::address(var_shape_transform, var_16);
                var_51 = wp::load(var_49);
                var_50 = wp::copy(var_51);
                // shape_data_a, v0_world = get_triangle_shape_from_mesh(mesh_id_a, mesh_scale_a, X_ws_a, tri_idx)       <L 2337>
            ...
            // pos_b, quat_b, shape_data_b, _scale_b, margin_offset_b = extract_shape_data(       <L 2340>
            // shape_b,                                                                           <L 2341>
            // shape_transform,                                                                   <L 2342>
            // shape_types,                                                                       <L 2343>
            // shape_data,                                                                        <L 2344>
            // shape_source,                                                                      <L 2345>
            ...
            // shape_a,                                                                           <L 2384>
            // shape_b,                                                                           <L 2385>
            // margin_offset_a,                                                                   <L 2386>
            // margin_offset_b,                                                                   <L 2387>
            // reducer_data,                                                                      <L 2388>
            // (tri_idx << 1) | 1,                                                                <L 2389>
